...
public class ExcitationSystemDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignExcitationSystemDynamics( @RequestBody AssignExcitationSystemDynamicsToExcitationSystemDynamicsCommand command ) {
		try {
			ExcitationSystemDynamicsBusinessDelegate.getExcitationSystemDynamicsInstance().assignExcitationSystemDynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignExcitationSystemDynamics( @RequestBody(required=true)  UnAssignExcitationSystemDynamicsFromExcitationSystemDynamicsCommand command ) {
		try {
			ExcitationSystemDynamicsBusinessDelegate.getExcitationSystemDynamicsInstance().unAssignExcitationSystemDynamics( command );   
		}
		catch( Exception exc ) {
