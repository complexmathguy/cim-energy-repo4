...
public class DCLineSegmentCommandRestController extends BaseSpringRestController {
	...
	public void addToDCLineSegments( @RequestBody(required=true) AssignDCLineSegmentsToDCLineSegmentCommand command ) {
		try {
	...
	public void removeFromDCLineSegments( 	@RequestBody(required=true) RemoveDCLineSegmentsFromDCLineSegmentCommand command )
	{		
		try {
