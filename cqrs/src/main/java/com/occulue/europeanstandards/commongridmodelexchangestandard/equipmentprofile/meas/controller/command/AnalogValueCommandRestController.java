...
public class AnalogValueCommandRestController extends BaseSpringRestController {
	...
	public void addToAnalogValues( @RequestBody(required=true) AssignAnalogValuesToAnalogValueCommand command ) {
		try {
	...
	public void removeFromAnalogValues( 	@RequestBody(required=true) RemoveAnalogValuesFromAnalogValueCommand command )
	{		
		try {
