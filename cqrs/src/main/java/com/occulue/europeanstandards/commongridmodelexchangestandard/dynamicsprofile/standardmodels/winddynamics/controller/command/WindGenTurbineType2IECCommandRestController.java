...
public class WindGenTurbineType2IECCommandRestController extends BaseSpringRestController {
	...
	public void assignWindGenTurbineType2IEC( @RequestBody AssignWindGenTurbineType2IECToWindGenTurbineType2IECCommand command ) {
		try {
			WindGenTurbineType2IECBusinessDelegate.getWindGenTurbineType2IECInstance().assignWindGenTurbineType2IEC( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignWindGenTurbineType2IEC( @RequestBody(required=true)  UnAssignWindGenTurbineType2IECFromWindGenTurbineType2IECCommand command ) {
		try {
			WindGenTurbineType2IECBusinessDelegate.getWindGenTurbineType2IECInstance().unAssignWindGenTurbineType2IEC( command );   
		}
		catch( Exception exc ) {
