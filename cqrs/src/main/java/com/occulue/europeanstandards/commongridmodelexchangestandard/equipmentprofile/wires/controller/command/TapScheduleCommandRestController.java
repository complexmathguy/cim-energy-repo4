...
public class TapScheduleCommandRestController extends BaseSpringRestController {
	...
	public void addToTapSchedules( @RequestBody(required=true) AssignTapSchedulesToTapScheduleCommand command ) {
		try {
	...
	public void removeFromTapSchedules( 	@RequestBody(required=true) RemoveTapSchedulesFromTapScheduleCommand command )
	{		
		try {
