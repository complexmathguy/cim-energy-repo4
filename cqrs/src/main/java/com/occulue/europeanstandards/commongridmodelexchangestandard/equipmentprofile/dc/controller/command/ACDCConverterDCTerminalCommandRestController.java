...
public class ACDCConverterDCTerminalCommandRestController extends BaseSpringRestController {
	...
	public void addToDCTerminals( @RequestBody(required=true) AssignDCTerminalsToACDCConverterDCTerminalCommand command ) {
		try {
			ACDCConverterDCTerminalBusinessDelegate.getACDCConverterDCTerminalInstance().addToDCTerminals( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromDCTerminals( 	@RequestBody(required=true) RemoveDCTerminalsFromACDCConverterDCTerminalCommand command )
	{		
		try {
			ACDCConverterDCTerminalBusinessDelegate.getACDCConverterDCTerminalInstance().removeFromDCTerminals( command );
		}
		catch( Exception exc ) {
