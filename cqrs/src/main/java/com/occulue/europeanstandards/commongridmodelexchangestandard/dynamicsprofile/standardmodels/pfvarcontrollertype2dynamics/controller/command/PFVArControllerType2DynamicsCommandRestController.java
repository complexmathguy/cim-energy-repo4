...
public class PFVArControllerType2DynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignPFVArControllerType2Dynamics( @RequestBody AssignPFVArControllerType2DynamicsToPFVArControllerType2DynamicsCommand command ) {
		try {
			PFVArControllerType2DynamicsBusinessDelegate.getPFVArControllerType2DynamicsInstance().assignPFVArControllerType2Dynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPFVArControllerType2Dynamics( @RequestBody(required=true)  UnAssignPFVArControllerType2DynamicsFromPFVArControllerType2DynamicsCommand command ) {
		try {
			PFVArControllerType2DynamicsBusinessDelegate.getPFVArControllerType2DynamicsInstance().unAssignPFVArControllerType2Dynamics( command );   
		}
		catch( Exception exc ) {
