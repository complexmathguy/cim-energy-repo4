...
public class PowerTransformerEndCommandRestController extends BaseSpringRestController {
	...
	public void addToPowerTransformerEnd( @RequestBody(required=true) AssignPowerTransformerEndToPowerTransformerEndCommand command ) {
		try {
			PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance().addToPowerTransformerEnd( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromPowerTransformerEnd( 	@RequestBody(required=true) RemovePowerTransformerEndFromPowerTransformerEndCommand command )
	{		
		try {
			PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance().removeFromPowerTransformerEnd( command );
		}
		catch( Exception exc ) {
