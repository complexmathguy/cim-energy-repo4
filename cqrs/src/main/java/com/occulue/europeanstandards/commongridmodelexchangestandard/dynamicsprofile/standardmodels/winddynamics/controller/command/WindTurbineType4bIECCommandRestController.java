...
public class WindTurbineType4bIECCommandRestController extends BaseSpringRestController {
	...
	public void assignWindTurbineType4bIEC( @RequestBody AssignWindTurbineType4bIECToWindTurbineType4bIECCommand command ) {
		try {
			WindTurbineType4bIECBusinessDelegate.getWindTurbineType4bIECInstance().assignWindTurbineType4bIEC( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignWindTurbineType4bIEC( @RequestBody(required=true)  UnAssignWindTurbineType4bIECFromWindTurbineType4bIECCommand command ) {
		try {
			WindTurbineType4bIECBusinessDelegate.getWindTurbineType4bIECInstance().unAssignWindTurbineType4bIEC( command );   
		}
		catch( Exception exc ) {
