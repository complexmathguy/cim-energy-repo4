...
public class ConformLoadCommandRestController extends BaseSpringRestController {
	...
	public void addToEnergyConsumers( @RequestBody(required=true) AssignEnergyConsumersToConformLoadCommand command ) {
		try {
	...
	public void removeFromEnergyConsumers( 	@RequestBody(required=true) RemoveEnergyConsumersFromConformLoadCommand command )
	{		
		try {
