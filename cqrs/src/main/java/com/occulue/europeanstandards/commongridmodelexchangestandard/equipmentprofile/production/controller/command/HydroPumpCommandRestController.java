...
public class HydroPumpCommandRestController extends BaseSpringRestController {
	...
	public void unAssignHydroPump( @RequestBody(required=true)  UnAssignHydroPumpFromHydroPumpCommand command ) {
		try {
	...
	public void addToHydroPumps( @RequestBody(required=true) AssignHydroPumpsToHydroPumpCommand command ) {
		try {
	...
	public void removeFromHydroPumps( 	@RequestBody(required=true) RemoveHydroPumpsFromHydroPumpCommand command )
	{		
		try {
