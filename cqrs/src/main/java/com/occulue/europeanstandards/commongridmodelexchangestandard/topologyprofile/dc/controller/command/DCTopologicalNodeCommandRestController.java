...
public class DCTopologicalNodeCommandRestController extends BaseSpringRestController {
	...
	public void addToDCTopologicalNode( @RequestBody(required=true) AssignDCTopologicalNodeToDCTopologicalNodeCommand command ) {
		try {
			DCTopologicalNodeBusinessDelegate.getDCTopologicalNodeInstance().addToDCTopologicalNode( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromDCTopologicalNode( 	@RequestBody(required=true) RemoveDCTopologicalNodeFromDCTopologicalNodeCommand command )
	{		
		try {
			DCTopologicalNodeBusinessDelegate.getDCTopologicalNodeInstance().removeFromDCTopologicalNode( command );
		}
		catch( Exception exc ) {
