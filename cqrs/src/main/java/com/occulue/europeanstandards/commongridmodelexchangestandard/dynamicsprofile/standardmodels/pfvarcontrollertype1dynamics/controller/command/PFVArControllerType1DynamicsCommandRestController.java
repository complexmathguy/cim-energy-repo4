...
public class PFVArControllerType1DynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignPFVArControllerType1Dynamics( @RequestBody AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsCommand command ) {
		try {
			PFVArControllerType1DynamicsBusinessDelegate.getPFVArControllerType1DynamicsInstance().assignPFVArControllerType1Dynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPFVArControllerType1Dynamics( @RequestBody(required=true)  UnAssignPFVArControllerType1DynamicsFromPFVArControllerType1DynamicsCommand command ) {
		try {
			PFVArControllerType1DynamicsBusinessDelegate.getPFVArControllerType1DynamicsInstance().unAssignPFVArControllerType1Dynamics( command );   
		}
		catch( Exception exc ) {
