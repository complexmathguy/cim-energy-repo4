...
public class ControlAreaGeneratingUnitCommandRestController extends BaseSpringRestController {
	...
	public void addToControlAreaGeneratingUnit( @RequestBody(required=true) AssignControlAreaGeneratingUnitToControlAreaGeneratingUnitCommand command ) {
		try {
			ControlAreaGeneratingUnitBusinessDelegate.getControlAreaGeneratingUnitInstance().addToControlAreaGeneratingUnit( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromControlAreaGeneratingUnit( 	@RequestBody(required=true) RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitCommand command )
	{		
		try {
			ControlAreaGeneratingUnitBusinessDelegate.getControlAreaGeneratingUnitInstance().removeFromControlAreaGeneratingUnit( command );
		}
		catch( Exception exc ) {
