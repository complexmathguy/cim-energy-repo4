...
public class AccumulatorValueCommandRestController extends BaseSpringRestController {
	...
	public void addToAccumulatorValues( @RequestBody(required=true) AssignAccumulatorValuesToAccumulatorValueCommand command ) {
		try {
			AccumulatorValueBusinessDelegate.getAccumulatorValueInstance().addToAccumulatorValues( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromAccumulatorValues( 	@RequestBody(required=true) RemoveAccumulatorValuesFromAccumulatorValueCommand command )
	{		
		try {
			AccumulatorValueBusinessDelegate.getAccumulatorValueInstance().removeFromAccumulatorValues( command );
		}
		catch( Exception exc ) {
