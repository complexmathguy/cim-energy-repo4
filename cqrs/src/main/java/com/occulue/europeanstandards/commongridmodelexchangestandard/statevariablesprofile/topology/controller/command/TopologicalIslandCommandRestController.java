...
public class TopologicalIslandCommandRestController extends BaseSpringRestController {
	...
	public void assignTopologicalIsland( @RequestBody AssignTopologicalIslandToTopologicalIslandCommand command ) {
		try {
			TopologicalIslandBusinessDelegate.getTopologicalIslandInstance().assignTopologicalIsland( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTopologicalIsland( @RequestBody(required=true)  UnAssignTopologicalIslandFromTopologicalIslandCommand command ) {
		try {
			TopologicalIslandBusinessDelegate.getTopologicalIslandInstance().unAssignTopologicalIsland( command );   
		}
		catch( Exception exc ) {
	...
	public void assignAngleRefTopologicalIsland( @RequestBody AssignAngleRefTopologicalIslandToTopologicalIslandCommand command ) {
		try {
			TopologicalIslandBusinessDelegate.getTopologicalIslandInstance().assignAngleRefTopologicalIsland( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignAngleRefTopologicalIsland( @RequestBody(required=true)  UnAssignAngleRefTopologicalIslandFromTopologicalIslandCommand command ) {
		try {
			TopologicalIslandBusinessDelegate.getTopologicalIslandInstance().unAssignAngleRefTopologicalIsland( command );   
		}
		catch( Exception exc ) {
