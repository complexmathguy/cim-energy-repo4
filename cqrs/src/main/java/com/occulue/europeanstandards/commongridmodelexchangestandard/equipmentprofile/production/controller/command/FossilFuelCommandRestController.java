...
public class FossilFuelCommandRestController extends BaseSpringRestController {
	...
	public void addToFossilFuels( @RequestBody(required=true) AssignFossilFuelsToFossilFuelCommand command ) {
		try {
	...
	public void removeFromFossilFuels( 	@RequestBody(required=true) RemoveFossilFuelsFromFossilFuelCommand command )
	{		
		try {
