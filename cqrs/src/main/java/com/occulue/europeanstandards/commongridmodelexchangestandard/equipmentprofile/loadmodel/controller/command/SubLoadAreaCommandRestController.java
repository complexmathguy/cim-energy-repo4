...
public class SubLoadAreaCommandRestController extends BaseSpringRestController {
	...
	public void addToSubLoadAreas( @RequestBody(required=true) AssignSubLoadAreasToSubLoadAreaCommand command ) {
		try {
	...
	public void removeFromSubLoadAreas( 	@RequestBody(required=true) RemoveSubLoadAreasFromSubLoadAreaCommand command )
	{		
		try {
