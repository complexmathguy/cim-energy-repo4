...
public class EquivalentEquipmentCommandRestController extends BaseSpringRestController {
	...
	public void addToEquivalentEquipments( @RequestBody(required=true) AssignEquivalentEquipmentsToEquivalentEquipmentCommand command ) {
		try {
			EquivalentEquipmentBusinessDelegate.getEquivalentEquipmentInstance().addToEquivalentEquipments( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromEquivalentEquipments( 	@RequestBody(required=true) RemoveEquivalentEquipmentsFromEquivalentEquipmentCommand command )
	{		
		try {
			EquivalentEquipmentBusinessDelegate.getEquivalentEquipmentInstance().removeFromEquivalentEquipments( command );
		}
		catch( Exception exc ) {
