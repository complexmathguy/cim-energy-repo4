...
public class RegulationScheduleCommandRestController extends BaseSpringRestController {
	...
	public void addToRegulationSchedule( @RequestBody(required=true) AssignRegulationScheduleToRegulationScheduleCommand command ) {
		try {
			RegulationScheduleBusinessDelegate.getRegulationScheduleInstance().addToRegulationSchedule( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromRegulationSchedule( 	@RequestBody(required=true) RemoveRegulationScheduleFromRegulationScheduleCommand command )
	{		
		try {
			RegulationScheduleBusinessDelegate.getRegulationScheduleInstance().removeFromRegulationSchedule( command );
		}
		catch( Exception exc ) {
