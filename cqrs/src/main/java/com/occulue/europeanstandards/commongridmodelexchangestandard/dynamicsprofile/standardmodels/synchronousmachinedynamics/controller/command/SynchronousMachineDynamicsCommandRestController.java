...
public class SynchronousMachineDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignSynchronousMachineDynamics( @RequestBody AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsCommand command ) {
		try {
			SynchronousMachineDynamicsBusinessDelegate.getSynchronousMachineDynamicsInstance().assignSynchronousMachineDynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignSynchronousMachineDynamics( @RequestBody(required=true)  UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsCommand command ) {
		try {
			SynchronousMachineDynamicsBusinessDelegate.getSynchronousMachineDynamicsInstance().unAssignSynchronousMachineDynamics( command );   
		}
		catch( Exception exc ) {
