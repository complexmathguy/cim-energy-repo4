...
public class MeasurementCommandRestController extends BaseSpringRestController {
	...
	public void addToMeasurements( @RequestBody(required=true) AssignMeasurementsToMeasurementCommand command ) {
		try {
	...
	public void removeFromMeasurements( 	@RequestBody(required=true) RemoveMeasurementsFromMeasurementCommand command )
	{		
		try {
