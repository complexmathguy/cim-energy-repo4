...
public class DiagramObjectCommandRestController extends BaseSpringRestController {
	...
	public void addToStyledObjects( @RequestBody(required=true) AssignStyledObjectsToDiagramObjectCommand command ) {
		try {
	...
	public void removeFromStyledObjects( 	@RequestBody(required=true) RemoveStyledObjectsFromDiagramObjectCommand command )
	{		
		try {
	...
	public void addToDiagramElements( @RequestBody(required=true) AssignDiagramElementsToDiagramObjectCommand command ) {
		try {
	...
	public void removeFromDiagramElements( 	@RequestBody(required=true) RemoveDiagramElementsFromDiagramObjectCommand command )
	{		
		try {
	...
	public void addToDiagramObjects( @RequestBody(required=true) AssignDiagramObjectsToDiagramObjectCommand command ) {
		try {
	...
	public void removeFromDiagramObjects( 	@RequestBody(required=true) RemoveDiagramObjectsFromDiagramObjectCommand command )
	{		
		try {
