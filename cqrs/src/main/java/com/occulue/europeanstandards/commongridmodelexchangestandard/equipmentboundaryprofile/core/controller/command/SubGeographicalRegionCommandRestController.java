...
public class SubGeographicalRegionCommandRestController extends BaseSpringRestController {
	...
	public void addToRegions( @RequestBody(required=true) AssignRegionsToSubGeographicalRegionCommand command ) {
		try {
			SubGeographicalRegionBusinessDelegate.getSubGeographicalRegionInstance().addToRegions( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromRegions( 	@RequestBody(required=true) RemoveRegionsFromSubGeographicalRegionCommand command )
	{		
		try {
			SubGeographicalRegionBusinessDelegate.getSubGeographicalRegionInstance().removeFromRegions( command );
		}
		catch( Exception exc ) {
