...
public class EquivalentInjectionCommandRestController extends BaseSpringRestController {
	...
	public void addToEquivalentInjection( @RequestBody(required=true) AssignEquivalentInjectionToEquivalentInjectionCommand command ) {
		try {
			EquivalentInjectionBusinessDelegate.getEquivalentInjectionInstance().addToEquivalentInjection( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromEquivalentInjection( 	@RequestBody(required=true) RemoveEquivalentInjectionFromEquivalentInjectionCommand command )
	{		
		try {
			EquivalentInjectionBusinessDelegate.getEquivalentInjectionInstance().removeFromEquivalentInjection( command );
		}
		catch( Exception exc ) {
