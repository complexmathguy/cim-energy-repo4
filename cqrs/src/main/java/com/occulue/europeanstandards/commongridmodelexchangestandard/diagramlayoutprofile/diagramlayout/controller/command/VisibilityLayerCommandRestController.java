...
public class VisibilityLayerCommandRestController extends BaseSpringRestController {
	...
	public void addToVisibilityLayers( @RequestBody(required=true) AssignVisibilityLayersToVisibilityLayerCommand command ) {
		try {
	...
	public void removeFromVisibilityLayers( 	@RequestBody(required=true) RemoveVisibilityLayersFromVisibilityLayerCommand command )
	{		
		try {
			VisibilityLayerBusinessDelegate.getVisibilityLayerInstance().removeFromVisibilityLayers( command );
		}
		catch( Exception exc ) {
