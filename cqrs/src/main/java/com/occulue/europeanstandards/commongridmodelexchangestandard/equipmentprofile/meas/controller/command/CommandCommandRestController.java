...
public class CommandCommandRestController extends BaseSpringRestController {
	...
	public void unAssignCommand( @RequestBody(required=true)  UnAssignCommandFromCommandCommand command ) {
		try {
	...
	public void removeFromCommands( 	@RequestBody(required=true) RemoveCommandsFromCommandCommand command )
	{		
		try {
