...
public class WindGenTurbineType1IECCommandRestController extends BaseSpringRestController {
	...
	public void assignWindGenTurbineType1IEC( @RequestBody AssignWindGenTurbineType1IECToWindGenTurbineType1IECCommand command ) {
		try {
			WindGenTurbineType1IECBusinessDelegate.getWindGenTurbineType1IECInstance().assignWindGenTurbineType1IEC( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignWindGenTurbineType1IEC( @RequestBody(required=true)  UnAssignWindGenTurbineType1IECFromWindGenTurbineType1IECCommand command ) {
		try {
			WindGenTurbineType1IECBusinessDelegate.getWindGenTurbineType1IECInstance().unAssignWindGenTurbineType1IEC( command );   
		}
		catch( Exception exc ) {
