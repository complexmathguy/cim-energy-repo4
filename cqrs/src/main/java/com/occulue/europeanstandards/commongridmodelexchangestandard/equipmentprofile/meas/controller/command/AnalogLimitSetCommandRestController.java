...
public class AnalogLimitSetCommandRestController extends BaseSpringRestController {
	...
	public void addToLimitSets( @RequestBody(required=true) AssignLimitSetsToAnalogLimitSetCommand command ) {
		try {
	...
	public void removeFromLimitSets( 	@RequestBody(required=true) RemoveLimitSetsFromAnalogLimitSetCommand command )
	{		
		try {
