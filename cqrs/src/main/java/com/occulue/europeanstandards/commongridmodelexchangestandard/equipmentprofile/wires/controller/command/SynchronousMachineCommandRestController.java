...
public class SynchronousMachineCommandRestController extends BaseSpringRestController {
	...
	public void addToInitiallyUsedBySynchronousMachines( @RequestBody(required=true) AssignInitiallyUsedBySynchronousMachinesToSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().addToInitiallyUsedBySynchronousMachines( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromInitiallyUsedBySynchronousMachines( 	@RequestBody(required=true) RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineCommand command )
	{		
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().removeFromInitiallyUsedBySynchronousMachines( command );
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to remove from Set InitiallyUsedBySynchronousMachines", exc );
		}
	}
