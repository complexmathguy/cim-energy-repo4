...
public class DCTopologicalIslandCommandRestController extends BaseSpringRestController {
	...
	public void assignDCTopologicalIsland( @RequestBody AssignDCTopologicalIslandToDCTopologicalIslandCommand command ) {
		try {
			DCTopologicalIslandBusinessDelegate.getDCTopologicalIslandInstance().assignDCTopologicalIsland( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDCTopologicalIsland( @RequestBody(required=true)  UnAssignDCTopologicalIslandFromDCTopologicalIslandCommand command ) {
		try {
			DCTopologicalIslandBusinessDelegate.getDCTopologicalIslandInstance().unAssignDCTopologicalIsland( command );   
		}
		catch( Exception exc ) {
