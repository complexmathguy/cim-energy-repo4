...
public class ACDCConverterCommandRestController extends BaseSpringRestController {
	...
	public void addToConverterDCSides( @RequestBody(required=true) AssignConverterDCSidesToACDCConverterCommand command ) {
		try {
	...
	public void removeFromConverterDCSides( 	@RequestBody(required=true) RemoveConverterDCSidesFromACDCConverterCommand command )
	{		
		try {
