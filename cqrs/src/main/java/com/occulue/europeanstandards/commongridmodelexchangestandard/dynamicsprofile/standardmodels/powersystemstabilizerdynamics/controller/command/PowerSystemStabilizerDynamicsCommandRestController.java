...
public class PowerSystemStabilizerDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignPowerSystemStabilizerDynamics( @RequestBody AssignPowerSystemStabilizerDynamicsToPowerSystemStabilizerDynamicsCommand command ) {
		try {
			PowerSystemStabilizerDynamicsBusinessDelegate.getPowerSystemStabilizerDynamicsInstance().assignPowerSystemStabilizerDynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPowerSystemStabilizerDynamics( @RequestBody(required=true)  UnAssignPowerSystemStabilizerDynamicsFromPowerSystemStabilizerDynamicsCommand command ) {
		try {
			PowerSystemStabilizerDynamicsBusinessDelegate.getPowerSystemStabilizerDynamicsInstance().unAssignPowerSystemStabilizerDynamics( command );   
		}
		catch( Exception exc ) {
