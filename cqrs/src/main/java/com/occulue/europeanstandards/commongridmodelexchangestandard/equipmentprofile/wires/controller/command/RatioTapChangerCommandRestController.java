...
public class RatioTapChangerCommandRestController extends BaseSpringRestController {
	...
	public void assignRatioTapChanger( @RequestBody AssignRatioTapChangerToRatioTapChangerCommand command ) {
		try {
	...
	public void unAssignRatioTapChanger( @RequestBody(required=true)  UnAssignRatioTapChangerFromRatioTapChangerCommand command ) {
		try {
