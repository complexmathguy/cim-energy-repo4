...
public class RatioTapChangerTablePointCommandRestController extends BaseSpringRestController {
	...
	public void addToRatioTapChangerTablePoint( @RequestBody(required=true) AssignRatioTapChangerTablePointToRatioTapChangerTablePointCommand command ) {
		try {
			RatioTapChangerTablePointBusinessDelegate.getRatioTapChangerTablePointInstance().addToRatioTapChangerTablePoint( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromRatioTapChangerTablePoint( 	@RequestBody(required=true) RemoveRatioTapChangerTablePointFromRatioTapChangerTablePointCommand command )
	{		
		try {
			RatioTapChangerTablePointBusinessDelegate.getRatioTapChangerTablePointInstance().removeFromRatioTapChangerTablePoint( command );
		}
		catch( Exception exc ) {
