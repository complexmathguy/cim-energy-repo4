...
public class RegularTimePointCommandRestController extends BaseSpringRestController {
	...
	public void addToTimePoints( @RequestBody(required=true) AssignTimePointsToRegularTimePointCommand command ) {
		try {
	...
	public void removeFromTimePoints( 	@RequestBody(required=true) RemoveTimePointsFromRegularTimePointCommand command )
	{		
		try {
