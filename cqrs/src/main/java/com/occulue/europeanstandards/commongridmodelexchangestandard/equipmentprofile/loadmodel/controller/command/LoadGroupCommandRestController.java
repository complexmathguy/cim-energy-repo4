...
public class LoadGroupCommandRestController extends BaseSpringRestController {
	...
	public void addToLoadGroups( @RequestBody(required=true) AssignLoadGroupsToLoadGroupCommand command ) {
		try {
	...
	public void removeFromLoadGroups( 	@RequestBody(required=true) RemoveLoadGroupsFromLoadGroupCommand command )
	{		
		try {
