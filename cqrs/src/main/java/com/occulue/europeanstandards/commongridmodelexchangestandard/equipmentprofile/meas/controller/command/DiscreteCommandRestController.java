...
public class DiscreteCommandRestController extends BaseSpringRestController {
	...
	public void addToDiscretes( @RequestBody(required=true) AssignDiscretesToDiscreteCommand command ) {
		try {
	...
	public void removeFromDiscretes( 	@RequestBody(required=true) RemoveDiscretesFromDiscreteCommand command )
	{		
		try {
