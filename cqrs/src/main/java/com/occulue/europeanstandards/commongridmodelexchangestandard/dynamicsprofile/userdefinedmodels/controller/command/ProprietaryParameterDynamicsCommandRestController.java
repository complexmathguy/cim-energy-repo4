...
public class ProprietaryParameterDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void addToProprietaryParameterDynamics( @RequestBody(required=true) AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsCommand command ) {
		try {
			ProprietaryParameterDynamicsBusinessDelegate.getProprietaryParameterDynamicsInstance().addToProprietaryParameterDynamics( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromProprietaryParameterDynamics( 	@RequestBody(required=true) RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsCommand command )
	{		
		try {
			ProprietaryParameterDynamicsBusinessDelegate.getProprietaryParameterDynamicsInstance().removeFromProprietaryParameterDynamics( command );
		}
		catch( Exception exc ) {
