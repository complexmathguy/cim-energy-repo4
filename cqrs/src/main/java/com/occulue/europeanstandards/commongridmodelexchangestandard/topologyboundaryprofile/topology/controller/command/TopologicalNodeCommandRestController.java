...
public class TopologicalNodeCommandRestController extends BaseSpringRestController {
	...
	public void addToTopologicalNode( @RequestBody(required=true) AssignTopologicalNodeToTopologicalNodeCommand command ) {
		try {
	...
	public void removeFromTopologicalNode( 	@RequestBody(required=true) RemoveTopologicalNodeFromTopologicalNodeCommand command )
	{		
		try {
			TopologicalNodeBusinessDelegate.getTopologicalNodeInstance().removeFromTopologicalNode( command );
		}
		catch( Exception exc ) {
