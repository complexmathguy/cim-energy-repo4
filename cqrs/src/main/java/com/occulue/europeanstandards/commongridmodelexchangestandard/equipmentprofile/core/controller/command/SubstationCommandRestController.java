...
public class SubstationCommandRestController extends BaseSpringRestController {
	...
	public void addToSubstations( @RequestBody(required=true) AssignSubstationsToSubstationCommand command ) {
		try {
	...
	public void removeFromSubstations( 	@RequestBody(required=true) RemoveSubstationsFromSubstationCommand command )
	{		
		try {
