...
public class GenICompensationForGenJCommandRestController extends BaseSpringRestController {
	...
	public void addToGenICompensationForGenJ( @RequestBody(required=true) AssignGenICompensationForGenJToGenICompensationForGenJCommand command ) {
		try {
			GenICompensationForGenJBusinessDelegate.getGenICompensationForGenJInstance().addToGenICompensationForGenJ( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromGenICompensationForGenJ( 	@RequestBody(required=true) RemoveGenICompensationForGenJFromGenICompensationForGenJCommand command )
	{		
		try {
			GenICompensationForGenJBusinessDelegate.getGenICompensationForGenJInstance().removeFromGenICompensationForGenJ( command );
		}
		catch( Exception exc ) {
