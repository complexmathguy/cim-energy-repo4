...
public class MutualCouplingCommandRestController extends BaseSpringRestController {
	...
	public void addToHasSecondMutualCoupling( @RequestBody(required=true) AssignHasSecondMutualCouplingToMutualCouplingCommand command ) {
		try {
			MutualCouplingBusinessDelegate.getMutualCouplingInstance().addToHasSecondMutualCoupling( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromHasSecondMutualCoupling( 	@RequestBody(required=true) RemoveHasSecondMutualCouplingFromMutualCouplingCommand command )
	{		
		try {
			MutualCouplingBusinessDelegate.getMutualCouplingInstance().removeFromHasSecondMutualCoupling( command );
		}
		catch( Exception exc ) {
	...
	public void addToHasFirstMutualCoupling( @RequestBody(required=true) AssignHasFirstMutualCouplingToMutualCouplingCommand command ) {
		try {
			MutualCouplingBusinessDelegate.getMutualCouplingInstance().addToHasFirstMutualCoupling( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromHasFirstMutualCoupling( 	@RequestBody(required=true) RemoveHasFirstMutualCouplingFromMutualCouplingCommand command )
	{		
		try {
			MutualCouplingBusinessDelegate.getMutualCouplingInstance().removeFromHasFirstMutualCoupling( command );
		}
		catch( Exception exc ) {
