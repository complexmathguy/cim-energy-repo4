...
public class PhaseTapChangerTablePointCommandRestController extends BaseSpringRestController {
	...
	public void addToPhaseTapChangerTablePoint( @RequestBody(required=true) AssignPhaseTapChangerTablePointToPhaseTapChangerTablePointCommand command ) {
		try {
			PhaseTapChangerTablePointBusinessDelegate.getPhaseTapChangerTablePointInstance().addToPhaseTapChangerTablePoint( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromPhaseTapChangerTablePoint( 	@RequestBody(required=true) RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointCommand command )
	{		
		try {
			PhaseTapChangerTablePointBusinessDelegate.getPhaseTapChangerTablePointInstance().removeFromPhaseTapChangerTablePoint( command );
		}
		catch( Exception exc ) {
