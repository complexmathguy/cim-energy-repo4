...
public class SvShuntCompensatorSectionsCommandRestController extends BaseSpringRestController {
	...
	public void assignSvShuntCompensatorSections( @RequestBody AssignSvShuntCompensatorSectionsToSvShuntCompensatorSectionsCommand command ) {
		try {
			SvShuntCompensatorSectionsBusinessDelegate.getSvShuntCompensatorSectionsInstance().assignSvShuntCompensatorSections( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignSvShuntCompensatorSections( @RequestBody(required=true)  UnAssignSvShuntCompensatorSectionsFromSvShuntCompensatorSectionsCommand command ) {
		try {
			SvShuntCompensatorSectionsBusinessDelegate.getSvShuntCompensatorSectionsInstance().unAssignSvShuntCompensatorSections( command );   
		}
		catch( Exception exc ) {
