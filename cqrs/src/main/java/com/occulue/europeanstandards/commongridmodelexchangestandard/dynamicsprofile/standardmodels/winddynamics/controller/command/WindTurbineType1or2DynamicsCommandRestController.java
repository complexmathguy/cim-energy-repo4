...
public class WindTurbineType1or2DynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignWindTurbineType1or2Dynamics( @RequestBody AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsCommand command ) {
		try {
			WindTurbineType1or2DynamicsBusinessDelegate.getWindTurbineType1or2DynamicsInstance().assignWindTurbineType1or2Dynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignWindTurbineType1or2Dynamics( @RequestBody(required=true)  UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsCommand command ) {
		try {
			WindTurbineType1or2DynamicsBusinessDelegate.getWindTurbineType1or2DynamicsInstance().unAssignWindTurbineType1or2Dynamics( command );   
		}
		catch( Exception exc ) {
