...
public class RemoteInputSignalCommandRestController extends BaseSpringRestController {
	...
	public void addToRemoteInputSignal( @RequestBody(required=true) AssignRemoteInputSignalToRemoteInputSignalCommand command ) {
		try {
			RemoteInputSignalBusinessDelegate.getRemoteInputSignalInstance().addToRemoteInputSignal( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromRemoteInputSignal( 	@RequestBody(required=true) RemoveRemoteInputSignalFromRemoteInputSignalCommand command )
	{		
		try {
			RemoteInputSignalBusinessDelegate.getRemoteInputSignalInstance().removeFromRemoteInputSignal( command );
		}
		catch( Exception exc ) {
