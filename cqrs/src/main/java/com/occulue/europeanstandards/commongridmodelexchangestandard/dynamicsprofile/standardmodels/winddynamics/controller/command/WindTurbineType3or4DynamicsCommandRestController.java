...
public class WindTurbineType3or4DynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignWindTurbineType3or4Dynamics( @RequestBody AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsCommand command ) {
		try {
			WindTurbineType3or4DynamicsBusinessDelegate.getWindTurbineType3or4DynamicsInstance().assignWindTurbineType3or4Dynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignWindTurbineType3or4Dynamics( @RequestBody(required=true)  UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsCommand command ) {
		try {
			WindTurbineType3or4DynamicsBusinessDelegate.getWindTurbineType3or4DynamicsInstance().unAssignWindTurbineType3or4Dynamics( command );   
		}
		catch( Exception exc ) {
