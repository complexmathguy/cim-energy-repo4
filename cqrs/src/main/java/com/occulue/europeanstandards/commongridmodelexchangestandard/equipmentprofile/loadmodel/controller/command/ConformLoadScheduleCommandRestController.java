...
public class ConformLoadScheduleCommandRestController extends BaseSpringRestController {
	...
	public void addToConformLoadSchedules( @RequestBody(required=true) AssignConformLoadSchedulesToConformLoadScheduleCommand command ) {
		try {
			ConformLoadScheduleBusinessDelegate.getConformLoadScheduleInstance().addToConformLoadSchedules( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromConformLoadSchedules( 	@RequestBody(required=true) RemoveConformLoadSchedulesFromConformLoadScheduleCommand command )
	{		
		try {
			ConformLoadScheduleBusinessDelegate.getConformLoadScheduleInstance().removeFromConformLoadSchedules( command );
		}
		catch( Exception exc ) {
