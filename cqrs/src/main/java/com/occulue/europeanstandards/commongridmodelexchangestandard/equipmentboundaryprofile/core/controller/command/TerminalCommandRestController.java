...
public class TerminalCommandRestController extends BaseSpringRestController {
	...
	public void addToTerminals( @RequestBody(required=true) AssignTerminalsToTerminalCommand command ) {
		try {
	...
	public void removeFromTerminals( 	@RequestBody(required=true) RemoveTerminalsFromTerminalCommand command )
	{		
		try {
