...
public class MeasurementValueQualityCommandRestController extends BaseSpringRestController {
	...
	public void assignMeasurementValueQuality( @RequestBody AssignMeasurementValueQualityToMeasurementValueQualityCommand command ) {
		try {
			MeasurementValueQualityBusinessDelegate.getMeasurementValueQualityInstance().assignMeasurementValueQuality( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMeasurementValueQuality( @RequestBody(required=true)  UnAssignMeasurementValueQualityFromMeasurementValueQualityCommand command ) {
		try {
			MeasurementValueQualityBusinessDelegate.getMeasurementValueQualityInstance().unAssignMeasurementValueQuality( command );   
		}
		catch( Exception exc ) {
