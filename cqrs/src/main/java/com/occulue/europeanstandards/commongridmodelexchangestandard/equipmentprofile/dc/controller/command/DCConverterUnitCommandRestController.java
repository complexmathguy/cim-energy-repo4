...
public class DCConverterUnitCommandRestController extends BaseSpringRestController {
	...
	public void addToDCConverterUnit( @RequestBody(required=true) AssignDCConverterUnitToDCConverterUnitCommand command ) {
		try {
	...
	public void removeFromDCConverterUnit( 	@RequestBody(required=true) RemoveDCConverterUnitFromDCConverterUnitCommand command )
	{		
		try {
			DCConverterUnitBusinessDelegate.getDCConverterUnitInstance().removeFromDCConverterUnit( command );
		}
		catch( Exception exc ) {
