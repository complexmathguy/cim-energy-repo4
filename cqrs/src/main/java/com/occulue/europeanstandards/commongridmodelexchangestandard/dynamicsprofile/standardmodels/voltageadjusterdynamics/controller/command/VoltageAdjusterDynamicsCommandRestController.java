...
public class VoltageAdjusterDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignVoltageAdjusterDynamics( @RequestBody AssignVoltageAdjusterDynamicsToVoltageAdjusterDynamicsCommand command ) {
		try {
			VoltageAdjusterDynamicsBusinessDelegate.getVoltageAdjusterDynamicsInstance().assignVoltageAdjusterDynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVoltageAdjusterDynamics( @RequestBody(required=true)  UnAssignVoltageAdjusterDynamicsFromVoltageAdjusterDynamicsCommand command ) {
		try {
			VoltageAdjusterDynamicsBusinessDelegate.getVoltageAdjusterDynamicsInstance().unAssignVoltageAdjusterDynamics( command );   
		}
		catch( Exception exc ) {
