...
public class AsynchronousMachineDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignAsynchronousMachineDynamics( @RequestBody AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsCommand command ) {
		try {
			AsynchronousMachineDynamicsBusinessDelegate.getAsynchronousMachineDynamicsInstance().assignAsynchronousMachineDynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignAsynchronousMachineDynamics( @RequestBody(required=true)  UnAssignAsynchronousMachineDynamicsFromAsynchronousMachineDynamicsCommand command ) {
		try {
			AsynchronousMachineDynamicsBusinessDelegate.getAsynchronousMachineDynamicsInstance().unAssignAsynchronousMachineDynamics( command );   
		}
		catch( Exception exc ) {
