...
public class WindTurbineType4aIECCommandRestController extends BaseSpringRestController {
	...
	public void assignWindTurbineType4aIEC( @RequestBody AssignWindTurbineType4aIECToWindTurbineType4aIECCommand command ) {
		try {
			WindTurbineType4aIECBusinessDelegate.getWindTurbineType4aIECInstance().assignWindTurbineType4aIEC( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignWindTurbineType4aIEC( @RequestBody(required=true)  UnAssignWindTurbineType4aIECFromWindTurbineType4aIECCommand command ) {
		try {
			WindTurbineType4aIECBusinessDelegate.getWindTurbineType4aIECInstance().unAssignWindTurbineType4aIEC( command );   
		}
		catch( Exception exc ) {
