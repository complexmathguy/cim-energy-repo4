...
public class RegulatingCondEqCommandRestController extends BaseSpringRestController {
	...
	public void addToRegulatingCondEq( @RequestBody(required=true) AssignRegulatingCondEqToRegulatingCondEqCommand command ) {
		try {
	...
	public void removeFromRegulatingCondEq( 	@RequestBody(required=true) RemoveRegulatingCondEqFromRegulatingCondEqCommand command )
	{		
		try {
			RegulatingCondEqBusinessDelegate.getRegulatingCondEqInstance().removeFromRegulatingCondEq( command );
		}
		catch( Exception exc ) {
