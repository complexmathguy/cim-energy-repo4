...
public class HydroGeneratingUnitCommandRestController extends BaseSpringRestController {
	...
	public void addToHydroGeneratingUnits( @RequestBody(required=true) AssignHydroGeneratingUnitsToHydroGeneratingUnitCommand command ) {
		try {
			HydroGeneratingUnitBusinessDelegate.getHydroGeneratingUnitInstance().addToHydroGeneratingUnits( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromHydroGeneratingUnits( 	@RequestBody(required=true) RemoveHydroGeneratingUnitsFromHydroGeneratingUnitCommand command )
	{		
		try {
			HydroGeneratingUnitBusinessDelegate.getHydroGeneratingUnitInstance().removeFromHydroGeneratingUnits( command );
		}
		catch( Exception exc ) {
