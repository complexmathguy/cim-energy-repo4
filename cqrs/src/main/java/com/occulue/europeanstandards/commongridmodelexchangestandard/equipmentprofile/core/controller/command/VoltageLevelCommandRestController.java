...
public class VoltageLevelCommandRestController extends BaseSpringRestController {
	...
	public void addToVoltageLevel( @RequestBody(required=true) AssignVoltageLevelToVoltageLevelCommand command ) {
		try {
	...
	public void removeFromVoltageLevel( 	@RequestBody(required=true) RemoveVoltageLevelFromVoltageLevelCommand command )
	{		
		try {
	...
	public void addToVoltageLevels( @RequestBody(required=true) AssignVoltageLevelsToVoltageLevelCommand command ) {
		try {
	...
	public void removeFromVoltageLevels( 	@RequestBody(required=true) RemoveVoltageLevelsFromVoltageLevelCommand command )
	{		
		try {
