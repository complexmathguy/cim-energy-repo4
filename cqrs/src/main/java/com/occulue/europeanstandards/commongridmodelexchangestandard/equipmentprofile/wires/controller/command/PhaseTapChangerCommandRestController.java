...
public class PhaseTapChangerCommandRestController extends BaseSpringRestController {
	...
	public void assignPhaseTapChanger( @RequestBody AssignPhaseTapChangerToPhaseTapChangerCommand command ) {
		try {
	...
	public void unAssignPhaseTapChanger( @RequestBody(required=true)  UnAssignPhaseTapChangerFromPhaseTapChangerCommand command ) {
		try {
