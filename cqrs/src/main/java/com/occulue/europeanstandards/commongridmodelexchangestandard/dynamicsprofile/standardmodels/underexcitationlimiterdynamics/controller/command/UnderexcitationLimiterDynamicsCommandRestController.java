...
public class UnderexcitationLimiterDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignUnderexcitationLimiterDynamics( @RequestBody AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsCommand command ) {
		try {
			UnderexcitationLimiterDynamicsBusinessDelegate.getUnderexcitationLimiterDynamicsInstance().assignUnderexcitationLimiterDynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignUnderexcitationLimiterDynamics( @RequestBody(required=true)  UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsCommand command ) {
		try {
			UnderexcitationLimiterDynamicsBusinessDelegate.getUnderexcitationLimiterDynamicsInstance().unAssignUnderexcitationLimiterDynamics( command );   
		}
		catch( Exception exc ) {
