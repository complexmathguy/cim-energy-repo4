...
public class WindTurbineType1or2IECCommandRestController extends BaseSpringRestController {
	...
	public void assignWindTurbineType1or2IEC( @RequestBody AssignWindTurbineType1or2IECToWindTurbineType1or2IECCommand command ) {
		try {
			WindTurbineType1or2IECBusinessDelegate.getWindTurbineType1or2IECInstance().assignWindTurbineType1or2IEC( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignWindTurbineType1or2IEC( @RequestBody(required=true)  UnAssignWindTurbineType1or2IECFromWindTurbineType1or2IECCommand command ) {
		try {
			WindTurbineType1or2IECBusinessDelegate.getWindTurbineType1or2IECInstance().unAssignWindTurbineType1or2IEC( command );   
		}
		catch( Exception exc ) {
