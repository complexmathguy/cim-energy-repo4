...
public class CurveDataCommandRestController extends BaseSpringRestController {
	...
	public void addToCurveDatas( @RequestBody(required=true) AssignCurveDatasToCurveDataCommand command ) {
		try {
	...
	public void removeFromCurveDatas( 	@RequestBody(required=true) RemoveCurveDatasFromCurveDataCommand command )
	{		
		try {
