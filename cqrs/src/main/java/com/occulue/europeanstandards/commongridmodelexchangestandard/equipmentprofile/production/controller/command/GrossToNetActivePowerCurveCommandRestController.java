...
public class GrossToNetActivePowerCurveCommandRestController extends BaseSpringRestController {
	...
	public void addToGrossToNetActivePowerCurves( @RequestBody(required=true) AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveCommand command ) {
		try {
			GrossToNetActivePowerCurveBusinessDelegate.getGrossToNetActivePowerCurveInstance().addToGrossToNetActivePowerCurves( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromGrossToNetActivePowerCurves( 	@RequestBody(required=true) RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveCommand command )
	{		
		try {
			GrossToNetActivePowerCurveBusinessDelegate.getGrossToNetActivePowerCurveInstance().removeFromGrossToNetActivePowerCurves( command );
		}
		catch( Exception exc ) {
