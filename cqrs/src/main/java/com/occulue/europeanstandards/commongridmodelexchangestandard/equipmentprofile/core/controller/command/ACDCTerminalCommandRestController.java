...
public class ACDCTerminalCommandRestController extends BaseSpringRestController {
	...
	public void addToTerminal( @RequestBody(required=true) AssignTerminalToACDCTerminalCommand command ) {
		try {
	...
	public void removeFromTerminal( 	@RequestBody(required=true) RemoveTerminalFromACDCTerminalCommand command )
	{		
		try {
