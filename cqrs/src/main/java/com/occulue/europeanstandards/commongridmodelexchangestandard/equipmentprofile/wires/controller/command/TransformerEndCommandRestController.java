...
public class TransformerEndCommandRestController extends BaseSpringRestController {
	...
	public void addToTransformerEnds( @RequestBody(required=true) AssignTransformerEndsToTransformerEndCommand command ) {
		try {
	...
	public void removeFromTransformerEnds( 	@RequestBody(required=true) RemoveTransformerEndsFromTransformerEndCommand command )
	{		
		try {
	...
	public void addToTransformerEnd( @RequestBody(required=true) AssignTransformerEndToTransformerEndCommand command ) {
		try {
	...
	public void removeFromTransformerEnd( 	@RequestBody(required=true) RemoveTransformerEndFromTransformerEndCommand command )
	{		
		try {
