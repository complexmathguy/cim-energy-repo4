...
public class NonConformLoadCommandRestController extends BaseSpringRestController {
	...
	public void addToEnergyConsumers( @RequestBody(required=true) AssignEnergyConsumersToNonConformLoadCommand command ) {
		try {
	...
	public void removeFromEnergyConsumers( 	@RequestBody(required=true) RemoveEnergyConsumersFromNonConformLoadCommand command )
	{		
		try {
