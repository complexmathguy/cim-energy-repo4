...
public class DCTerminalCommandRestController extends BaseSpringRestController {
	...
	public void addToDCTerminals( @RequestBody(required=true) AssignDCTerminalsToDCTerminalCommand command ) {
		try {
	...
	public void removeFromDCTerminals( 	@RequestBody(required=true) RemoveDCTerminalsFromDCTerminalCommand command )
	{		
		try {
