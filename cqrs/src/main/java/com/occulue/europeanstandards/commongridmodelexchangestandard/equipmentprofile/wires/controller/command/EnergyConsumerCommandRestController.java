...
public class EnergyConsumerCommandRestController extends BaseSpringRestController {
	...
	public void addToEnergyConsumer( @RequestBody(required=true) AssignEnergyConsumerToEnergyConsumerCommand command ) {
		try {
	...
	public void removeFromEnergyConsumer( 	@RequestBody(required=true) RemoveEnergyConsumerFromEnergyConsumerCommand command )
	{		
		try {
