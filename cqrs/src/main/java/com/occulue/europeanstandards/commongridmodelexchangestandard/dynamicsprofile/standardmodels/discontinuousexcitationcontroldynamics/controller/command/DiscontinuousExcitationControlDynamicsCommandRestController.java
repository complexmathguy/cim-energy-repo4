...
public class DiscontinuousExcitationControlDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignDiscontinuousExcitationControlDynamics( @RequestBody AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsCommand command ) {
		try {
			DiscontinuousExcitationControlDynamicsBusinessDelegate.getDiscontinuousExcitationControlDynamicsInstance().assignDiscontinuousExcitationControlDynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDiscontinuousExcitationControlDynamics( @RequestBody(required=true)  UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsCommand command ) {
		try {
			DiscontinuousExcitationControlDynamicsBusinessDelegate.getDiscontinuousExcitationControlDynamicsInstance().unAssignDiscontinuousExcitationControlDynamics( command );   
		}
		catch( Exception exc ) {
