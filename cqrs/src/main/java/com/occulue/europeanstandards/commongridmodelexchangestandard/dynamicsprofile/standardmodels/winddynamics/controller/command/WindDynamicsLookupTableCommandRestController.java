...
public class WindDynamicsLookupTableCommandRestController extends BaseSpringRestController {
	...
	public void addToWindDynamicsLookupTable( @RequestBody(required=true) AssignWindDynamicsLookupTableToWindDynamicsLookupTableCommand command ) {
		try {
			WindDynamicsLookupTableBusinessDelegate.getWindDynamicsLookupTableInstance().addToWindDynamicsLookupTable( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromWindDynamicsLookupTable( 	@RequestBody(required=true) RemoveWindDynamicsLookupTableFromWindDynamicsLookupTableCommand command )
	{		
		try {
			WindDynamicsLookupTableBusinessDelegate.getWindDynamicsLookupTableInstance().removeFromWindDynamicsLookupTable( command );
		}
		catch( Exception exc ) {
