...
public class SwitchScheduleCommandRestController extends BaseSpringRestController {
	...
	public void addToSwitchSchedules( @RequestBody(required=true) AssignSwitchSchedulesToSwitchScheduleCommand command ) {
		try {
	...
	public void removeFromSwitchSchedules( 	@RequestBody(required=true) RemoveSwitchSchedulesFromSwitchScheduleCommand command )
	{		
		try {
