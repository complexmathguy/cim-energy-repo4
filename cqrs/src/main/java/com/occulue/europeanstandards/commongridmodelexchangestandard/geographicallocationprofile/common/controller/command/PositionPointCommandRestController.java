...
public class PositionPointCommandRestController extends BaseSpringRestController {
	...
	public void addToPositionPoints( @RequestBody(required=true) AssignPositionPointsToPositionPointCommand command ) {
		try {
	...
	public void removeFromPositionPoints( 	@RequestBody(required=true) RemovePositionPointsFromPositionPointCommand command )
	{		
		try {
