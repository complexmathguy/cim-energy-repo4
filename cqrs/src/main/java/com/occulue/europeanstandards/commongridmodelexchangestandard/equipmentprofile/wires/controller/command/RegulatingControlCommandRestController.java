...
public class RegulatingControlCommandRestController extends BaseSpringRestController {
	...
	public void assignRegulatingControl( @RequestBody AssignRegulatingControlToRegulatingControlCommand command ) {
		try {
			RegulatingControlBusinessDelegate.getRegulatingControlInstance().assignRegulatingControl( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignRegulatingControl( @RequestBody(required=true)  UnAssignRegulatingControlFromRegulatingControlCommand command ) {
		try {
			RegulatingControlBusinessDelegate.getRegulatingControlInstance().unAssignRegulatingControl( command );   
		}
		catch( Exception exc ) {
