...
public class OverexcitationLimiterDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignOverexcitationLimiterDynamics( @RequestBody AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsCommand command ) {
		try {
			OverexcitationLimiterDynamicsBusinessDelegate.getOverexcitationLimiterDynamicsInstance().assignOverexcitationLimiterDynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignOverexcitationLimiterDynamics( @RequestBody(required=true)  UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsCommand command ) {
		try {
			OverexcitationLimiterDynamicsBusinessDelegate.getOverexcitationLimiterDynamicsInstance().unAssignOverexcitationLimiterDynamics( command );   
		}
		catch( Exception exc ) {
