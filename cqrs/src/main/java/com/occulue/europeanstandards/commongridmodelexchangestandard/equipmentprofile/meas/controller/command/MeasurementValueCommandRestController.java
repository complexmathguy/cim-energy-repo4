...
public class MeasurementValueCommandRestController extends BaseSpringRestController {
	...
	public void addToMeasurementValues( @RequestBody(required=true) AssignMeasurementValuesToMeasurementValueCommand command ) {
		try {
			MeasurementValueBusinessDelegate.getMeasurementValueInstance().addToMeasurementValues( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromMeasurementValues( 	@RequestBody(required=true) RemoveMeasurementValuesFromMeasurementValueCommand command )
	{		
		try {
			MeasurementValueBusinessDelegate.getMeasurementValueInstance().removeFromMeasurementValues( command );
		}
		catch( Exception exc ) {
