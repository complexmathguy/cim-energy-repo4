...
public class VoltageCompensatorDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignVoltageCompensatorDynamics( @RequestBody AssignVoltageCompensatorDynamicsToVoltageCompensatorDynamicsCommand command ) {
		try {
			VoltageCompensatorDynamicsBusinessDelegate.getVoltageCompensatorDynamicsInstance().assignVoltageCompensatorDynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVoltageCompensatorDynamics( @RequestBody(required=true)  UnAssignVoltageCompensatorDynamicsFromVoltageCompensatorDynamicsCommand command ) {
		try {
			VoltageCompensatorDynamicsBusinessDelegate.getVoltageCompensatorDynamicsInstance().unAssignVoltageCompensatorDynamics( command );   
		}
		catch( Exception exc ) {
