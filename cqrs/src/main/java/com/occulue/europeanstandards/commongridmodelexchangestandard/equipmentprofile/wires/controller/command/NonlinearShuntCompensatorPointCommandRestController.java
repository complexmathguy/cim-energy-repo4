...
public class NonlinearShuntCompensatorPointCommandRestController extends BaseSpringRestController {
	...
	public void addToNonlinearShuntCompensatorPoints( @RequestBody(required=true) AssignNonlinearShuntCompensatorPointsToNonlinearShuntCompensatorPointCommand command ) {
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().addToNonlinearShuntCompensatorPoints( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromNonlinearShuntCompensatorPoints( 	@RequestBody(required=true) RemoveNonlinearShuntCompensatorPointsFromNonlinearShuntCompensatorPointCommand command )
	{		
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().removeFromNonlinearShuntCompensatorPoints( command );
		}
		catch( Exception exc ) {
