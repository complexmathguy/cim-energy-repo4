...
public class EquipmentCommandRestController extends BaseSpringRestController {
	...
	public void addToEquipments( @RequestBody(required=true) AssignEquipmentsToEquipmentCommand command ) {
		try {
	...
	public void removeFromEquipments( 	@RequestBody(required=true) RemoveEquipmentsFromEquipmentCommand command )
	{		
		try {
