...
public class RaiseLowerCommandCommandRestController extends BaseSpringRestController {
	...
	public void addToRaiseLowerCommands( @RequestBody(required=true) AssignRaiseLowerCommandsToRaiseLowerCommandCommand command ) {
		try {
			RaiseLowerCommandBusinessDelegate.getRaiseLowerCommandInstance().addToRaiseLowerCommands( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromRaiseLowerCommands( 	@RequestBody(required=true) RemoveRaiseLowerCommandsFromRaiseLowerCommandCommand command )
	{		
		try {
			RaiseLowerCommandBusinessDelegate.getRaiseLowerCommandInstance().removeFromRaiseLowerCommands( command );
		}
		catch( Exception exc ) {
