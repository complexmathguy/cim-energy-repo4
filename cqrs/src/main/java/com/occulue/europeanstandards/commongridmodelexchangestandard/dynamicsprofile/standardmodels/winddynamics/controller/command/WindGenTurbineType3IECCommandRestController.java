...
public class WindGenTurbineType3IECCommandRestController extends BaseSpringRestController {
	...
	public void assignWindGenTurbineType3IEC( @RequestBody AssignWindGenTurbineType3IECToWindGenTurbineType3IECCommand command ) {
		try {
			WindGenTurbineType3IECBusinessDelegate.getWindGenTurbineType3IECInstance().assignWindGenTurbineType3IEC( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignWindGenTurbineType3IEC( @RequestBody(required=true)  UnAssignWindGenTurbineType3IECFromWindGenTurbineType3IECCommand command ) {
		try {
			WindGenTurbineType3IECBusinessDelegate.getWindGenTurbineType3IECInstance().unAssignWindGenTurbineType3IEC( command );   
		}
		catch( Exception exc ) {
