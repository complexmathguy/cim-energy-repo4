...
public class DiagramObjectPointCommandRestController extends BaseSpringRestController {
	...
	public void addToDiagramObjectPoints( @RequestBody(required=true) AssignDiagramObjectPointsToDiagramObjectPointCommand command ) {
		try {
			DiagramObjectPointBusinessDelegate.getDiagramObjectPointInstance().addToDiagramObjectPoints( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromDiagramObjectPoints( 	@RequestBody(required=true) RemoveDiagramObjectPointsFromDiagramObjectPointCommand command )
	{		
		try {
			DiagramObjectPointBusinessDelegate.getDiagramObjectPointInstance().removeFromDiagramObjectPoints( command );
		}
		catch( Exception exc ) {
