...
public class WindTurbineType3or4IECCommandRestController extends BaseSpringRestController {
	...
	public void assignWindTurbineType3or4IEC( @RequestBody AssignWindTurbineType3or4IECToWindTurbineType3or4IECCommand command ) {
		try {
			WindTurbineType3or4IECBusinessDelegate.getWindTurbineType3or4IECInstance().assignWindTurbineType3or4IEC( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignWindTurbineType3or4IEC( @RequestBody(required=true)  UnAssignWindTurbineType3or4IECFromWindTurbineType3or4IECCommand command ) {
		try {
			WindTurbineType3or4IECBusinessDelegate.getWindTurbineType3or4IECInstance().unAssignWindTurbineType3or4IEC( command );   
		}
		catch( Exception exc ) {
