...
public class DiscreteValueCommandRestController extends BaseSpringRestController {
	...
	public void addToDiscreteValues( @RequestBody(required=true) AssignDiscreteValuesToDiscreteValueCommand command ) {
		try {
	...
	public void removeFromDiscreteValues( 	@RequestBody(required=true) RemoveDiscreteValuesFromDiscreteValueCommand command )
	{		
		try {
