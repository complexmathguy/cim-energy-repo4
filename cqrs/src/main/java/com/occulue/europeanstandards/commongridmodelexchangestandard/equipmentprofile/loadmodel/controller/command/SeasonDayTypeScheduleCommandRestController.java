...
public class SeasonDayTypeScheduleCommandRestController extends BaseSpringRestController {
	...
	public void addToSeasonDayTypeSchedules( @RequestBody(required=true) AssignSeasonDayTypeSchedulesToSeasonDayTypeScheduleCommand command ) {
		try {
			SeasonDayTypeScheduleBusinessDelegate.getSeasonDayTypeScheduleInstance().addToSeasonDayTypeSchedules( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromSeasonDayTypeSchedules( 	@RequestBody(required=true) RemoveSeasonDayTypeSchedulesFromSeasonDayTypeScheduleCommand command )
	{		
		try {
			SeasonDayTypeScheduleBusinessDelegate.getSeasonDayTypeScheduleInstance().removeFromSeasonDayTypeSchedules( command );
		}
		catch( Exception exc ) {
