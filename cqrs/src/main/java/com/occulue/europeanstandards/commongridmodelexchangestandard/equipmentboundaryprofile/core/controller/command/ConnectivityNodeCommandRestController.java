...
public class ConnectivityNodeCommandRestController extends BaseSpringRestController {
	...
	public void addToConnectivityNodes( @RequestBody(required=true) AssignConnectivityNodesToConnectivityNodeCommand command ) {
		try {
			ConnectivityNodeBusinessDelegate.getConnectivityNodeInstance().addToConnectivityNodes( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromConnectivityNodes( 	@RequestBody(required=true) RemoveConnectivityNodesFromConnectivityNodeCommand command )
	{		
		try {
			ConnectivityNodeBusinessDelegate.getConnectivityNodeInstance().removeFromConnectivityNodes( command );
		}
		catch( Exception exc ) {
