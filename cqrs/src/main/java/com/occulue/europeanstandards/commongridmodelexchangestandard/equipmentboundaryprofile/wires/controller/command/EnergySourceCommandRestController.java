...
public class EnergySourceCommandRestController extends BaseSpringRestController {
	...
	public void addToEnergySource( @RequestBody(required=true) AssignEnergySourceToEnergySourceCommand command ) {
		try {
	...
	public void removeFromEnergySource( 	@RequestBody(required=true) RemoveEnergySourceFromEnergySourceCommand command )
	{		
		try {
