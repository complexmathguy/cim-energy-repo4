...
public class TurbineLoadControllerDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignTurbineLoadControllerDynamics( @RequestBody AssignTurbineLoadControllerDynamicsToTurbineLoadControllerDynamicsCommand command ) {
		try {
			TurbineLoadControllerDynamicsBusinessDelegate.getTurbineLoadControllerDynamicsInstance().assignTurbineLoadControllerDynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTurbineLoadControllerDynamics( @RequestBody(required=true)  UnAssignTurbineLoadControllerDynamicsFromTurbineLoadControllerDynamicsCommand command ) {
		try {
			TurbineLoadControllerDynamicsBusinessDelegate.getTurbineLoadControllerDynamicsInstance().unAssignTurbineLoadControllerDynamics( command );   
		}
		catch( Exception exc ) {
