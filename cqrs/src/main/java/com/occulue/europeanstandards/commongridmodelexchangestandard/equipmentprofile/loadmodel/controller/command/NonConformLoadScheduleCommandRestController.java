...
public class NonConformLoadScheduleCommandRestController extends BaseSpringRestController {
	...
	public void addToNonConformLoadSchedules( @RequestBody(required=true) AssignNonConformLoadSchedulesToNonConformLoadScheduleCommand command ) {
		try {
			NonConformLoadScheduleBusinessDelegate.getNonConformLoadScheduleInstance().addToNonConformLoadSchedules( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromNonConformLoadSchedules( 	@RequestBody(required=true) RemoveNonConformLoadSchedulesFromNonConformLoadScheduleCommand command )
	{		
		try {
			NonConformLoadScheduleBusinessDelegate.getNonConformLoadScheduleInstance().removeFromNonConformLoadSchedules( command );
		}
		catch( Exception exc ) {
