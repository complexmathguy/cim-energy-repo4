...
public class AccumulatorLimitCommandRestController extends BaseSpringRestController {
	...
	public void addToLimits( @RequestBody(required=true) AssignLimitsToAccumulatorLimitCommand command ) {
		try {
	...
	public void removeFromLimits( 	@RequestBody(required=true) RemoveLimitsFromAccumulatorLimitCommand command )
	{		
		try {
