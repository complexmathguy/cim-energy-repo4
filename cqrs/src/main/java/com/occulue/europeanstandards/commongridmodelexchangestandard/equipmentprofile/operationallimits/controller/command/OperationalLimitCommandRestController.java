...
public class OperationalLimitCommandRestController extends BaseSpringRestController {
	...
	public void addToOperationalLimit( @RequestBody(required=true) AssignOperationalLimitToOperationalLimitCommand command ) {
		try {
	...
	public void removeFromOperationalLimit( 	@RequestBody(required=true) RemoveOperationalLimitFromOperationalLimitCommand command )
	{		
		try {
			OperationalLimitBusinessDelegate.getOperationalLimitInstance().removeFromOperationalLimit( command );
		}
		catch( Exception exc ) {
	...
	public void addToOperationalLimitValue( @RequestBody(required=true) AssignOperationalLimitValueToOperationalLimitCommand command ) {
		try {
			OperationalLimitBusinessDelegate.getOperationalLimitInstance().addToOperationalLimitValue( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromOperationalLimitValue( 	@RequestBody(required=true) RemoveOperationalLimitValueFromOperationalLimitCommand command )
	{		
		try {
			OperationalLimitBusinessDelegate.getOperationalLimitInstance().removeFromOperationalLimitValue( command );
		}
		catch( Exception exc ) {
