...
public class PhaseTapChangerTabularCommandRestController extends BaseSpringRestController {
	...
	public void addToPhaseTapChangerTabular( @RequestBody(required=true) AssignPhaseTapChangerTabularToPhaseTapChangerTabularCommand command ) {
		try {
			PhaseTapChangerTabularBusinessDelegate.getPhaseTapChangerTabularInstance().addToPhaseTapChangerTabular( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromPhaseTapChangerTabular( 	@RequestBody(required=true) RemovePhaseTapChangerTabularFromPhaseTapChangerTabularCommand command )
	{		
		try {
			PhaseTapChangerTabularBusinessDelegate.getPhaseTapChangerTabularInstance().removeFromPhaseTapChangerTabular( command );
		}
		catch( Exception exc ) {
