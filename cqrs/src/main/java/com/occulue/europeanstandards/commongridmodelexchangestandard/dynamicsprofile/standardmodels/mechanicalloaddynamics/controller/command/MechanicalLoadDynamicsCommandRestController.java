...
public class MechanicalLoadDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignMechanicalLoadDynamics( @RequestBody AssignMechanicalLoadDynamicsToMechanicalLoadDynamicsCommand command ) {
		try {
			MechanicalLoadDynamicsBusinessDelegate.getMechanicalLoadDynamicsInstance().assignMechanicalLoadDynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMechanicalLoadDynamics( @RequestBody(required=true)  UnAssignMechanicalLoadDynamicsFromMechanicalLoadDynamicsCommand command ) {
		try {
			MechanicalLoadDynamicsBusinessDelegate.getMechanicalLoadDynamicsInstance().unAssignMechanicalLoadDynamics( command );   
		}
		catch( Exception exc ) {
