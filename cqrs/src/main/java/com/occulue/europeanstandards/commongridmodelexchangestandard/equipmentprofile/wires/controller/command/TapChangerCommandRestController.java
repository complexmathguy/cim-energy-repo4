...
public class TapChangerCommandRestController extends BaseSpringRestController {
	...
	public void addToTapChanger( @RequestBody(required=true) AssignTapChangerToTapChangerCommand command ) {
		try {
	...
	public void removeFromTapChanger( 	@RequestBody(required=true) RemoveTapChangerFromTapChangerCommand command )
	{		
		try {
