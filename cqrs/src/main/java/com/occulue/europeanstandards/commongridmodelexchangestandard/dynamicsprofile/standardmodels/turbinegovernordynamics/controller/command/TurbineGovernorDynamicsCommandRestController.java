...
public class TurbineGovernorDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignTurbineGovernorDynamics( @RequestBody AssignTurbineGovernorDynamicsToTurbineGovernorDynamicsCommand command ) {
		try {
			TurbineGovernorDynamicsBusinessDelegate.getTurbineGovernorDynamicsInstance().assignTurbineGovernorDynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTurbineGovernorDynamics( @RequestBody(required=true)  UnAssignTurbineGovernorDynamicsFromTurbineGovernorDynamicsCommand command ) {
		try {
			TurbineGovernorDynamicsBusinessDelegate.getTurbineGovernorDynamicsInstance().unAssignTurbineGovernorDynamics( command );   
		}
		catch( Exception exc ) {
