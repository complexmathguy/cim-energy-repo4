...
public class DCBaseTerminalCommandRestController extends BaseSpringRestController {
	...
	public void addToDCTerminals( @RequestBody(required=true) AssignDCTerminalsToDCBaseTerminalCommand command ) {
		try {
	...
	public void removeFromDCTerminals( 	@RequestBody(required=true) RemoveDCTerminalsFromDCBaseTerminalCommand command )
	{		
		try {
