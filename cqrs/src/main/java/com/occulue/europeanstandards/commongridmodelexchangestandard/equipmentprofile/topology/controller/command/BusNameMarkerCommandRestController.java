...
public class BusNameMarkerCommandRestController extends BaseSpringRestController {
	...
	public void addToBusNameMarker( @RequestBody(required=true) AssignBusNameMarkerToBusNameMarkerCommand command ) {
		try {
	...
	public void removeFromBusNameMarker( 	@RequestBody(required=true) RemoveBusNameMarkerFromBusNameMarkerCommand command )
	{		
		try {
