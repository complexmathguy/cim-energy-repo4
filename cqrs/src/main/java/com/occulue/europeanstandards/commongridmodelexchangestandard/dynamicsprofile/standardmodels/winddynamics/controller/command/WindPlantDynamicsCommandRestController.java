...
public class WindPlantDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignWindPlantDynamics( @RequestBody AssignWindPlantDynamicsToWindPlantDynamicsCommand command ) {
		try {
			WindPlantDynamicsBusinessDelegate.getWindPlantDynamicsInstance().assignWindPlantDynamics( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignWindPlantDynamics( @RequestBody(required=true)  UnAssignWindPlantDynamicsFromWindPlantDynamicsCommand command ) {
		try {
			WindPlantDynamicsBusinessDelegate.getWindPlantDynamicsInstance().unAssignWindPlantDynamics( command );   
		}
		catch( Exception exc ) {
