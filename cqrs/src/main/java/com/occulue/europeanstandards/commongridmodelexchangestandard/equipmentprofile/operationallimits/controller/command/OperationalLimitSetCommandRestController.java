...
public class OperationalLimitSetCommandRestController extends BaseSpringRestController {
	...
	public void addToOperationalLimitSet( @RequestBody(required=true) AssignOperationalLimitSetToOperationalLimitSetCommand command ) {
		try {
			OperationalLimitSetBusinessDelegate.getOperationalLimitSetInstance().addToOperationalLimitSet( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromOperationalLimitSet( 	@RequestBody(required=true) RemoveOperationalLimitSetFromOperationalLimitSetCommand command )
	{		
		try {
			OperationalLimitSetBusinessDelegate.getOperationalLimitSetInstance().removeFromOperationalLimitSet( command );
		}
		catch( Exception exc ) {
