...
public class StringMeasurementValueCommandRestController extends BaseSpringRestController {
	...
	public void addToStringMeasurementValues( @RequestBody(required=true) AssignStringMeasurementValuesToStringMeasurementValueCommand command ) {
		try {
			StringMeasurementValueBusinessDelegate.getStringMeasurementValueInstance().addToStringMeasurementValues( command );   
		}
		catch( Exception exc ) {
	...
	public void removeFromStringMeasurementValues( 	@RequestBody(required=true) RemoveStringMeasurementValuesFromStringMeasurementValueCommand command )
	{		
		try {
			StringMeasurementValueBusinessDelegate.getStringMeasurementValueInstance().removeFromStringMeasurementValues( command );
		}
		catch( Exception exc ) {
