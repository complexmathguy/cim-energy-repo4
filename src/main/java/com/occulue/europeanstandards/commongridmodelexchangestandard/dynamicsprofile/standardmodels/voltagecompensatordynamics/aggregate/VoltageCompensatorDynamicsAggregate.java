...
public class VoltageCompensatorDynamicsAggregate {  
    ...
    public void handle(UpdateVoltageCompensatorDynamicsCommand command) throws Exception {
    	...
    	UpdateVoltageCompensatorDynamicsEvent event = new UpdateVoltageCompensatorDynamicsEvent(command.getVoltageCompensatorDynamicsId(), command.getVoltageCompensatorDynamics());        
    ...
    @CommandHandler
    public void handle(AssignVoltageCompensatorDynamicsToVoltageCompensatorDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignVoltageCompensatorDynamicsToVoltageCompensatorDynamicsCommand" );
        ...
        apply(new AssignVoltageCompensatorDynamicsToVoltageCompensatorDynamicsEvent(command.getVoltageCompensatorDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignVoltageCompensatorDynamicsFromVoltageCompensatorDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignVoltageCompensatorDynamicsFromVoltageCompensatorDynamicsCommand" );

    	if (  voltageCompensatorDynamics == null )
    		throw new ProcessingException( "VoltageCompensatorDynamics already has nothing assigned." );  

    	apply(new UnAssignVoltageCompensatorDynamicsFromVoltageCompensatorDynamicsEvent(command.getVoltageCompensatorDynamicsId()));
    }
	...
	void on(UnAssignVoltageCompensatorDynamicsFromVoltageCompensatorDynamicsEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignVoltageCompensatorDynamicsFromVoltageCompensatorDynamicsEvent" );
