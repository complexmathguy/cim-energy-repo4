...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignSynchronousMachineDynamics( AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsCommand command ) throws ProcessingException {
		...
		SynchronousMachineDynamicsBusinessDelegate childDelegate 	= SynchronousMachineDynamicsBusinessDelegate.getSynchronousMachineDynamicsInstance();
		SynchronousMachineDynamicsBusinessDelegate parentDelegate = SynchronousMachineDynamicsBusinessDelegate.getSynchronousMachineDynamicsInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSynchronousMachineDynamics( UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign SynchronousMachineDynamics on SynchronousMachineDynamics";
