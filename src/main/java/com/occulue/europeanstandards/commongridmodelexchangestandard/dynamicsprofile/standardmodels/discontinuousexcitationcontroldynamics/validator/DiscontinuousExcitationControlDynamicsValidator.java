...
//		Assert.isNull( discontinuousExcitationControlDynamics.getDiscontinuousExcitationControlDynamicsId(), "CreateDiscontinuousExcitationControlDynamicsCommand identifier should be null" );
	...
	/**
	 * handles assign DiscontinuousExcitationControlDynamics validation for a DiscontinuousExcitationControlDynamics
	 * 
	 * @param	command AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsCommand
	 */	
	public void validate( AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsCommand should not be null" );
		Assert.notNull( command.getDiscontinuousExcitationControlDynamicsId(), "AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsCommand assignment should not be null" );
	}

	/**
	 * handles unassign DiscontinuousExcitationControlDynamics validation for a DiscontinuousExcitationControlDynamics
	 * 
	 * @param	command UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsCommand
	 */	
	public void validate( UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsCommand should not be null" );
		Assert.notNull( command.getDiscontinuousExcitationControlDynamicsId(), "UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsCommand identifier should not be null" );
	}
