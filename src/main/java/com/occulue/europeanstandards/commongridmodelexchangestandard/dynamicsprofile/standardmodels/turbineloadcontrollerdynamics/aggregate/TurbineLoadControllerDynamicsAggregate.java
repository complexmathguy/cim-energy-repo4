...
public class TurbineLoadControllerDynamicsAggregate {  
    ...
    public void handle(UpdateTurbineLoadControllerDynamicsCommand command) throws Exception {
    	...
    	UpdateTurbineLoadControllerDynamicsEvent event = new UpdateTurbineLoadControllerDynamicsEvent(command.getTurbineLoadControllerDynamicsId(), command.getTurbineLoadControllerDynamics());        
    ...
    @CommandHandler
    public void handle(AssignTurbineLoadControllerDynamicsToTurbineLoadControllerDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignTurbineLoadControllerDynamicsToTurbineLoadControllerDynamicsCommand" );
    	
    	if (  turbineLoadControllerDynamics != null && turbineLoadControllerDynamics.getTurbineLoadControllerDynamicsId() == command.getAssignment().getTurbineLoadControllerDynamicsId() )
    		throw new ProcessingException( "TurbineLoadControllerDynamics already assigned with id " + command.getAssignment().getTurbineLoadControllerDynamicsId() );  
    		
        apply(new AssignTurbineLoadControllerDynamicsToTurbineLoadControllerDynamicsEvent(command.getTurbineLoadControllerDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignTurbineLoadControllerDynamicsFromTurbineLoadControllerDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignTurbineLoadControllerDynamicsFromTurbineLoadControllerDynamicsCommand" );
    	...
    	apply(new UnAssignTurbineLoadControllerDynamicsFromTurbineLoadControllerDynamicsEvent(command.getTurbineLoadControllerDynamicsId()));
    }
    ...
    void on(AssignTurbineLoadControllerDynamicsToTurbineLoadControllerDynamicsEvent event ) {	
    	LOGGER.info( "Event sourcing AssignTurbineLoadControllerDynamicsToTurbineLoadControllerDynamicsEvent" );
	...
	void on(UnAssignTurbineLoadControllerDynamicsFromTurbineLoadControllerDynamicsEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignTurbineLoadControllerDynamicsFromTurbineLoadControllerDynamicsEvent" );
