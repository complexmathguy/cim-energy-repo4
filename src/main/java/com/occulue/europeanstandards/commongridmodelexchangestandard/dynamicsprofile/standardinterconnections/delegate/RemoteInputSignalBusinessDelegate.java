...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToRemoteInputSignal( AssignRemoteInputSignalToRemoteInputSignalCommand command ) throws ProcessingException {
		...
		RemoteInputSignalBusinessDelegate childDelegate 	= RemoteInputSignalBusinessDelegate.getRemoteInputSignalInstance();
		...
		try {		
			...
			final String msg = "Failed to add a RemoteInputSignal as RemoteInputSignal to RemoteInputSignal" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromRemoteInputSignal( RemoveRemoteInputSignalFromRemoteInputSignalCommand command ) throws ProcessingException {		
