...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignVoltageAdjusterDynamics( AssignVoltageAdjusterDynamicsToVoltageAdjusterDynamicsCommand command ) throws ProcessingException {
		...
		VoltageAdjusterDynamicsBusinessDelegate childDelegate 	= VoltageAdjusterDynamicsBusinessDelegate.getVoltageAdjusterDynamicsInstance();
		VoltageAdjusterDynamicsBusinessDelegate parentDelegate = VoltageAdjusterDynamicsBusinessDelegate.getVoltageAdjusterDynamicsInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignVoltageAdjusterDynamics( UnAssignVoltageAdjusterDynamicsFromVoltageAdjusterDynamicsCommand command ) throws ProcessingException {
