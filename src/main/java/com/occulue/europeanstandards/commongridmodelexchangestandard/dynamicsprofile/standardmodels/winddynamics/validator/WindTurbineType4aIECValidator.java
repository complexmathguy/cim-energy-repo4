...
//		Assert.isNull( windTurbineType4aIEC.getWindTurbineType4aIECId(), "CreateWindTurbineType4aIECCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignWindTurbineType4aIECToWindTurbineType4aIECCommand command ) throws Exception {
		Assert.notNull( command, "AssignWindTurbineType4aIECToWindTurbineType4aIECCommand should not be null" );
		Assert.notNull( command.getWindTurbineType4aIECId(), "AssignWindTurbineType4aIECToWindTurbineType4aIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWindTurbineType4aIECToWindTurbineType4aIECCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignWindTurbineType4aIECFromWindTurbineType4aIECCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWindTurbineType4aIECFromWindTurbineType4aIECCommand should not be null" );
		Assert.notNull( command.getWindTurbineType4aIECId(), "UnAssignWindTurbineType4aIECFromWindTurbineType4aIECCommand identifier should not be null" );
	}
