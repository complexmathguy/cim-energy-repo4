...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignAsynchronousMachineDynamics( AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsCommand command ) throws ProcessingException {
		...
		AsynchronousMachineDynamicsBusinessDelegate childDelegate 	= AsynchronousMachineDynamicsBusinessDelegate.getAsynchronousMachineDynamicsInstance();
		AsynchronousMachineDynamicsBusinessDelegate parentDelegate = AsynchronousMachineDynamicsBusinessDelegate.getAsynchronousMachineDynamicsInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignAsynchronousMachineDynamics( UnAssignAsynchronousMachineDynamicsFromAsynchronousMachineDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign AsynchronousMachineDynamics on AsynchronousMachineDynamics";
