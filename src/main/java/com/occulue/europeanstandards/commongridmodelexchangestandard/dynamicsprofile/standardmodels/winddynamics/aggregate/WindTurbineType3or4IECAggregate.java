...
public class WindTurbineType3or4IECAggregate {  
    ...
    public void handle(UpdateWindTurbineType3or4IECCommand command) throws Exception {
    	...
    	UpdateWindTurbineType3or4IECEvent event = new UpdateWindTurbineType3or4IECEvent(command.getWindTurbineType3or4IECId(), command.getWindTurbineType3or4IEC());        
    ...
    @CommandHandler
    public void handle(AssignWindTurbineType3or4IECToWindTurbineType3or4IECCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignWindTurbineType3or4IECToWindTurbineType3or4IECCommand" );
    	
    	if (  windTurbineType3or4IEC != null && windTurbineType3or4IEC.getWindTurbineType3or4IECId() == command.getAssignment().getWindTurbineType3or4IECId() )
    		throw new ProcessingException( "WindTurbineType3or4IEC already assigned with id " + command.getAssignment().getWindTurbineType3or4IECId() );  
    		
        apply(new AssignWindTurbineType3or4IECToWindTurbineType3or4IECEvent(command.getWindTurbineType3or4IECId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignWindTurbineType3or4IECFromWindTurbineType3or4IECCommand command) throws Exception {
    	...
    	apply(new UnAssignWindTurbineType3or4IECFromWindTurbineType3or4IECEvent(command.getWindTurbineType3or4IECId()));
    }
