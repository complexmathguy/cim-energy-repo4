...
public class GenICompensationForGenJAggregate {  
    ...
    public void handle(UpdateGenICompensationForGenJCommand command) throws Exception {
    	...
    	UpdateGenICompensationForGenJEvent event = new UpdateGenICompensationForGenJEvent(command.getGenICompensationForGenJId(), command.getRcij(), command.getXcij(), command.getGenICompensationForGenJ());        
    ...
    @CommandHandler
    public void handle(AssignGenICompensationForGenJToGenICompensationForGenJCommand command) throws Exception {
    	...
    	if ( genICompensationForGenJ.contains( command.getAddTo() ) )
    		throw new ProcessingException( "GenICompensationForGenJ already contains an entity with id " + command.getAddTo().getGenICompensationForGenJId() );

    	apply(new AssignGenICompensationForGenJToGenICompensationForGenJEvent(command.getGenICompensationForGenJId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveGenICompensationForGenJFromGenICompensationForGenJCommand command) throws Exception {
    	...
    	if ( !genICompensationForGenJ.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "GenICompensationForGenJ does not contain an entity with id " + command.getRemoveFrom().getGenICompensationForGenJId() );

        apply(new RemoveGenICompensationForGenJFromGenICompensationForGenJEvent(command.getGenICompensationForGenJId(), command.getRemoveFrom()));
    }
