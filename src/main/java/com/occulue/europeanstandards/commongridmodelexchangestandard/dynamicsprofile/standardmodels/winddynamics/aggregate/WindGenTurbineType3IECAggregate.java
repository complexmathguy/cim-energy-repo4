...
public class WindGenTurbineType3IECAggregate {  
    ...
    public void handle(UpdateWindGenTurbineType3IECCommand command) throws Exception {
    	...
    	UpdateWindGenTurbineType3IECEvent event = new UpdateWindGenTurbineType3IECEvent(command.getWindGenTurbineType3IECId(), command.getDipmax(), command.getDiqmax(), command.getWindGenTurbineType3IEC());        
    ...
    @CommandHandler
    public void handle(AssignWindGenTurbineType3IECToWindGenTurbineType3IECCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignWindGenTurbineType3IECToWindGenTurbineType3IECCommand" );
    	
    	if (  windGenTurbineType3IEC != null && windGenTurbineType3IEC.getWindGenTurbineType3IECId() == command.getAssignment().getWindGenTurbineType3IECId() )
    		throw new ProcessingException( "WindGenTurbineType3IEC already assigned with id " + command.getAssignment().getWindGenTurbineType3IECId() );  
    		
        apply(new AssignWindGenTurbineType3IECToWindGenTurbineType3IECEvent(command.getWindGenTurbineType3IECId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignWindGenTurbineType3IECFromWindGenTurbineType3IECCommand command) throws Exception {
    	...
    	apply(new UnAssignWindGenTurbineType3IECFromWindGenTurbineType3IECEvent(command.getWindGenTurbineType3IECId()));
    }
