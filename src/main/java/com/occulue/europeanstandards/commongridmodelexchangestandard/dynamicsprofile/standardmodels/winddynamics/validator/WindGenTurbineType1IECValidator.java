...
//		Assert.isNull( windGenTurbineType1IEC.getWindGenTurbineType1IECId(), "CreateWindGenTurbineType1IECCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignWindGenTurbineType1IECToWindGenTurbineType1IECCommand command ) throws Exception {
		Assert.notNull( command, "AssignWindGenTurbineType1IECToWindGenTurbineType1IECCommand should not be null" );
		Assert.notNull( command.getWindGenTurbineType1IECId(), "AssignWindGenTurbineType1IECToWindGenTurbineType1IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWindGenTurbineType1IECToWindGenTurbineType1IECCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignWindGenTurbineType1IECFromWindGenTurbineType1IECCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWindGenTurbineType1IECFromWindGenTurbineType1IECCommand should not be null" );
		Assert.notNull( command.getWindGenTurbineType1IECId(), "UnAssignWindGenTurbineType1IECFromWindGenTurbineType1IECCommand identifier should not be null" );
	}
