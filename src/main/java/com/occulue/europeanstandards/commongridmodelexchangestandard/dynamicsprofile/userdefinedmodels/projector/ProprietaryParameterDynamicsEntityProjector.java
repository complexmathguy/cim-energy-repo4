...
public class ProprietaryParameterDynamicsEntityProjector {
     ...
     * @return	ProprietaryParameterDynamics
     */
    public ProprietaryParameterDynamics addToProprietaryParameterDynamics( UUID parentId, ProprietaryParameterDynamics addTo ) {
	    LOGGER.info("handling AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsEvent - " );
	    
	    ProprietaryParameterDynamics parentEntity = repository.findById(parentId).get();
	    ProprietaryParameterDynamics child = ProprietaryParameterDynamicsProjector.find(addTo.getProprietaryParameterDynamicsId());
     ...
     * @return	ProprietaryParameterDynamics
     */
	public ProprietaryParameterDynamics removeFromProprietaryParameterDynamics( UUID parentId, ProprietaryParameterDynamics removeFrom ) {
	    LOGGER.info("handling RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsEvent " );
	
	    ProprietaryParameterDynamics parentEntity = repository.findById(parentId).get();
	    ProprietaryParameterDynamics child = ProprietaryParameterDynamicsProjector.find(removeFrom.getProprietaryParameterDynamicsId());
