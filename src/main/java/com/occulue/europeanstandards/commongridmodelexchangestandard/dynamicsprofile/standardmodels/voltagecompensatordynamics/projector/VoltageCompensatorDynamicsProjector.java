...
public class VoltageCompensatorDynamicsProjector extends VoltageCompensatorDynamicsEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignVoltageCompensatorDynamicsToVoltageCompensatorDynamicsEvent.class)
    public void handle( AssignVoltageCompensatorDynamicsToVoltageCompensatorDynamicsEvent event) {
	    LOGGER.info("handling AssignVoltageCompensatorDynamicsToVoltageCompensatorDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    VoltageCompensatorDynamics entity = assignVoltageCompensatorDynamics( event.getVoltageCompensatorDynamicsId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignVoltageCompensatorDynamicsFromVoltageCompensatorDynamicsEvent.class)
	public void handle( UnAssignVoltageCompensatorDynamicsFromVoltageCompensatorDynamicsEvent event) {
	    LOGGER.info("handling UnAssignVoltageCompensatorDynamicsFromVoltageCompensatorDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    VoltageCompensatorDynamics entity = unAssignVoltageCompensatorDynamics( event.getVoltageCompensatorDynamicsId() );
