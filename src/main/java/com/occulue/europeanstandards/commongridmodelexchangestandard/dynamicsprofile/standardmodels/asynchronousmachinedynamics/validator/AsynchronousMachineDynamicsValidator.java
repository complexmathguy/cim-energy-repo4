...
//		Assert.isNull( asynchronousMachineDynamics.getAsynchronousMachineDynamicsId(), "CreateAsynchronousMachineDynamicsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getAsynchronousMachineDynamicsId(), "AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignAsynchronousMachineDynamicsFromAsynchronousMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignAsynchronousMachineDynamicsFromAsynchronousMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getAsynchronousMachineDynamicsId(), "UnAssignAsynchronousMachineDynamicsFromAsynchronousMachineDynamicsCommand identifier should not be null" );
	}
