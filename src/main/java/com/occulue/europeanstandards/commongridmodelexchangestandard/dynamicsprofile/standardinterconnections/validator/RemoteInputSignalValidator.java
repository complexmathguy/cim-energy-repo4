...
//		Assert.isNull( remoteInputSignal.getRemoteInputSignalId(), "CreateRemoteInputSignalCommand identifier should be null" );
	...
	public void validate( AssignRemoteInputSignalToRemoteInputSignalCommand command ) throws Exception {
		...
		Assert.notNull( command.getRemoteInputSignalId(), "AssignRemoteInputSignalToRemoteInputSignalCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignRemoteInputSignalToRemoteInputSignalCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveRemoteInputSignalFromRemoteInputSignalCommand command ) throws Exception {
		Assert.notNull( command, "RemoveRemoteInputSignalFromRemoteInputSignalCommand should not be null" );
		Assert.notNull( command.getRemoteInputSignalId(), "RemoveRemoteInputSignalFromRemoteInputSignalCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveRemoteInputSignalFromRemoteInputSignalCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getRemoteInputSignalId(), "RemoveRemoteInputSignalFromRemoteInputSignalCommand removeFrom attribubte identifier should not be null" );
	}
