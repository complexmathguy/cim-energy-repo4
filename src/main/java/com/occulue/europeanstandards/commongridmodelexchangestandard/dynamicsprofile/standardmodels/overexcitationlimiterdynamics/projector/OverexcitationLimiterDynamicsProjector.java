...
public class OverexcitationLimiterDynamicsProjector extends OverexcitationLimiterDynamicsEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsEvent.class)
    public void handle( AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsEvent event) {
	    LOGGER.info("handling AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    OverexcitationLimiterDynamics entity = assignOverexcitationLimiterDynamics( event.getOverexcitationLimiterDynamicsId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsEvent.class)
	public void handle( UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsEvent event) {
	    LOGGER.info("handling UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    OverexcitationLimiterDynamics entity = unAssignOverexcitationLimiterDynamics( event.getOverexcitationLimiterDynamicsId() );
