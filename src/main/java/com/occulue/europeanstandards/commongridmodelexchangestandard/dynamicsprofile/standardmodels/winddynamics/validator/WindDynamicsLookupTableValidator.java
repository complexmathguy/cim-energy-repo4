...
//		Assert.isNull( windDynamicsLookupTable.getWindDynamicsLookupTableId(), "CreateWindDynamicsLookupTableCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignWindDynamicsLookupTableToWindDynamicsLookupTableCommand command ) throws Exception {
		Assert.notNull( command, "AssignWindDynamicsLookupTableToWindDynamicsLookupTableCommand should not be null" );
		Assert.notNull( command.getWindDynamicsLookupTableId(), "AssignWindDynamicsLookupTableToWindDynamicsLookupTableCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignWindDynamicsLookupTableToWindDynamicsLookupTableCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveWindDynamicsLookupTableFromWindDynamicsLookupTableCommand command ) throws Exception {
		Assert.notNull( command, "RemoveWindDynamicsLookupTableFromWindDynamicsLookupTableCommand should not be null" );
		Assert.notNull( command.getWindDynamicsLookupTableId(), "RemoveWindDynamicsLookupTableFromWindDynamicsLookupTableCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveWindDynamicsLookupTableFromWindDynamicsLookupTableCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getWindDynamicsLookupTableId(), "RemoveWindDynamicsLookupTableFromWindDynamicsLookupTableCommand removeFrom attribubte identifier should not be null" );
	}
