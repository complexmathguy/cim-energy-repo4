...
public class WindGenTurbineType3IECProjector extends WindGenTurbineType3IECEntityProjector {
    ...
    public void handle( AssignWindGenTurbineType3IECToWindGenTurbineType3IECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindGenTurbineType3IEC entity = assignWindGenTurbineType3IEC( event.getWindGenTurbineType3IECId(), event.getAssignment() );
	...
	public void handle( UnAssignWindGenTurbineType3IECFromWindGenTurbineType3IECEvent event) {
	    LOGGER.info("handling UnAssignWindGenTurbineType3IECFromWindGenTurbineType3IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindGenTurbineType3IEC entity = unAssignWindGenTurbineType3IEC( event.getWindGenTurbineType3IECId() );
