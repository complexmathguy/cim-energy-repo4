...
public class WindTurbineType1or2IECProjector extends WindTurbineType1or2IECEntityProjector {
    ...
    public void handle( AssignWindTurbineType1or2IECToWindTurbineType1or2IECEvent event) {
	    ...
	    // ------------------------------------------
	    WindTurbineType1or2IEC entity = assignWindTurbineType1or2IEC( event.getWindTurbineType1or2IECId(), event.getAssignment() );
	...
	public void handle( UnAssignWindTurbineType1or2IECFromWindTurbineType1or2IECEvent event) {
	    LOGGER.info("handling UnAssignWindTurbineType1or2IECFromWindTurbineType1or2IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindTurbineType1or2IEC entity = unAssignWindTurbineType1or2IEC( event.getWindTurbineType1or2IECId() );
