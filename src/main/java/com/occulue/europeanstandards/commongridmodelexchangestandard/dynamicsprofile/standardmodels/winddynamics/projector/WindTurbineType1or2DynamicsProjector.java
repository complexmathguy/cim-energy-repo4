...
public class WindTurbineType1or2DynamicsProjector extends WindTurbineType1or2DynamicsEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsEvent.class)
    public void handle( AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsEvent event) {
	    LOGGER.info("handling AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindTurbineType1or2Dynamics entity = assignWindTurbineType1or2Dynamics( event.getWindTurbineType1or2DynamicsId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsEvent.class)
	public void handle( UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsEvent event) {
	    LOGGER.info("handling UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindTurbineType1or2Dynamics entity = unAssignWindTurbineType1or2Dynamics( event.getWindTurbineType1or2DynamicsId() );
