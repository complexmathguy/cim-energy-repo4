...
//		Assert.isNull( genICompensationForGenJ.getGenICompensationForGenJId(), "CreateGenICompensationForGenJCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignGenICompensationForGenJToGenICompensationForGenJCommand command ) throws Exception {
		Assert.notNull( command, "AssignGenICompensationForGenJToGenICompensationForGenJCommand should not be null" );
		Assert.notNull( command.getGenICompensationForGenJId(), "AssignGenICompensationForGenJToGenICompensationForGenJCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignGenICompensationForGenJToGenICompensationForGenJCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveGenICompensationForGenJFromGenICompensationForGenJCommand command ) throws Exception {
		Assert.notNull( command, "RemoveGenICompensationForGenJFromGenICompensationForGenJCommand should not be null" );
		Assert.notNull( command.getGenICompensationForGenJId(), "RemoveGenICompensationForGenJFromGenICompensationForGenJCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveGenICompensationForGenJFromGenICompensationForGenJCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getGenICompensationForGenJId(), "RemoveGenICompensationForGenJFromGenICompensationForGenJCommand removeFrom attribubte identifier should not be null" );
	}
