...
public class WindPlantDynamicsAggregate {  
    ...
    public void handle(UpdateWindPlantDynamicsCommand command) throws Exception {
    	...
    	UpdateWindPlantDynamicsEvent event = new UpdateWindPlantDynamicsEvent(command.getWindPlantDynamicsId(), command.getWindPlantDynamics());        
    ...
    public void handle(AssignWindPlantDynamicsToWindPlantDynamicsCommand command) throws Exception {
        ...
        apply(new AssignWindPlantDynamicsToWindPlantDynamicsEvent(command.getWindPlantDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignWindPlantDynamicsFromWindPlantDynamicsCommand command) throws Exception {
    	...
    	apply(new UnAssignWindPlantDynamicsFromWindPlantDynamicsEvent(command.getWindPlantDynamicsId()));
    }
