...
public class SynchronousMachineDynamicsProjector extends SynchronousMachineDynamicsEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsEvent.class)
    public void handle( AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsEvent event) {
	    LOGGER.info("handling AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineDynamics entity = assignSynchronousMachineDynamics( event.getSynchronousMachineDynamicsId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsEvent.class)
	public void handle( UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsEvent event) {
	    LOGGER.info("handling UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineDynamics entity = unAssignSynchronousMachineDynamics( event.getSynchronousMachineDynamicsId() );
