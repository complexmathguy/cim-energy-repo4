...
//		Assert.isNull( pFVArControllerType2Dynamics.getPFVArControllerType2DynamicsId(), "CreatePFVArControllerType2DynamicsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignPFVArControllerType2DynamicsToPFVArControllerType2DynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignPFVArControllerType2DynamicsToPFVArControllerType2DynamicsCommand should not be null" );
		Assert.notNull( command.getPFVArControllerType2DynamicsId(), "AssignPFVArControllerType2DynamicsToPFVArControllerType2DynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPFVArControllerType2DynamicsToPFVArControllerType2DynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignPFVArControllerType2DynamicsFromPFVArControllerType2DynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignPFVArControllerType2DynamicsFromPFVArControllerType2DynamicsCommand should not be null" );
		Assert.notNull( command.getPFVArControllerType2DynamicsId(), "UnAssignPFVArControllerType2DynamicsFromPFVArControllerType2DynamicsCommand identifier should not be null" );
	}
