...
public class WindTurbineType4bIECAggregate {  
    ...
    public void handle(UpdateWindTurbineType4bIECCommand command) throws Exception {
    	...
    	UpdateWindTurbineType4bIECEvent event = new UpdateWindTurbineType4bIECEvent(command.getWindTurbineType4bIECId(), command.getWindTurbineType4bIEC());        
    ...
    @CommandHandler
    public void handle(AssignWindTurbineType4bIECToWindTurbineType4bIECCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignWindTurbineType4bIECToWindTurbineType4bIECCommand" );
    	
    	if (  windTurbineType4bIEC != null && windTurbineType4bIEC.getWindTurbineType4bIECId() == command.getAssignment().getWindTurbineType4bIECId() )
    		throw new ProcessingException( "WindTurbineType4bIEC already assigned with id " + command.getAssignment().getWindTurbineType4bIECId() );  
    		
        apply(new AssignWindTurbineType4bIECToWindTurbineType4bIECEvent(command.getWindTurbineType4bIECId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignWindTurbineType4bIECFromWindTurbineType4bIECCommand command) throws Exception {
    	...
    	apply(new UnAssignWindTurbineType4bIECFromWindTurbineType4bIECEvent(command.getWindTurbineType4bIECId()));
    }
