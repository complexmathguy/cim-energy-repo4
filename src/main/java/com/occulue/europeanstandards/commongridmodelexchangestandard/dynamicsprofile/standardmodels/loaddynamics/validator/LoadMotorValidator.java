...
//		Assert.isNull( loadMotor.getLoadMotorId(), "CreateLoadMotorCommand identifier should be null" );
	...
	public void validate( AssignLoadMotorToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignLoadMotorToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLoadMotorToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLoadMotorFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignLoadMotorFromLoadMotorCommand identifier should not be null" );
	}
