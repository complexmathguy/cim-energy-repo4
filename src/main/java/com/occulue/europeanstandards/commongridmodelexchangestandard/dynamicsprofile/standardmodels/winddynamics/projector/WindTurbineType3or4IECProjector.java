...
public class WindTurbineType3or4IECProjector extends WindTurbineType3or4IECEntityProjector {
    ...
    public void handle( AssignWindTurbineType3or4IECToWindTurbineType3or4IECEvent event) {
	    ...
	    // ------------------------------------------
	    WindTurbineType3or4IEC entity = assignWindTurbineType3or4IEC( event.getWindTurbineType3or4IECId(), event.getAssignment() );
	...
	public void handle( UnAssignWindTurbineType3or4IECFromWindTurbineType3or4IECEvent event) {
	    LOGGER.info("handling UnAssignWindTurbineType3or4IECFromWindTurbineType3or4IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindTurbineType3or4IEC entity = unAssignWindTurbineType3or4IEC( event.getWindTurbineType3or4IECId() );
