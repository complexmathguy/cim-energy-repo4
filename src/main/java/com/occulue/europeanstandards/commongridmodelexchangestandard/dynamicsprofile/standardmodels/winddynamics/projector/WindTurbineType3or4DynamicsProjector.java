...
public class WindTurbineType3or4DynamicsProjector extends WindTurbineType3or4DynamicsEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsEvent.class)
    public void handle( AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsEvent event) {
	    LOGGER.info("handling AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindTurbineType3or4Dynamics entity = assignWindTurbineType3or4Dynamics( event.getWindTurbineType3or4DynamicsId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsEvent.class)
	public void handle( UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsEvent event) {
	    LOGGER.info("handling UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindTurbineType3or4Dynamics entity = unAssignWindTurbineType3or4Dynamics( event.getWindTurbineType3or4DynamicsId() );
