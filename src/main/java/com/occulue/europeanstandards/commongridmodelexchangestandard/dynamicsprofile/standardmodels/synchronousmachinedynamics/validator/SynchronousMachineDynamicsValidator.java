...
//		Assert.isNull( synchronousMachineDynamics.getSynchronousMachineDynamicsId(), "CreateSynchronousMachineDynamicsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineDynamicsId(), "AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineDynamicsId(), "UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsCommand identifier should not be null" );
	}
