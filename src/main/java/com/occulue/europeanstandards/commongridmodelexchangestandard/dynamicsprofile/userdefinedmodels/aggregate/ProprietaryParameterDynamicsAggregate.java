...
public class ProprietaryParameterDynamicsAggregate {  
    ...
    public void handle(UpdateProprietaryParameterDynamicsCommand command) throws Exception {
    	...
    	UpdateProprietaryParameterDynamicsEvent event = new UpdateProprietaryParameterDynamicsEvent(command.getProprietaryParameterDynamicsId(), command.getBooleanParameterValue(), command.getFloatParameterValue(), command.getIntegerParameterValue(), command.getParameterNumber(), command.getProprietaryParameterDynamics());        
    ...
    @CommandHandler
    public void handle(AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsCommand" );
    	
    	if ( proprietaryParameterDynamics.contains( command.getAddTo() ) )
    		throw new ProcessingException( "ProprietaryParameterDynamics already contains an entity with id " + command.getAddTo().getProprietaryParameterDynamicsId() );

    	apply(new AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsEvent(command.getProprietaryParameterDynamicsId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsCommand" );
    	
    	if ( !proprietaryParameterDynamics.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "ProprietaryParameterDynamics does not contain an entity with id " + command.getRemoveFrom().getProprietaryParameterDynamicsId() );

        apply(new RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsEvent(command.getProprietaryParameterDynamicsId(), command.getRemoveFrom()));
    }
    ...
    void on(AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsEvent event ) {
    	LOGGER.info( "Event sourcing AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsEvent" );
	...
	void on(RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsEvent event ) {	
		LOGGER.info( "Event sourcing RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsEvent" );
