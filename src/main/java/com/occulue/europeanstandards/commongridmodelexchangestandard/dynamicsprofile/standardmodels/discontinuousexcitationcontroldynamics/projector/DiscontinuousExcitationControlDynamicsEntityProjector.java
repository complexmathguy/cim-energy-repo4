...
public class DiscontinuousExcitationControlDynamicsEntityProjector {
     ...
     */
    public DiscontinuousExcitationControlDynamics assignDiscontinuousExcitationControlDynamics( UUID parentId, DiscontinuousExcitationControlDynamics assignment ) {
	 ...
	 * @return	DiscontinuousExcitationControlDynamics
	 */
	public DiscontinuousExcitationControlDynamics unAssignDiscontinuousExcitationControlDynamics( UUID parentId ) {
		DiscontinuousExcitationControlDynamics parentEntity = repository.findById(parentId).get();
