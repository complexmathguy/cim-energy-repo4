...
public class PowerSystemStabilizerDynamicsProjector extends PowerSystemStabilizerDynamicsEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignPowerSystemStabilizerDynamicsToPowerSystemStabilizerDynamicsEvent.class)
    public void handle( AssignPowerSystemStabilizerDynamicsToPowerSystemStabilizerDynamicsEvent event) {
	    LOGGER.info("handling AssignPowerSystemStabilizerDynamicsToPowerSystemStabilizerDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    PowerSystemStabilizerDynamics entity = assignPowerSystemStabilizerDynamics( event.getPowerSystemStabilizerDynamicsId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignPowerSystemStabilizerDynamicsFromPowerSystemStabilizerDynamicsEvent.class)
	public void handle( UnAssignPowerSystemStabilizerDynamicsFromPowerSystemStabilizerDynamicsEvent event) {
	    LOGGER.info("handling UnAssignPowerSystemStabilizerDynamicsFromPowerSystemStabilizerDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    PowerSystemStabilizerDynamics entity = unAssignPowerSystemStabilizerDynamics( event.getPowerSystemStabilizerDynamicsId() );
