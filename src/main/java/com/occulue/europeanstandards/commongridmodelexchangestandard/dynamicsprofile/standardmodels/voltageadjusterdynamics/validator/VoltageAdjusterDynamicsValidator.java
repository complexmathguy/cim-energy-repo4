...
//		Assert.isNull( voltageAdjusterDynamics.getVoltageAdjusterDynamicsId(), "CreateVoltageAdjusterDynamicsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignVoltageAdjusterDynamicsToVoltageAdjusterDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignVoltageAdjusterDynamicsToVoltageAdjusterDynamicsCommand should not be null" );
		Assert.notNull( command.getVoltageAdjusterDynamicsId(), "AssignVoltageAdjusterDynamicsToVoltageAdjusterDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVoltageAdjusterDynamicsToVoltageAdjusterDynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVoltageAdjusterDynamicsFromVoltageAdjusterDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVoltageAdjusterDynamicsFromVoltageAdjusterDynamicsCommand should not be null" );
		Assert.notNull( command.getVoltageAdjusterDynamicsId(), "UnAssignVoltageAdjusterDynamicsFromVoltageAdjusterDynamicsCommand identifier should not be null" );
	}
