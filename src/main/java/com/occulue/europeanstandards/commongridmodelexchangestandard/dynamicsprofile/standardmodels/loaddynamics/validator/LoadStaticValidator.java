...
//		Assert.isNull( loadStatic.getLoadStaticId(), "CreateLoadStaticCommand identifier should be null" );
	...
	public void validate( AssignLoadStaticToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignLoadStaticToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLoadStaticToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLoadStaticFromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignLoadStaticFromLoadStaticCommand identifier should not be null" );
	}
