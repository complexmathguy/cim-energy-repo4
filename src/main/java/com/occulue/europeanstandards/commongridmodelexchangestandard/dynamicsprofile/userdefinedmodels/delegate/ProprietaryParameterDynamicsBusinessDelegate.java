...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToProprietaryParameterDynamics( AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsCommand command ) throws ProcessingException {
		...
		ProprietaryParameterDynamicsBusinessDelegate childDelegate 	= ProprietaryParameterDynamicsBusinessDelegate.getProprietaryParameterDynamicsInstance();
		ProprietaryParameterDynamicsBusinessDelegate parentDelegate = ProprietaryParameterDynamicsBusinessDelegate.getProprietaryParameterDynamicsInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a ProprietaryParameterDynamics as ProprietaryParameterDynamics to ProprietaryParameterDynamics" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromProprietaryParameterDynamics( RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsCommand command ) throws ProcessingException {		
