...
public class WindContQIECAggregate {  
    ...
    public WindContQIECAggregate(CreateWindContQIECCommand command) throws Exception {
    	...
    	CreateWindContQIECEvent event = new CreateWindContQIECEvent(command.getWindContQIECId(), command.getWindLVRTQcontrolModesType(), command.getWindQcontrolModesType());
