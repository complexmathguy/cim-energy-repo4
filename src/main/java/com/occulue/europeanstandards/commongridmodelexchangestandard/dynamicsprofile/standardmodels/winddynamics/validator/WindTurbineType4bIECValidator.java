...
//		Assert.isNull( windTurbineType4bIEC.getWindTurbineType4bIECId(), "CreateWindTurbineType4bIECCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignWindTurbineType4bIECToWindTurbineType4bIECCommand command ) throws Exception {
		Assert.notNull( command, "AssignWindTurbineType4bIECToWindTurbineType4bIECCommand should not be null" );
		Assert.notNull( command.getWindTurbineType4bIECId(), "AssignWindTurbineType4bIECToWindTurbineType4bIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWindTurbineType4bIECToWindTurbineType4bIECCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignWindTurbineType4bIECFromWindTurbineType4bIECCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWindTurbineType4bIECFromWindTurbineType4bIECCommand should not be null" );
		Assert.notNull( command.getWindTurbineType4bIECId(), "UnAssignWindTurbineType4bIECFromWindTurbineType4bIECCommand identifier should not be null" );
	}
