...
public class MechanicalLoadDynamicsAggregate {  
    ...
    public void handle(UpdateMechanicalLoadDynamicsCommand command) throws Exception {
    	...
    	UpdateMechanicalLoadDynamicsEvent event = new UpdateMechanicalLoadDynamicsEvent(command.getMechanicalLoadDynamicsId(), command.getMechanicalLoadDynamics());        
    ...
    @CommandHandler
    public void handle(AssignMechanicalLoadDynamicsToMechanicalLoadDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignMechanicalLoadDynamicsToMechanicalLoadDynamicsCommand" );
    	
    	if (  mechanicalLoadDynamics != null && mechanicalLoadDynamics.getMechanicalLoadDynamicsId() == command.getAssignment().getMechanicalLoadDynamicsId() )
    		throw new ProcessingException( "MechanicalLoadDynamics already assigned with id " + command.getAssignment().getMechanicalLoadDynamicsId() );  
    		
        apply(new AssignMechanicalLoadDynamicsToMechanicalLoadDynamicsEvent(command.getMechanicalLoadDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignMechanicalLoadDynamicsFromMechanicalLoadDynamicsCommand command) throws Exception {
    	...
    	apply(new UnAssignMechanicalLoadDynamicsFromMechanicalLoadDynamicsEvent(command.getMechanicalLoadDynamicsId()));
    }
