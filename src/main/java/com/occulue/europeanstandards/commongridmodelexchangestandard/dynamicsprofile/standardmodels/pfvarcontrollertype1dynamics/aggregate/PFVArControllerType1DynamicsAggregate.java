...
public class PFVArControllerType1DynamicsAggregate {  
    ...
    public void handle(UpdatePFVArControllerType1DynamicsCommand command) throws Exception {
    	...
    	UpdatePFVArControllerType1DynamicsEvent event = new UpdatePFVArControllerType1DynamicsEvent(command.getPFVArControllerType1DynamicsId(), command.getPFVArControllerType1Dynamics());        
    ...
    @CommandHandler
    public void handle(AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsCommand" );
        ...
        apply(new AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsEvent(command.getPFVArControllerType1DynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignPFVArControllerType1DynamicsFromPFVArControllerType1DynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignPFVArControllerType1DynamicsFromPFVArControllerType1DynamicsCommand" );
    	...
    	apply(new UnAssignPFVArControllerType1DynamicsFromPFVArControllerType1DynamicsEvent(command.getPFVArControllerType1DynamicsId()));
    }
    ...
    void on(AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsEvent event ) {	
    	LOGGER.info( "Event sourcing AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsEvent" );
	...
	void on(UnAssignPFVArControllerType1DynamicsFromPFVArControllerType1DynamicsEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignPFVArControllerType1DynamicsFromPFVArControllerType1DynamicsEvent" );
