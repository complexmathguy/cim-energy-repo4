...
public class WindGenTurbineType1IECAggregate {  
    ...
    public void handle(UpdateWindGenTurbineType1IECCommand command) throws Exception {
    	...
    	UpdateWindGenTurbineType1IECEvent event = new UpdateWindGenTurbineType1IECEvent(command.getWindGenTurbineType1IECId(), command.getWindGenTurbineType1IEC());        
    ...
    @CommandHandler
    public void handle(AssignWindGenTurbineType1IECToWindGenTurbineType1IECCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignWindGenTurbineType1IECToWindGenTurbineType1IECCommand" );
    	
    	if (  windGenTurbineType1IEC != null && windGenTurbineType1IEC.getWindGenTurbineType1IECId() == command.getAssignment().getWindGenTurbineType1IECId() )
    		throw new ProcessingException( "WindGenTurbineType1IEC already assigned with id " + command.getAssignment().getWindGenTurbineType1IECId() );  
    		
        apply(new AssignWindGenTurbineType1IECToWindGenTurbineType1IECEvent(command.getWindGenTurbineType1IECId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignWindGenTurbineType1IECFromWindGenTurbineType1IECCommand command) throws Exception {
    	...
    	apply(new UnAssignWindGenTurbineType1IECFromWindGenTurbineType1IECEvent(command.getWindGenTurbineType1IECId()));
    }
