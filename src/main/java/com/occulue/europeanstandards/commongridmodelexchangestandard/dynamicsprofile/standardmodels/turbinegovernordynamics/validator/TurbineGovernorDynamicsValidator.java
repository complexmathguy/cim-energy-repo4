...
//		Assert.isNull( turbineGovernorDynamics.getTurbineGovernorDynamicsId(), "CreateTurbineGovernorDynamicsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignTurbineGovernorDynamicsToTurbineGovernorDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignTurbineGovernorDynamicsToTurbineGovernorDynamicsCommand should not be null" );
		Assert.notNull( command.getTurbineGovernorDynamicsId(), "AssignTurbineGovernorDynamicsToTurbineGovernorDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTurbineGovernorDynamicsToTurbineGovernorDynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignTurbineGovernorDynamicsFromTurbineGovernorDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignTurbineGovernorDynamicsFromTurbineGovernorDynamicsCommand should not be null" );
		Assert.notNull( command.getTurbineGovernorDynamicsId(), "UnAssignTurbineGovernorDynamicsFromTurbineGovernorDynamicsCommand identifier should not be null" );
	}
