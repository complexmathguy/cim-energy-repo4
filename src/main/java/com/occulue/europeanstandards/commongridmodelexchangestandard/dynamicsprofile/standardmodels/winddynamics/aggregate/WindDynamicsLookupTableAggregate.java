...
public class WindDynamicsLookupTableAggregate {  
    ...
    public void handle(UpdateWindDynamicsLookupTableCommand command) throws Exception {
    	...
    	UpdateWindDynamicsLookupTableEvent event = new UpdateWindDynamicsLookupTableEvent(command.getWindDynamicsLookupTableId(), command.getInput(), command.getLookupTableFunctionType(), command.getOutput(), command.getSequence(), command.getWindDynamicsLookupTable());        
    ...
    @CommandHandler
    public void handle(AssignWindDynamicsLookupTableToWindDynamicsLookupTableCommand command) throws Exception {
    	...
    	if ( windDynamicsLookupTable.contains( command.getAddTo() ) )
    		throw new ProcessingException( "WindDynamicsLookupTable already contains an entity with id " + command.getAddTo().getWindDynamicsLookupTableId() );

    	apply(new AssignWindDynamicsLookupTableToWindDynamicsLookupTableEvent(command.getWindDynamicsLookupTableId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveWindDynamicsLookupTableFromWindDynamicsLookupTableCommand command) throws Exception {
    	...
    	if ( !windDynamicsLookupTable.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "WindDynamicsLookupTable does not contain an entity with id " + command.getRemoveFrom().getWindDynamicsLookupTableId() );

        apply(new RemoveWindDynamicsLookupTableFromWindDynamicsLookupTableEvent(command.getWindDynamicsLookupTableId(), command.getRemoveFrom()));
    }
