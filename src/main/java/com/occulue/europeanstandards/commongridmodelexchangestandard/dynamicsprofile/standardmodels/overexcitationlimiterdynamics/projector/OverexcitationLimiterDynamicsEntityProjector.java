...
public class OverexcitationLimiterDynamicsEntityProjector {
     ...
     */
    public OverexcitationLimiterDynamics assignOverexcitationLimiterDynamics( UUID parentId, OverexcitationLimiterDynamics assignment ) {
	    ...
	    assignment = OverexcitationLimiterDynamicsProjector.find(assignment.getOverexcitationLimiterDynamicsId());
