...
public class DiscontinuousExcitationControlDynamicsAggregate {  
    ...
    public void handle(UpdateDiscontinuousExcitationControlDynamicsCommand command) throws Exception {
    	...
    	UpdateDiscontinuousExcitationControlDynamicsEvent event = new UpdateDiscontinuousExcitationControlDynamicsEvent(command.getDiscontinuousExcitationControlDynamicsId(), command.getDiscontinuousExcitationControlDynamics());        
    ...
    @CommandHandler
    public void handle(AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsCommand" );
        ...
        apply(new AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsEvent(command.getDiscontinuousExcitationControlDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsCommand" );
    	...
    	apply(new UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsEvent(command.getDiscontinuousExcitationControlDynamicsId()));
    }
	...
	// single associations
    @EventSourcingHandler
    void on(AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsEvent event ) {	
    	LOGGER.info( "Event sourcing AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsEvent" );
    	this.discontinuousExcitationControlDynamics = event.getAssignment();
    }

	@EventSourcingHandler
	void on(UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsEvent" );
