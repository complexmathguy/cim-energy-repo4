...
public class OverexcitationLimiterDynamicsAggregate {  
    ...
    public void handle(UpdateOverexcitationLimiterDynamicsCommand command) throws Exception {
    	...
    	UpdateOverexcitationLimiterDynamicsEvent event = new UpdateOverexcitationLimiterDynamicsEvent(command.getOverexcitationLimiterDynamicsId(), command.getOverexcitationLimiterDynamics());        
    ...
    @CommandHandler
    public void handle(AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsCommand" );
    	
    	if (  overexcitationLimiterDynamics != null && overexcitationLimiterDynamics.getOverexcitationLimiterDynamicsId() == command.getAssignment().getOverexcitationLimiterDynamicsId() )
    		throw new ProcessingException( "OverexcitationLimiterDynamics already assigned with id " + command.getAssignment().getOverexcitationLimiterDynamicsId() );  
    		
        apply(new AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsEvent(command.getOverexcitationLimiterDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsCommand" );
    	...
    	apply(new UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsEvent(command.getOverexcitationLimiterDynamicsId()));
    }
    ...
    void on(AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsEvent event ) {	
    	LOGGER.info( "Event sourcing AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsEvent" );
	...
	void on(UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsEvent" );
