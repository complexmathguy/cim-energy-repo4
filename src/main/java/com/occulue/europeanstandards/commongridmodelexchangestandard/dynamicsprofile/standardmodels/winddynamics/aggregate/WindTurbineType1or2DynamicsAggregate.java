...
public class WindTurbineType1or2DynamicsAggregate {  
    ...
    public void handle(UpdateWindTurbineType1or2DynamicsCommand command) throws Exception {
    	...
    	UpdateWindTurbineType1or2DynamicsEvent event = new UpdateWindTurbineType1or2DynamicsEvent(command.getWindTurbineType1or2DynamicsId(), command.getWindTurbineType1or2Dynamics());        
    ...
    @CommandHandler
    public void handle(AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsCommand" );
    	
    	if (  windTurbineType1or2Dynamics != null && windTurbineType1or2Dynamics.getWindTurbineType1or2DynamicsId() == command.getAssignment().getWindTurbineType1or2DynamicsId() )
    		throw new ProcessingException( "WindTurbineType1or2Dynamics already assigned with id " + command.getAssignment().getWindTurbineType1or2DynamicsId() );  
    		
        apply(new AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsEvent(command.getWindTurbineType1or2DynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsCommand" );
    	...
    	apply(new UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsEvent(command.getWindTurbineType1or2DynamicsId()));
    }
    ...
    void on(AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsEvent event ) {	
    	LOGGER.info( "Event sourcing AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsEvent" );
	...
	void on(UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsEvent" );
