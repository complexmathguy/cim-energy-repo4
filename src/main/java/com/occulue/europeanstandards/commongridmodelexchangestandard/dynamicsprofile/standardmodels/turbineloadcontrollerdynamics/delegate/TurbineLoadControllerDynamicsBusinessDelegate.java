...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignTurbineLoadControllerDynamics( AssignTurbineLoadControllerDynamicsToTurbineLoadControllerDynamicsCommand command ) throws ProcessingException {
		...
		TurbineLoadControllerDynamicsBusinessDelegate childDelegate 	= TurbineLoadControllerDynamicsBusinessDelegate.getTurbineLoadControllerDynamicsInstance();
		TurbineLoadControllerDynamicsBusinessDelegate parentDelegate = TurbineLoadControllerDynamicsBusinessDelegate.getTurbineLoadControllerDynamicsInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTurbineLoadControllerDynamics( UnAssignTurbineLoadControllerDynamicsFromTurbineLoadControllerDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign TurbineLoadControllerDynamics on TurbineLoadControllerDynamics";
