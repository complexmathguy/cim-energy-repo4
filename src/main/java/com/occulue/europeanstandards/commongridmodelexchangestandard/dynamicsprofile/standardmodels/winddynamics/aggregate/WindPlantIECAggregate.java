...
public class WindPlantIECAggregate {  
    ...
    public void handle(UpdateWindPlantIECCommand command) throws Exception {
    	...
    	UpdateWindPlantIECEvent event = new UpdateWindPlantIECEvent(command.getWindPlantIECId(), command.getWindPlantIEC());        
    ...
    public void handle(AssignWindPlantIECToWindPlantIECCommand command) throws Exception {
    	...
    	if (  windPlantIEC != null && windPlantIEC.getWindPlantIECId() == command.getAssignment().getWindPlantIECId() )
    		throw new ProcessingException( "WindPlantIEC already assigned with id " + command.getAssignment().getWindPlantIECId() );  
    		
        apply(new AssignWindPlantIECToWindPlantIECEvent(command.getWindPlantIECId(), command.getAssignment()));
    }
