...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignDiscontinuousExcitationControlDynamics( AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsCommand command ) throws ProcessingException {
		...
		DiscontinuousExcitationControlDynamicsBusinessDelegate parentDelegate = DiscontinuousExcitationControlDynamicsBusinessDelegate.getDiscontinuousExcitationControlDynamicsInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignDiscontinuousExcitationControlDynamics( UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign DiscontinuousExcitationControlDynamics on DiscontinuousExcitationControlDynamics";
