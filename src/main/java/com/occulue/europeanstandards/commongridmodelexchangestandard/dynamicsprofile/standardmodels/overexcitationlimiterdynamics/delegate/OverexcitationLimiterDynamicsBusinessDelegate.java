...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignOverexcitationLimiterDynamics( AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsCommand command ) throws ProcessingException {
		...
		OverexcitationLimiterDynamicsBusinessDelegate childDelegate 	= OverexcitationLimiterDynamicsBusinessDelegate.getOverexcitationLimiterDynamicsInstance();
		OverexcitationLimiterDynamicsBusinessDelegate parentDelegate = OverexcitationLimiterDynamicsBusinessDelegate.getOverexcitationLimiterDynamicsInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignOverexcitationLimiterDynamics( UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign OverexcitationLimiterDynamics on OverexcitationLimiterDynamics";
