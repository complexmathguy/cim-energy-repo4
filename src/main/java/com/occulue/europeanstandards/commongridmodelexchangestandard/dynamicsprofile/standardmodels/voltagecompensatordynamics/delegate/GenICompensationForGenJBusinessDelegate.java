...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToGenICompensationForGenJ( AssignGenICompensationForGenJToGenICompensationForGenJCommand command ) throws ProcessingException {
		...
		GenICompensationForGenJBusinessDelegate childDelegate 	= GenICompensationForGenJBusinessDelegate.getGenICompensationForGenJInstance();
		GenICompensationForGenJBusinessDelegate parentDelegate = GenICompensationForGenJBusinessDelegate.getGenICompensationForGenJInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a GenICompensationForGenJ as GenICompensationForGenJ to GenICompensationForGenJ" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromGenICompensationForGenJ( RemoveGenICompensationForGenJFromGenICompensationForGenJCommand command ) throws ProcessingException {		
