...
//		Assert.isNull( voltageCompensatorDynamics.getVoltageCompensatorDynamicsId(), "CreateVoltageCompensatorDynamicsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignVoltageCompensatorDynamicsToVoltageCompensatorDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignVoltageCompensatorDynamicsToVoltageCompensatorDynamicsCommand should not be null" );
		Assert.notNull( command.getVoltageCompensatorDynamicsId(), "AssignVoltageCompensatorDynamicsToVoltageCompensatorDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVoltageCompensatorDynamicsToVoltageCompensatorDynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVoltageCompensatorDynamicsFromVoltageCompensatorDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVoltageCompensatorDynamicsFromVoltageCompensatorDynamicsCommand should not be null" );
		Assert.notNull( command.getVoltageCompensatorDynamicsId(), "UnAssignVoltageCompensatorDynamicsFromVoltageCompensatorDynamicsCommand identifier should not be null" );
	}
