...
public class PFVArControllerType2DynamicsEntityProjector {
     ...
     */
    public PFVArControllerType2Dynamics assignPFVArControllerType2Dynamics( UUID parentId, PFVArControllerType2Dynamics assignment ) {
	    ...
	    assignment = PFVArControllerType2DynamicsProjector.find(assignment.getPFVArControllerType2DynamicsId());
