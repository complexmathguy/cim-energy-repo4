...
public class WindDynamicsLookupTableEntityProjector {
     ...
     * @return	WindDynamicsLookupTable
     */
    public WindDynamicsLookupTable addToWindDynamicsLookupTable( UUID parentId, WindDynamicsLookupTable addTo ) {
	    LOGGER.info("handling AssignWindDynamicsLookupTableToWindDynamicsLookupTableEvent - " );
	    
	    WindDynamicsLookupTable parentEntity = repository.findById(parentId).get();
	    WindDynamicsLookupTable child = WindDynamicsLookupTableProjector.find(addTo.getWindDynamicsLookupTableId());
     ...
     * @return	WindDynamicsLookupTable
     */
	public WindDynamicsLookupTable removeFromWindDynamicsLookupTable( UUID parentId, WindDynamicsLookupTable removeFrom ) {
	    LOGGER.info("handling RemoveWindDynamicsLookupTableFromWindDynamicsLookupTableEvent " );
	
	    WindDynamicsLookupTable parentEntity = repository.findById(parentId).get();
	    WindDynamicsLookupTable child = WindDynamicsLookupTableProjector.find(removeFrom.getWindDynamicsLookupTableId());
