...
//		Assert.isNull( proprietaryParameterDynamics.getProprietaryParameterDynamicsId(), "CreateProprietaryParameterDynamicsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsCommand should not be null" );
		Assert.notNull( command.getProprietaryParameterDynamicsId(), "AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsCommand should not be null" );
		Assert.notNull( command.getProprietaryParameterDynamicsId(), "RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getProprietaryParameterDynamicsId(), "RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsCommand removeFrom attribubte identifier should not be null" );
	}
