...
//		Assert.isNull( underexcitationLimiterDynamics.getUnderexcitationLimiterDynamicsId(), "CreateUnderexcitationLimiterDynamicsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsCommand should not be null" );
		Assert.notNull( command.getUnderexcitationLimiterDynamicsId(), "AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsCommand should not be null" );
		Assert.notNull( command.getUnderexcitationLimiterDynamicsId(), "UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsCommand identifier should not be null" );
	}
