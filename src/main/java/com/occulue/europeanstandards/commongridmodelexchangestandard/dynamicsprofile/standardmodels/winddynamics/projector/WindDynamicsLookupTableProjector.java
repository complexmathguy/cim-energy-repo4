...
public class WindDynamicsLookupTableProjector extends WindDynamicsLookupTableEntityProjector {
    ...
    public void handle( AssignWindDynamicsLookupTableToWindDynamicsLookupTableEvent event) {
    	...
    	// delegate to addTo 
    	// ------------------------------------------ 
	    WindDynamicsLookupTable entity = addToWindDynamicsLookupTable(event.getWindDynamicsLookupTableId(), event.getAddTo() );
...
public void handle( RemoveWindDynamicsLookupTableFromWindDynamicsLookupTableEvent event) {
    LOGGER.info("handling RemoveWindDynamicsLookupTableFromWindDynamicsLookupTableEvent - " + event );

    WindDynamicsLookupTable entity = removeFromWindDynamicsLookupTable(event.getWindDynamicsLookupTableId(), event.getRemoveFrom() );
