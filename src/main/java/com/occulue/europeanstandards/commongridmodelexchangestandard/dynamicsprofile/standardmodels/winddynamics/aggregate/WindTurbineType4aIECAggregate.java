...
public class WindTurbineType4aIECAggregate {  
    ...
    public void handle(UpdateWindTurbineType4aIECCommand command) throws Exception {
    	...
    	UpdateWindTurbineType4aIECEvent event = new UpdateWindTurbineType4aIECEvent(command.getWindTurbineType4aIECId(), command.getWindTurbineType4aIEC());        
    ...
    @CommandHandler
    public void handle(AssignWindTurbineType4aIECToWindTurbineType4aIECCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignWindTurbineType4aIECToWindTurbineType4aIECCommand" );
    	
    	if (  windTurbineType4aIEC != null && windTurbineType4aIEC.getWindTurbineType4aIECId() == command.getAssignment().getWindTurbineType4aIECId() )
    		throw new ProcessingException( "WindTurbineType4aIEC already assigned with id " + command.getAssignment().getWindTurbineType4aIECId() );  
    		
        apply(new AssignWindTurbineType4aIECToWindTurbineType4aIECEvent(command.getWindTurbineType4aIECId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignWindTurbineType4aIECFromWindTurbineType4aIECCommand command) throws Exception {
    	...
    	apply(new UnAssignWindTurbineType4aIECFromWindTurbineType4aIECEvent(command.getWindTurbineType4aIECId()));
    }
