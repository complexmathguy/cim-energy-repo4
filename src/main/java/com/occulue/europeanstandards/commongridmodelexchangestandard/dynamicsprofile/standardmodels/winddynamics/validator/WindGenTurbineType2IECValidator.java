...
//		Assert.isNull( windGenTurbineType2IEC.getWindGenTurbineType2IECId(), "CreateWindGenTurbineType2IECCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignWindGenTurbineType2IECToWindGenTurbineType2IECCommand command ) throws Exception {
		Assert.notNull( command, "AssignWindGenTurbineType2IECToWindGenTurbineType2IECCommand should not be null" );
		Assert.notNull( command.getWindGenTurbineType2IECId(), "AssignWindGenTurbineType2IECToWindGenTurbineType2IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWindGenTurbineType2IECToWindGenTurbineType2IECCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignWindGenTurbineType2IECFromWindGenTurbineType2IECCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWindGenTurbineType2IECFromWindGenTurbineType2IECCommand should not be null" );
		Assert.notNull( command.getWindGenTurbineType2IECId(), "UnAssignWindGenTurbineType2IECFromWindGenTurbineType2IECCommand identifier should not be null" );
	}
