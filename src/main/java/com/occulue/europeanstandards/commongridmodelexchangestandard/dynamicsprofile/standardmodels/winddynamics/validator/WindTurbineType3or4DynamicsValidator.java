...
//		Assert.isNull( windTurbineType3or4Dynamics.getWindTurbineType3or4DynamicsId(), "CreateWindTurbineType3or4DynamicsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsCommand should not be null" );
		Assert.notNull( command.getWindTurbineType3or4DynamicsId(), "AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsCommand should not be null" );
		Assert.notNull( command.getWindTurbineType3or4DynamicsId(), "UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsCommand identifier should not be null" );
	}
