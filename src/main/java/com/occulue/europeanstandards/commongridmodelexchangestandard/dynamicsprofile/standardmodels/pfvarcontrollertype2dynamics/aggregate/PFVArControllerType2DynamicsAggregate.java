...
public class PFVArControllerType2DynamicsAggregate {  
    ...
    public void handle(UpdatePFVArControllerType2DynamicsCommand command) throws Exception {
    	...
    	UpdatePFVArControllerType2DynamicsEvent event = new UpdatePFVArControllerType2DynamicsEvent(command.getPFVArControllerType2DynamicsId(), command.getPFVArControllerType2Dynamics());        
    ...
    @CommandHandler
    public void handle(AssignPFVArControllerType2DynamicsToPFVArControllerType2DynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignPFVArControllerType2DynamicsToPFVArControllerType2DynamicsCommand" );
    	
    	if (  pFVArControllerType2Dynamics != null && pFVArControllerType2Dynamics.getPFVArControllerType2DynamicsId() == command.getAssignment().getPFVArControllerType2DynamicsId() )
    		throw new ProcessingException( "PFVArControllerType2Dynamics already assigned with id " + command.getAssignment().getPFVArControllerType2DynamicsId() );  
    		
        apply(new AssignPFVArControllerType2DynamicsToPFVArControllerType2DynamicsEvent(command.getPFVArControllerType2DynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignPFVArControllerType2DynamicsFromPFVArControllerType2DynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignPFVArControllerType2DynamicsFromPFVArControllerType2DynamicsCommand" );
    	...
    	apply(new UnAssignPFVArControllerType2DynamicsFromPFVArControllerType2DynamicsEvent(command.getPFVArControllerType2DynamicsId()));
    }
    ...
    void on(AssignPFVArControllerType2DynamicsToPFVArControllerType2DynamicsEvent event ) {	
    	LOGGER.info( "Event sourcing AssignPFVArControllerType2DynamicsToPFVArControllerType2DynamicsEvent" );
	...
	void on(UnAssignPFVArControllerType2DynamicsFromPFVArControllerType2DynamicsEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignPFVArControllerType2DynamicsFromPFVArControllerType2DynamicsEvent" );
