...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToWindDynamicsLookupTable( AssignWindDynamicsLookupTableToWindDynamicsLookupTableCommand command ) throws ProcessingException {
		...
		WindDynamicsLookupTableBusinessDelegate childDelegate 	= WindDynamicsLookupTableBusinessDelegate.getWindDynamicsLookupTableInstance();
		WindDynamicsLookupTableBusinessDelegate parentDelegate = WindDynamicsLookupTableBusinessDelegate.getWindDynamicsLookupTableInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a WindDynamicsLookupTable as WindDynamicsLookupTable to WindDynamicsLookupTable" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromWindDynamicsLookupTable( RemoveWindDynamicsLookupTableFromWindDynamicsLookupTableCommand command ) throws ProcessingException {		
