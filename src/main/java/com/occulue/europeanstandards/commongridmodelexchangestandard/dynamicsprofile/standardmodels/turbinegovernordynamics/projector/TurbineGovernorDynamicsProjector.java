...
public class TurbineGovernorDynamicsProjector extends TurbineGovernorDynamicsEntityProjector {
    ...
    public void handle( AssignTurbineGovernorDynamicsToTurbineGovernorDynamicsEvent event) {
	    ...
	    // ------------------------------------------
	    TurbineGovernorDynamics entity = assignTurbineGovernorDynamics( event.getTurbineGovernorDynamicsId(), event.getAssignment() );
	...
	public void handle( UnAssignTurbineGovernorDynamicsFromTurbineGovernorDynamicsEvent event) {
	    LOGGER.info("handling UnAssignTurbineGovernorDynamicsFromTurbineGovernorDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    TurbineGovernorDynamics entity = unAssignTurbineGovernorDynamics( event.getTurbineGovernorDynamicsId() );
