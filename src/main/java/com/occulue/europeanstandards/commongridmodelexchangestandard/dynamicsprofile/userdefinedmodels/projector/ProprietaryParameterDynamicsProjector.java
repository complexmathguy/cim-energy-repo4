...
public class ProprietaryParameterDynamicsProjector extends ProprietaryParameterDynamicsEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsEvent.class)
    public void handle( AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsEvent event) {
	    LOGGER.info("handling AssignProprietaryParameterDynamicsToProprietaryParameterDynamicsEvent - " + event );
	    
	    // ------------------------------------------
    	// delegate to addTo 
    	// ------------------------------------------ 
	    ProprietaryParameterDynamics entity = addToProprietaryParameterDynamics(event.getProprietaryParameterDynamicsId(), event.getAddTo() );
 ...
 */
@EventHandler( payloadType=RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsEvent.class)
public void handle( RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsEvent event) {
    LOGGER.info("handling RemoveProprietaryParameterDynamicsFromProprietaryParameterDynamicsEvent - " + event );

    ProprietaryParameterDynamics entity = removeFromProprietaryParameterDynamics(event.getProprietaryParameterDynamicsId(), event.getRemoveFrom() );
