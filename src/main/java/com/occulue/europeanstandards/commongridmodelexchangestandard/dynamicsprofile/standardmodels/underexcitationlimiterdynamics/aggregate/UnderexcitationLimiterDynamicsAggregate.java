...
public class UnderexcitationLimiterDynamicsAggregate {  
    ...
    public void handle(UpdateUnderexcitationLimiterDynamicsCommand command) throws Exception {
    	...
    	UpdateUnderexcitationLimiterDynamicsEvent event = new UpdateUnderexcitationLimiterDynamicsEvent(command.getUnderexcitationLimiterDynamicsId(), command.getUnderexcitationLimiterDynamics());        
    ...
    @CommandHandler
    public void handle(AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsCommand" );
        ...
        apply(new AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsEvent(command.getUnderexcitationLimiterDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsCommand" );
    	...
    	apply(new UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsEvent(command.getUnderexcitationLimiterDynamicsId()));
    }
    ...
    void on(AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsEvent event ) {	
    	LOGGER.info( "Event sourcing AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsEvent" );
	...
	void on(UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsEvent" );
