...
public class WindGenTurbineType1IECProjector extends WindGenTurbineType1IECEntityProjector {
    ...
    public void handle( AssignWindGenTurbineType1IECToWindGenTurbineType1IECEvent event) {
	    ...
	    // ------------------------------------------
	    WindGenTurbineType1IEC entity = assignWindGenTurbineType1IEC( event.getWindGenTurbineType1IECId(), event.getAssignment() );
	...
	public void handle( UnAssignWindGenTurbineType1IECFromWindGenTurbineType1IECEvent event) {
	    LOGGER.info("handling UnAssignWindGenTurbineType1IECFromWindGenTurbineType1IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindGenTurbineType1IEC entity = unAssignWindGenTurbineType1IEC( event.getWindGenTurbineType1IECId() );
