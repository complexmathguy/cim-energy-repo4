...
public class MechanicalLoadDynamicsProjector extends MechanicalLoadDynamicsEntityProjector {
    ...
    public void handle( AssignMechanicalLoadDynamicsToMechanicalLoadDynamicsEvent event) {
	    ...
	    // ------------------------------------------
	    MechanicalLoadDynamics entity = assignMechanicalLoadDynamics( event.getMechanicalLoadDynamicsId(), event.getAssignment() );
	...
	public void handle( UnAssignMechanicalLoadDynamicsFromMechanicalLoadDynamicsEvent event) {
	    LOGGER.info("handling UnAssignMechanicalLoadDynamicsFromMechanicalLoadDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    MechanicalLoadDynamics entity = unAssignMechanicalLoadDynamics( event.getMechanicalLoadDynamicsId() );
