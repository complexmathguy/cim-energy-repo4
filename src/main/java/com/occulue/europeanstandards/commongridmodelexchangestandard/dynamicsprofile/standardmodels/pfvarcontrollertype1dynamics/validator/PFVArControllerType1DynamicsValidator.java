...
//		Assert.isNull( pFVArControllerType1Dynamics.getPFVArControllerType1DynamicsId(), "CreatePFVArControllerType1DynamicsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsCommand should not be null" );
		Assert.notNull( command.getPFVArControllerType1DynamicsId(), "AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignPFVArControllerType1DynamicsFromPFVArControllerType1DynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignPFVArControllerType1DynamicsFromPFVArControllerType1DynamicsCommand should not be null" );
		Assert.notNull( command.getPFVArControllerType1DynamicsId(), "UnAssignPFVArControllerType1DynamicsFromPFVArControllerType1DynamicsCommand identifier should not be null" );
	}
