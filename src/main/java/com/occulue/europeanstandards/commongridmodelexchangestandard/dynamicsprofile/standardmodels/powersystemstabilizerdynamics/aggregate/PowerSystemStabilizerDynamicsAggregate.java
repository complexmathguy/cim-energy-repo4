...
public class PowerSystemStabilizerDynamicsAggregate {  
    ...
    public void handle(UpdatePowerSystemStabilizerDynamicsCommand command) throws Exception {
    	...
    	UpdatePowerSystemStabilizerDynamicsEvent event = new UpdatePowerSystemStabilizerDynamicsEvent(command.getPowerSystemStabilizerDynamicsId(), command.getPowerSystemStabilizerDynamics());        
    ...
    @CommandHandler
    public void handle(AssignPowerSystemStabilizerDynamicsToPowerSystemStabilizerDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignPowerSystemStabilizerDynamicsToPowerSystemStabilizerDynamicsCommand" );
        ...
        apply(new AssignPowerSystemStabilizerDynamicsToPowerSystemStabilizerDynamicsEvent(command.getPowerSystemStabilizerDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignPowerSystemStabilizerDynamicsFromPowerSystemStabilizerDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignPowerSystemStabilizerDynamicsFromPowerSystemStabilizerDynamicsCommand" );
    	...
    	apply(new UnAssignPowerSystemStabilizerDynamicsFromPowerSystemStabilizerDynamicsEvent(command.getPowerSystemStabilizerDynamicsId()));
    }
    ...
    void on(AssignPowerSystemStabilizerDynamicsToPowerSystemStabilizerDynamicsEvent event ) {	
    	LOGGER.info( "Event sourcing AssignPowerSystemStabilizerDynamicsToPowerSystemStabilizerDynamicsEvent" );
	...
	void on(UnAssignPowerSystemStabilizerDynamicsFromPowerSystemStabilizerDynamicsEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignPowerSystemStabilizerDynamicsFromPowerSystemStabilizerDynamicsEvent" );
