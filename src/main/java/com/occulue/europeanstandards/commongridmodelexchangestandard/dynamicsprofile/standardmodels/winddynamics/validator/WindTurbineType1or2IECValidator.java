...
//		Assert.isNull( windTurbineType1or2IEC.getWindTurbineType1or2IECId(), "CreateWindTurbineType1or2IECCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignWindTurbineType1or2IECToWindTurbineType1or2IECCommand command ) throws Exception {
		Assert.notNull( command, "AssignWindTurbineType1or2IECToWindTurbineType1or2IECCommand should not be null" );
		Assert.notNull( command.getWindTurbineType1or2IECId(), "AssignWindTurbineType1or2IECToWindTurbineType1or2IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWindTurbineType1or2IECToWindTurbineType1or2IECCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignWindTurbineType1or2IECFromWindTurbineType1or2IECCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWindTurbineType1or2IECFromWindTurbineType1or2IECCommand should not be null" );
		Assert.notNull( command.getWindTurbineType1or2IECId(), "UnAssignWindTurbineType1or2IECFromWindTurbineType1or2IECCommand identifier should not be null" );
	}
