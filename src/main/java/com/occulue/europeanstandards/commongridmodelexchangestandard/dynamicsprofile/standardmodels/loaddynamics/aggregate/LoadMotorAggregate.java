...
public class LoadMotorAggregate {  
    ...
    public void handle(UpdateLoadMotorCommand command) throws Exception {
    	...
    	UpdateLoadMotorEvent event = new UpdateLoadMotorEvent(command.getLoadMotorId(), command.getD(), command.getH(), command.getLfac(), command.getLp(), command.getLpp(), command.getLs(), command.getPfrac(), command.getRa(), command.getTbkr(), command.getTpo(), command.getTppo(), command.getTv(), command.getVt(), command.getLoadMotor());        
    ...
    public void handle(AssignLoadMotorToLoadMotorCommand command) throws Exception {
    	...
    	if (  loadMotor != null && loadMotor.getLoadMotorId() == command.getAssignment().getLoadMotorId() )
    		throw new ProcessingException( "LoadMotor already assigned with id " + command.getAssignment().getLoadMotorId() );  
    ...
    public void handle(UnAssignLoadMotorFromLoadMotorCommand command) throws Exception {
    	...
    	if (  loadMotor == null )
    		throw new ProcessingException( "LoadMotor already has nothing assigned." );  
