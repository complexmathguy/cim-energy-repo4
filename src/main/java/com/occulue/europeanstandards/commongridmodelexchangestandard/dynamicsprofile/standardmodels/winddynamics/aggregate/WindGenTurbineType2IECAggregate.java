...
public class WindGenTurbineType2IECAggregate {  
    ...
    public void handle(UpdateWindGenTurbineType2IECCommand command) throws Exception {
    	...
    	UpdateWindGenTurbineType2IECEvent event = new UpdateWindGenTurbineType2IECEvent(command.getWindGenTurbineType2IECId(), command.getWindGenTurbineType2IEC());        
    ...
    @CommandHandler
    public void handle(AssignWindGenTurbineType2IECToWindGenTurbineType2IECCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignWindGenTurbineType2IECToWindGenTurbineType2IECCommand" );
    	
    	if (  windGenTurbineType2IEC != null && windGenTurbineType2IEC.getWindGenTurbineType2IECId() == command.getAssignment().getWindGenTurbineType2IECId() )
    		throw new ProcessingException( "WindGenTurbineType2IEC already assigned with id " + command.getAssignment().getWindGenTurbineType2IECId() );  
    		
        apply(new AssignWindGenTurbineType2IECToWindGenTurbineType2IECEvent(command.getWindGenTurbineType2IECId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignWindGenTurbineType2IECFromWindGenTurbineType2IECCommand command) throws Exception {
    	...
    	apply(new UnAssignWindGenTurbineType2IECFromWindGenTurbineType2IECEvent(command.getWindGenTurbineType2IECId()));
    }
