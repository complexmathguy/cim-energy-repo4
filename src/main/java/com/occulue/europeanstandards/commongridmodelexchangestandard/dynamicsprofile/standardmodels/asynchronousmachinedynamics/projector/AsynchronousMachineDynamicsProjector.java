...
public class AsynchronousMachineDynamicsProjector extends AsynchronousMachineDynamicsEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsEvent.class)
    public void handle( AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsEvent event) {
	    LOGGER.info("handling AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachineDynamics entity = assignAsynchronousMachineDynamics( event.getAsynchronousMachineDynamicsId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignAsynchronousMachineDynamicsFromAsynchronousMachineDynamicsEvent.class)
	public void handle( UnAssignAsynchronousMachineDynamicsFromAsynchronousMachineDynamicsEvent event) {
	    LOGGER.info("handling UnAssignAsynchronousMachineDynamicsFromAsynchronousMachineDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    AsynchronousMachineDynamics entity = unAssignAsynchronousMachineDynamics( event.getAsynchronousMachineDynamicsId() );
