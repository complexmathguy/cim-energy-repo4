...
public class SynchronousMachineDynamicsAggregate {  
    ...
    public void handle(UpdateSynchronousMachineDynamicsCommand command) throws Exception {
    	...
    	UpdateSynchronousMachineDynamicsEvent event = new UpdateSynchronousMachineDynamicsEvent(command.getSynchronousMachineDynamicsId(), command.getSynchronousMachineDynamics());        
    ...
    @CommandHandler
    public void handle(AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsCommand" );
        ...
        apply(new AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsEvent(command.getSynchronousMachineDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsCommand" );

    	if (  synchronousMachineDynamics == null )
    		throw new ProcessingException( "SynchronousMachineDynamics already has nothing assigned." );  

    	apply(new UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsEvent(command.getSynchronousMachineDynamicsId()));
    }
	...
	void on(UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsEvent" );
