...
public class AsynchronousMachineDynamicsAggregate {  
    ...
    public void handle(UpdateAsynchronousMachineDynamicsCommand command) throws Exception {
    	...
    	UpdateAsynchronousMachineDynamicsEvent event = new UpdateAsynchronousMachineDynamicsEvent(command.getAsynchronousMachineDynamicsId(), command.getAsynchronousMachineDynamics());        
    ...
    @CommandHandler
    public void handle(AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsCommand" );
        ...
        apply(new AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsEvent(command.getAsynchronousMachineDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignAsynchronousMachineDynamicsFromAsynchronousMachineDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignAsynchronousMachineDynamicsFromAsynchronousMachineDynamicsCommand" );
    	...
    	apply(new UnAssignAsynchronousMachineDynamicsFromAsynchronousMachineDynamicsEvent(command.getAsynchronousMachineDynamicsId()));
    }
    ...
    void on(AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsEvent event ) {	
    	LOGGER.info( "Event sourcing AssignAsynchronousMachineDynamicsToAsynchronousMachineDynamicsEvent" );
	...
	void on(UnAssignAsynchronousMachineDynamicsFromAsynchronousMachineDynamicsEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignAsynchronousMachineDynamicsFromAsynchronousMachineDynamicsEvent" );
