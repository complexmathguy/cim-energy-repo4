...
public class WindTurbineType1or2IECAggregate {  
    ...
    public void handle(UpdateWindTurbineType1or2IECCommand command) throws Exception {
    	...
    	UpdateWindTurbineType1or2IECEvent event = new UpdateWindTurbineType1or2IECEvent(command.getWindTurbineType1or2IECId(), command.getWindTurbineType1or2IEC());        
    ...
    @CommandHandler
    public void handle(AssignWindTurbineType1or2IECToWindTurbineType1or2IECCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignWindTurbineType1or2IECToWindTurbineType1or2IECCommand" );
    	
    	if (  windTurbineType1or2IEC != null && windTurbineType1or2IEC.getWindTurbineType1or2IECId() == command.getAssignment().getWindTurbineType1or2IECId() )
    		throw new ProcessingException( "WindTurbineType1or2IEC already assigned with id " + command.getAssignment().getWindTurbineType1or2IECId() );  
    		
        apply(new AssignWindTurbineType1or2IECToWindTurbineType1or2IECEvent(command.getWindTurbineType1or2IECId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignWindTurbineType1or2IECFromWindTurbineType1or2IECCommand command) throws Exception {
    	...
    	apply(new UnAssignWindTurbineType1or2IECFromWindTurbineType1or2IECEvent(command.getWindTurbineType1or2IECId()));
    }
