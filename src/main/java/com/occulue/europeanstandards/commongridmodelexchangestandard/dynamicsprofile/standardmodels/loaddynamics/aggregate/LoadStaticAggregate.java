...
public class LoadStaticAggregate {  
    ...
    public LoadStaticAggregate(CreateLoadStaticCommand command) throws Exception {
    	...
    	CreateLoadStaticEvent event = new CreateLoadStaticEvent(command.getLoadStaticId(), command.getStaticLoadModelType());
    ...
    public void handle(AssignLoadStaticToLoadStaticCommand command) throws Exception {
    	...
    	if (  loadStatic != null && loadStatic.getLoadStaticId() == command.getAssignment().getLoadStaticId() )
    		throw new ProcessingException( "LoadStatic already assigned with id " + command.getAssignment().getLoadStaticId() );  
    		
        apply(new AssignLoadStaticToLoadStaticEvent(command.getLoadStaticId(), command.getAssignment()));
    }
