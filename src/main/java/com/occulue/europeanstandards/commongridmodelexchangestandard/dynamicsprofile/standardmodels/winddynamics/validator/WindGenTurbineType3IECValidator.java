...
//		Assert.isNull( windGenTurbineType3IEC.getWindGenTurbineType3IECId(), "CreateWindGenTurbineType3IECCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignWindGenTurbineType3IECToWindGenTurbineType3IECCommand command ) throws Exception {
		Assert.notNull( command, "AssignWindGenTurbineType3IECToWindGenTurbineType3IECCommand should not be null" );
		Assert.notNull( command.getWindGenTurbineType3IECId(), "AssignWindGenTurbineType3IECToWindGenTurbineType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWindGenTurbineType3IECToWindGenTurbineType3IECCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignWindGenTurbineType3IECFromWindGenTurbineType3IECCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWindGenTurbineType3IECFromWindGenTurbineType3IECCommand should not be null" );
		Assert.notNull( command.getWindGenTurbineType3IECId(), "UnAssignWindGenTurbineType3IECFromWindGenTurbineType3IECCommand identifier should not be null" );
	}
