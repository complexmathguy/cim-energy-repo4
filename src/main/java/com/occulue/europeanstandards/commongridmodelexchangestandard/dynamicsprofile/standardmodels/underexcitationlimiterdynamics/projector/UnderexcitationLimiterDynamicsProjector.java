...
public class UnderexcitationLimiterDynamicsProjector extends UnderexcitationLimiterDynamicsEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsEvent.class)
    public void handle( AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsEvent event) {
	    LOGGER.info("handling AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    UnderexcitationLimiterDynamics entity = assignUnderexcitationLimiterDynamics( event.getUnderexcitationLimiterDynamicsId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsEvent.class)
	public void handle( UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsEvent event) {
	    LOGGER.info("handling UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    UnderexcitationLimiterDynamics entity = unAssignUnderexcitationLimiterDynamics( event.getUnderexcitationLimiterDynamicsId() );
