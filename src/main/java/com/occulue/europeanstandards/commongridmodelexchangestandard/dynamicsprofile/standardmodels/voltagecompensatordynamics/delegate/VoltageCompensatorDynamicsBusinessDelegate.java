...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignVoltageCompensatorDynamics( AssignVoltageCompensatorDynamicsToVoltageCompensatorDynamicsCommand command ) throws ProcessingException {
		...
		VoltageCompensatorDynamicsBusinessDelegate parentDelegate = VoltageCompensatorDynamicsBusinessDelegate.getVoltageCompensatorDynamicsInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignVoltageCompensatorDynamics( UnAssignVoltageCompensatorDynamicsFromVoltageCompensatorDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign VoltageCompensatorDynamics on VoltageCompensatorDynamics";
