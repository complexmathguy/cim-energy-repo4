...
public class TurbineLoadControllerDynamicsEntityProjector {
     ...
     */
    public TurbineLoadControllerDynamics assignTurbineLoadControllerDynamics( UUID parentId, TurbineLoadControllerDynamics assignment ) {
	    ...
	    assignment = TurbineLoadControllerDynamicsProjector.find(assignment.getTurbineLoadControllerDynamicsId());
