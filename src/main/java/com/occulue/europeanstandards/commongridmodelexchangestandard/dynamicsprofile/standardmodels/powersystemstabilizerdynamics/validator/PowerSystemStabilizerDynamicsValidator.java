...
//		Assert.isNull( powerSystemStabilizerDynamics.getPowerSystemStabilizerDynamicsId(), "CreatePowerSystemStabilizerDynamicsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignPowerSystemStabilizerDynamicsToPowerSystemStabilizerDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignPowerSystemStabilizerDynamicsToPowerSystemStabilizerDynamicsCommand should not be null" );
		Assert.notNull( command.getPowerSystemStabilizerDynamicsId(), "AssignPowerSystemStabilizerDynamicsToPowerSystemStabilizerDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPowerSystemStabilizerDynamicsToPowerSystemStabilizerDynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignPowerSystemStabilizerDynamicsFromPowerSystemStabilizerDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignPowerSystemStabilizerDynamicsFromPowerSystemStabilizerDynamicsCommand should not be null" );
		Assert.notNull( command.getPowerSystemStabilizerDynamicsId(), "UnAssignPowerSystemStabilizerDynamicsFromPowerSystemStabilizerDynamicsCommand identifier should not be null" );
	}
