...
public class ExcitationSystemDynamicsAggregate {  
    ...
    public void handle(UpdateExcitationSystemDynamicsCommand command) throws Exception {
    	...
    	UpdateExcitationSystemDynamicsEvent event = new UpdateExcitationSystemDynamicsEvent(command.getExcitationSystemDynamicsId(), command.getExcitationSystemDynamics());        
    ...
    @CommandHandler
    public void handle(AssignExcitationSystemDynamicsToExcitationSystemDynamicsCommand command) throws Exception {
        ...
        apply(new AssignExcitationSystemDynamicsToExcitationSystemDynamicsEvent(command.getExcitationSystemDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignExcitationSystemDynamicsFromExcitationSystemDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignExcitationSystemDynamicsFromExcitationSystemDynamicsCommand" );

    	if (  excitationSystemDynamics == null )
    		throw new ProcessingException( "ExcitationSystemDynamics already has nothing assigned." );  

    	apply(new UnAssignExcitationSystemDynamicsFromExcitationSystemDynamicsEvent(command.getExcitationSystemDynamicsId()));
    }
