...
public class TurbineGovernorDynamicsAggregate {  
    ...
    public void handle(UpdateTurbineGovernorDynamicsCommand command) throws Exception {
    	...
    	UpdateTurbineGovernorDynamicsEvent event = new UpdateTurbineGovernorDynamicsEvent(command.getTurbineGovernorDynamicsId(), command.getTurbineGovernorDynamics());        
    ...
    @CommandHandler
    public void handle(AssignTurbineGovernorDynamicsToTurbineGovernorDynamicsCommand command) throws Exception {
        ...
        apply(new AssignTurbineGovernorDynamicsToTurbineGovernorDynamicsEvent(command.getTurbineGovernorDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignTurbineGovernorDynamicsFromTurbineGovernorDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignTurbineGovernorDynamicsFromTurbineGovernorDynamicsCommand" );

    	if (  turbineGovernorDynamics == null )
    		throw new ProcessingException( "TurbineGovernorDynamics already has nothing assigned." );  

    	apply(new UnAssignTurbineGovernorDynamicsFromTurbineGovernorDynamicsEvent(command.getTurbineGovernorDynamicsId()));
    }
