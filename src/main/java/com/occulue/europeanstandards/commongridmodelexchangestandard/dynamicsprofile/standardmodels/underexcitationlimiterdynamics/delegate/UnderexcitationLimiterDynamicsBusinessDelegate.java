...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignUnderexcitationLimiterDynamics( AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsCommand command ) throws ProcessingException {
		...
		UnderexcitationLimiterDynamicsBusinessDelegate parentDelegate = UnderexcitationLimiterDynamicsBusinessDelegate.getUnderexcitationLimiterDynamicsInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignUnderexcitationLimiterDynamics( UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign UnderexcitationLimiterDynamics on UnderexcitationLimiterDynamics";
