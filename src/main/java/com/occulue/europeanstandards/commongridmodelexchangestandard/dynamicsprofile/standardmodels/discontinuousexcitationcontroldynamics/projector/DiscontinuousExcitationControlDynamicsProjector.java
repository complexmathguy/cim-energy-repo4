...
public class DiscontinuousExcitationControlDynamicsProjector extends DiscontinuousExcitationControlDynamicsEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsEvent.class)
    public void handle( AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsEvent event) {
	    LOGGER.info("handling AssignDiscontinuousExcitationControlDynamicsToDiscontinuousExcitationControlDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscontinuousExcitationControlDynamics entity = assignDiscontinuousExcitationControlDynamics( event.getDiscontinuousExcitationControlDynamicsId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsEvent.class)
	public void handle( UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsEvent event) {
	    LOGGER.info("handling UnAssignDiscontinuousExcitationControlDynamicsFromDiscontinuousExcitationControlDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DiscontinuousExcitationControlDynamics entity = unAssignDiscontinuousExcitationControlDynamics( event.getDiscontinuousExcitationControlDynamicsId() );
