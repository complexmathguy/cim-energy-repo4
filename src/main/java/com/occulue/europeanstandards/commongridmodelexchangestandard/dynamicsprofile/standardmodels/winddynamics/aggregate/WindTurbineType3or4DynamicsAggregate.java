...
public class WindTurbineType3or4DynamicsAggregate {  
    ...
    public void handle(UpdateWindTurbineType3or4DynamicsCommand command) throws Exception {
    	...
    	UpdateWindTurbineType3or4DynamicsEvent event = new UpdateWindTurbineType3or4DynamicsEvent(command.getWindTurbineType3or4DynamicsId(), command.getWindTurbineType3or4Dynamics());        
    ...
    @CommandHandler
    public void handle(AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsCommand" );
    	
    	if (  windTurbineType3or4Dynamics != null && windTurbineType3or4Dynamics.getWindTurbineType3or4DynamicsId() == command.getAssignment().getWindTurbineType3or4DynamicsId() )
    		throw new ProcessingException( "WindTurbineType3or4Dynamics already assigned with id " + command.getAssignment().getWindTurbineType3or4DynamicsId() );  
    		
        apply(new AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsEvent(command.getWindTurbineType3or4DynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsCommand" );
    	...
    	apply(new UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsEvent(command.getWindTurbineType3or4DynamicsId()));
    }
    ...
    void on(AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsEvent event ) {	
    	LOGGER.info( "Event sourcing AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsEvent" );
	...
	void on(UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsEvent" );
