...
//		Assert.isNull( overexcitationLimiterDynamics.getOverexcitationLimiterDynamicsId(), "CreateOverexcitationLimiterDynamicsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsCommand should not be null" );
		Assert.notNull( command.getOverexcitationLimiterDynamicsId(), "AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsCommand should not be null" );
		Assert.notNull( command.getOverexcitationLimiterDynamicsId(), "UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsCommand identifier should not be null" );
	}
