...
public class GenICompensationForGenJProjector extends GenICompensationForGenJEntityProjector {
    ...
    public void handle( AssignGenICompensationForGenJToGenICompensationForGenJEvent event) {
    	...
    	// delegate to addTo 
    	// ------------------------------------------ 
	    GenICompensationForGenJ entity = addToGenICompensationForGenJ(event.getGenICompensationForGenJId(), event.getAddTo() );
...
public void handle( RemoveGenICompensationForGenJFromGenICompensationForGenJEvent event) {
    LOGGER.info("handling RemoveGenICompensationForGenJFromGenICompensationForGenJEvent - " + event );

    GenICompensationForGenJ entity = removeFromGenICompensationForGenJ(event.getGenICompensationForGenJId(), event.getRemoveFrom() );
