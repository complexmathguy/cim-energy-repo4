...
public class VoltageAdjusterDynamicsProjector extends VoltageAdjusterDynamicsEntityProjector {
    ...
    public void handle( AssignVoltageAdjusterDynamicsToVoltageAdjusterDynamicsEvent event) {
	    ...
	    // ------------------------------------------
	    VoltageAdjusterDynamics entity = assignVoltageAdjusterDynamics( event.getVoltageAdjusterDynamicsId(), event.getAssignment() );
	...
	public void handle( UnAssignVoltageAdjusterDynamicsFromVoltageAdjusterDynamicsEvent event) {
	    LOGGER.info("handling UnAssignVoltageAdjusterDynamicsFromVoltageAdjusterDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    VoltageAdjusterDynamics entity = unAssignVoltageAdjusterDynamics( event.getVoltageAdjusterDynamicsId() );
