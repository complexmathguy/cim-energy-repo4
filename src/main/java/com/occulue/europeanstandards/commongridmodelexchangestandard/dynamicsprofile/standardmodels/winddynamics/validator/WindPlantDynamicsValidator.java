...
//		Assert.isNull( windPlantDynamics.getWindPlantDynamicsId(), "CreateWindPlantDynamicsCommand identifier should be null" );
	...
	public void validate( AssignWindPlantDynamicsToWindPlantDynamicsCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPlantDynamicsId(), "AssignWindPlantDynamicsToWindPlantDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWindPlantDynamicsToWindPlantDynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignWindPlantDynamicsFromWindPlantDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWindPlantDynamicsFromWindPlantDynamicsCommand should not be null" );
		Assert.notNull( command.getWindPlantDynamicsId(), "UnAssignWindPlantDynamicsFromWindPlantDynamicsCommand identifier should not be null" );
	}
