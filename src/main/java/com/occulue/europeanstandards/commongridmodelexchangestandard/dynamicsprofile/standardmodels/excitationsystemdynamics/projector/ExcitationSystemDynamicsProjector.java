...
public class ExcitationSystemDynamicsProjector extends ExcitationSystemDynamicsEntityProjector {
    ...
    public void handle( AssignExcitationSystemDynamicsToExcitationSystemDynamicsEvent event) {
	    LOGGER.info("handling AssignExcitationSystemDynamicsToExcitationSystemDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    ExcitationSystemDynamics entity = assignExcitationSystemDynamics( event.getExcitationSystemDynamicsId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignExcitationSystemDynamicsFromExcitationSystemDynamicsEvent.class)
	public void handle( UnAssignExcitationSystemDynamicsFromExcitationSystemDynamicsEvent event) {
	    LOGGER.info("handling UnAssignExcitationSystemDynamicsFromExcitationSystemDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    ExcitationSystemDynamics entity = unAssignExcitationSystemDynamics( event.getExcitationSystemDynamicsId() );
