...
public class GenICompensationForGenJEntityProjector {
     ...
     * @return	GenICompensationForGenJ
     */
    public GenICompensationForGenJ addToGenICompensationForGenJ( UUID parentId, GenICompensationForGenJ addTo ) {
	    LOGGER.info("handling AssignGenICompensationForGenJToGenICompensationForGenJEvent - " );
	    
	    GenICompensationForGenJ parentEntity = repository.findById(parentId).get();
	    GenICompensationForGenJ child = GenICompensationForGenJProjector.find(addTo.getGenICompensationForGenJId());
     ...
     * @return	GenICompensationForGenJ
     */
	public GenICompensationForGenJ removeFromGenICompensationForGenJ( UUID parentId, GenICompensationForGenJ removeFrom ) {
	    LOGGER.info("handling RemoveGenICompensationForGenJFromGenICompensationForGenJEvent " );
	
	    GenICompensationForGenJ parentEntity = repository.findById(parentId).get();
	    GenICompensationForGenJ child = GenICompensationForGenJProjector.find(removeFrom.getGenICompensationForGenJId());
