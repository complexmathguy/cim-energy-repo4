...
public class WindGenTurbineType2IECProjector extends WindGenTurbineType2IECEntityProjector {
    ...
    public void handle( AssignWindGenTurbineType2IECToWindGenTurbineType2IECEvent event) {
	    ...
	    // ------------------------------------------
	    WindGenTurbineType2IEC entity = assignWindGenTurbineType2IEC( event.getWindGenTurbineType2IECId(), event.getAssignment() );
	...
	public void handle( UnAssignWindGenTurbineType2IECFromWindGenTurbineType2IECEvent event) {
	    LOGGER.info("handling UnAssignWindGenTurbineType2IECFromWindGenTurbineType2IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindGenTurbineType2IEC entity = unAssignWindGenTurbineType2IEC( event.getWindGenTurbineType2IECId() );
