...
//		Assert.isNull( windTurbineType3or4IEC.getWindTurbineType3or4IECId(), "CreateWindTurbineType3or4IECCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignWindTurbineType3or4IECToWindTurbineType3or4IECCommand command ) throws Exception {
		Assert.notNull( command, "AssignWindTurbineType3or4IECToWindTurbineType3or4IECCommand should not be null" );
		Assert.notNull( command.getWindTurbineType3or4IECId(), "AssignWindTurbineType3or4IECToWindTurbineType3or4IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWindTurbineType3or4IECToWindTurbineType3or4IECCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignWindTurbineType3or4IECFromWindTurbineType3or4IECCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWindTurbineType3or4IECFromWindTurbineType3or4IECCommand should not be null" );
		Assert.notNull( command.getWindTurbineType3or4IECId(), "UnAssignWindTurbineType3or4IECFromWindTurbineType3or4IECCommand identifier should not be null" );
	}
