...
//		Assert.isNull( windTurbineType1or2Dynamics.getWindTurbineType1or2DynamicsId(), "CreateWindTurbineType1or2DynamicsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsCommand should not be null" );
		Assert.notNull( command.getWindTurbineType1or2DynamicsId(), "AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsCommand should not be null" );
		Assert.notNull( command.getWindTurbineType1or2DynamicsId(), "UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsCommand identifier should not be null" );
	}
