...
//		Assert.isNull( location.getLocationId(), "CreateLocationCommand identifier should be null" );
	...
	public void validate( AssignLocationToLocationCommand command ) throws Exception {
		...
		Assert.notNull( command.getLocationId(), "AssignLocationToLocationCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLocationToLocationCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLocationFromLocationCommand command ) throws Exception {
		...
		Assert.notNull( command.getLocationId(), "UnAssignLocationFromLocationCommand identifier should not be null" );
	}
