...
//		Assert.isNull( positionPoint.getPositionPointId(), "CreatePositionPointCommand identifier should be null" );
	...
	public void validate( AssignPositionPointsToPositionPointCommand command ) throws Exception {
		...
		Assert.notNull( command.getPositionPointId(), "AssignPositionPointsToPositionPointCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignPositionPointsToPositionPointCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemovePositionPointsFromPositionPointCommand command ) throws Exception {
		...
		Assert.notNull( command.getPositionPointId(), "RemovePositionPointsFromPositionPointCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemovePositionPointsFromPositionPointCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getPositionPointId(), "RemovePositionPointsFromPositionPointCommand removeFrom attribubte identifier should not be null" );
	}
