...
public class PositionPointAggregate {  
    ...
    public void handle(UpdatePositionPointCommand command) throws Exception {
    	...
    	UpdatePositionPointEvent event = new UpdatePositionPointEvent(command.getPositionPointId(), command.getSequenceNumber(), command.getXPosition(), command.getYPosition(), command.getZPosition(), command.getPositionPoints());        
    ...
    public void handle(AssignPositionPointsToPositionPointCommand command) throws Exception {
    	...
    	if ( positionPoints.contains( command.getAddTo() ) )
    		throw new ProcessingException( "PositionPoints already contains an entity with id " + command.getAddTo().getPositionPointId() );

    	apply(new AssignPositionPointsToPositionPointEvent(command.getPositionPointId(), command.getAddTo()));
    }
    ...
    public void handle(RemovePositionPointsFromPositionPointCommand command) throws Exception {
    	...
    	if ( !positionPoints.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "PositionPoints does not contain an entity with id " + command.getRemoveFrom().getPositionPointId() );

        apply(new RemovePositionPointsFromPositionPointEvent(command.getPositionPointId(), command.getRemoveFrom()));
    }
