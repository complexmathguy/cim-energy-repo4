...
public class SvShuntCompensatorSectionsProjector extends SvShuntCompensatorSectionsEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignSvShuntCompensatorSectionsToSvShuntCompensatorSectionsEvent.class)
    public void handle( AssignSvShuntCompensatorSectionsToSvShuntCompensatorSectionsEvent event) {
	    LOGGER.info("handling AssignSvShuntCompensatorSectionsToSvShuntCompensatorSectionsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SvShuntCompensatorSections entity = assignSvShuntCompensatorSections( event.getSvShuntCompensatorSectionsId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignSvShuntCompensatorSectionsFromSvShuntCompensatorSectionsEvent.class)
	public void handle( UnAssignSvShuntCompensatorSectionsFromSvShuntCompensatorSectionsEvent event) {
	    LOGGER.info("handling UnAssignSvShuntCompensatorSectionsFromSvShuntCompensatorSectionsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SvShuntCompensatorSections entity = unAssignSvShuntCompensatorSections( event.getSvShuntCompensatorSectionsId() );
