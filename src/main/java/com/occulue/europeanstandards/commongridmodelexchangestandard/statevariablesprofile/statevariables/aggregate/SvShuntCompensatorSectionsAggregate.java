...
public class SvShuntCompensatorSectionsAggregate {  
    ...
    public void handle(UpdateSvShuntCompensatorSectionsCommand command) throws Exception {
    	...
    	UpdateSvShuntCompensatorSectionsEvent event = new UpdateSvShuntCompensatorSectionsEvent(command.getSvShuntCompensatorSectionsId(), command.getSections(), command.getSvShuntCompensatorSections());        
    ...
    @CommandHandler
    public void handle(AssignSvShuntCompensatorSectionsToSvShuntCompensatorSectionsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignSvShuntCompensatorSectionsToSvShuntCompensatorSectionsCommand" );
    	
    	if (  svShuntCompensatorSections != null && svShuntCompensatorSections.getSvShuntCompensatorSectionsId() == command.getAssignment().getSvShuntCompensatorSectionsId() )
    		throw new ProcessingException( "SvShuntCompensatorSections already assigned with id " + command.getAssignment().getSvShuntCompensatorSectionsId() );  
    		
        apply(new AssignSvShuntCompensatorSectionsToSvShuntCompensatorSectionsEvent(command.getSvShuntCompensatorSectionsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignSvShuntCompensatorSectionsFromSvShuntCompensatorSectionsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignSvShuntCompensatorSectionsFromSvShuntCompensatorSectionsCommand" );

    	if (  svShuntCompensatorSections == null )
    		throw new ProcessingException( "SvShuntCompensatorSections already has nothing assigned." );  

    	apply(new UnAssignSvShuntCompensatorSectionsFromSvShuntCompensatorSectionsEvent(command.getSvShuntCompensatorSectionsId()));
    }
	...
	void on(UnAssignSvShuntCompensatorSectionsFromSvShuntCompensatorSectionsEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignSvShuntCompensatorSectionsFromSvShuntCompensatorSectionsEvent" );
