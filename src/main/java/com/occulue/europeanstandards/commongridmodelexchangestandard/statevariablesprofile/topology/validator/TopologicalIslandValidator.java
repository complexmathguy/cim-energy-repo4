...
//		Assert.isNull( topologicalIsland.getTopologicalIslandId(), "CreateTopologicalIslandCommand identifier should be null" );
	...
	public void validate( AssignTopologicalIslandToTopologicalIslandCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologicalIslandId(), "AssignTopologicalIslandToTopologicalIslandCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTopologicalIslandToTopologicalIslandCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignTopologicalIslandFromTopologicalIslandCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignTopologicalIslandFromTopologicalIslandCommand should not be null" );
		Assert.notNull( command.getTopologicalIslandId(), "UnAssignTopologicalIslandFromTopologicalIslandCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignAngleRefTopologicalIslandToTopologicalIslandCommand command ) throws Exception {
		Assert.notNull( command, "AssignAngleRefTopologicalIslandToTopologicalIslandCommand should not be null" );
		Assert.notNull( command.getTopologicalIslandId(), "AssignAngleRefTopologicalIslandToTopologicalIslandCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAngleRefTopologicalIslandToTopologicalIslandCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignAngleRefTopologicalIslandFromTopologicalIslandCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignAngleRefTopologicalIslandFromTopologicalIslandCommand should not be null" );
		Assert.notNull( command.getTopologicalIslandId(), "UnAssignAngleRefTopologicalIslandFromTopologicalIslandCommand identifier should not be null" );
	}
