...
//		Assert.isNull( svStatus.getSvStatusId(), "CreateSvStatusCommand identifier should be null" );
	...
	public void validate( AssignSvStatusToSvStatusCommand command ) throws Exception {
		...
		Assert.notNull( command.getSvStatusId(), "AssignSvStatusToSvStatusCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSvStatusToSvStatusCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSvStatusFromSvStatusCommand command ) throws Exception {
		...
		Assert.notNull( command.getSvStatusId(), "UnAssignSvStatusFromSvStatusCommand identifier should not be null" );
	}
