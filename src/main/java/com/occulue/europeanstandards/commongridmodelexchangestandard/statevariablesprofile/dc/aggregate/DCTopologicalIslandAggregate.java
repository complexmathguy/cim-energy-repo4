...
public class DCTopologicalIslandAggregate {  
    ...
    public void handle(UpdateDCTopologicalIslandCommand command) throws Exception {
    	...
    	UpdateDCTopologicalIslandEvent event = new UpdateDCTopologicalIslandEvent(command.getDCTopologicalIslandId(), command.getDCTopologicalIsland());        
    ...
    @CommandHandler
    public void handle(AssignDCTopologicalIslandToDCTopologicalIslandCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignDCTopologicalIslandToDCTopologicalIslandCommand" );
    	
    	if (  dCTopologicalIsland != null && dCTopologicalIsland.getDCTopologicalIslandId() == command.getAssignment().getDCTopologicalIslandId() )
    		throw new ProcessingException( "DCTopologicalIsland already assigned with id " + command.getAssignment().getDCTopologicalIslandId() );  
    		
        apply(new AssignDCTopologicalIslandToDCTopologicalIslandEvent(command.getDCTopologicalIslandId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignDCTopologicalIslandFromDCTopologicalIslandCommand command) throws Exception {
    	...
    	apply(new UnAssignDCTopologicalIslandFromDCTopologicalIslandEvent(command.getDCTopologicalIslandId()));
    }
