...
//		Assert.isNull( dCTopologicalIsland.getDCTopologicalIslandId(), "CreateDCTopologicalIslandCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignDCTopologicalIslandToDCTopologicalIslandCommand command ) throws Exception {
		Assert.notNull( command, "AssignDCTopologicalIslandToDCTopologicalIslandCommand should not be null" );
		Assert.notNull( command.getDCTopologicalIslandId(), "AssignDCTopologicalIslandToDCTopologicalIslandCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDCTopologicalIslandToDCTopologicalIslandCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignDCTopologicalIslandFromDCTopologicalIslandCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignDCTopologicalIslandFromDCTopologicalIslandCommand should not be null" );
		Assert.notNull( command.getDCTopologicalIslandId(), "UnAssignDCTopologicalIslandFromDCTopologicalIslandCommand identifier should not be null" );
	}
