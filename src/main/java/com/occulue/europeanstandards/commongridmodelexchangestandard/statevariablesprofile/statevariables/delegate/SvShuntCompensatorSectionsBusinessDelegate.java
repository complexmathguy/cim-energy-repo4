...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignSvShuntCompensatorSections( AssignSvShuntCompensatorSectionsToSvShuntCompensatorSectionsCommand command ) throws ProcessingException {
		...
		SvShuntCompensatorSectionsBusinessDelegate childDelegate 	= SvShuntCompensatorSectionsBusinessDelegate.getSvShuntCompensatorSectionsInstance();
		SvShuntCompensatorSectionsBusinessDelegate parentDelegate = SvShuntCompensatorSectionsBusinessDelegate.getSvShuntCompensatorSectionsInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSvShuntCompensatorSections( UnAssignSvShuntCompensatorSectionsFromSvShuntCompensatorSectionsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign SvShuntCompensatorSections on SvShuntCompensatorSections";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
