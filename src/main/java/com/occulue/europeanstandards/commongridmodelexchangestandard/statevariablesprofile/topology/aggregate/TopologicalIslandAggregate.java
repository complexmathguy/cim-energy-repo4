...
public class TopologicalIslandAggregate {  
    ...
    public void handle(UpdateTopologicalIslandCommand command) throws Exception {
    	...
    	UpdateTopologicalIslandEvent event = new UpdateTopologicalIslandEvent(command.getTopologicalIslandId(), command.getTopologicalIsland(), command.getAngleRefTopologicalIsland());        
    ...
    public void handle(AssignTopologicalIslandToTopologicalIslandCommand command) throws Exception {
    	...
    	if (  topologicalIsland != null && topologicalIsland.getTopologicalIslandId() == command.getAssignment().getTopologicalIslandId() )
    		throw new ProcessingException( "TopologicalIsland already assigned with id " + command.getAssignment().getTopologicalIslandId() );  
    		
        apply(new AssignTopologicalIslandToTopologicalIslandEvent(command.getTopologicalIslandId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignTopologicalIslandFromTopologicalIslandCommand command) throws Exception {
    	...
    	apply(new UnAssignTopologicalIslandFromTopologicalIslandEvent(command.getTopologicalIslandId()));
    }
    @CommandHandler
    public void handle(AssignAngleRefTopologicalIslandToTopologicalIslandCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignAngleRefTopologicalIslandToTopologicalIslandCommand" );
    	
    	if (  angleRefTopologicalIsland != null && angleRefTopologicalIsland.getTopologicalIslandId() == command.getAssignment().getTopologicalIslandId() )
    		throw new ProcessingException( "AngleRefTopologicalIsland already assigned with id " + command.getAssignment().getTopologicalIslandId() );  
    		
        apply(new AssignAngleRefTopologicalIslandToTopologicalIslandEvent(command.getTopologicalIslandId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignAngleRefTopologicalIslandFromTopologicalIslandCommand command) throws Exception {
    	...
    	apply(new UnAssignAngleRefTopologicalIslandFromTopologicalIslandEvent(command.getTopologicalIslandId()));
    }
