...
public class SvInjectionAggregate {  
    ...
    public void handle(UpdateSvInjectionCommand command) throws Exception {
    	...
    	UpdateSvInjectionEvent event = new UpdateSvInjectionEvent(command.getSvInjectionId(), command.getPInjection(), command.getQInjection(), command.getSvInjection());        
    ...
    public void handle(AssignSvInjectionToSvInjectionCommand command) throws Exception {
    	...
    	if (  svInjection != null && svInjection.getSvInjectionId() == command.getAssignment().getSvInjectionId() )
    		throw new ProcessingException( "SvInjection already assigned with id " + command.getAssignment().getSvInjectionId() );  
    		
        apply(new AssignSvInjectionToSvInjectionEvent(command.getSvInjectionId(), command.getAssignment()));
    }
