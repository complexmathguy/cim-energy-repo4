...
//		Assert.isNull( svVoltage.getSvVoltageId(), "CreateSvVoltageCommand identifier should be null" );
	...
	public void validate( AssignSvVoltageToSvVoltageCommand command ) throws Exception {
		...
		Assert.notNull( command.getSvVoltageId(), "AssignSvVoltageToSvVoltageCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSvVoltageToSvVoltageCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSvVoltageFromSvVoltageCommand command ) throws Exception {
		...
		Assert.notNull( command.getSvVoltageId(), "UnAssignSvVoltageFromSvVoltageCommand identifier should not be null" );
	}
