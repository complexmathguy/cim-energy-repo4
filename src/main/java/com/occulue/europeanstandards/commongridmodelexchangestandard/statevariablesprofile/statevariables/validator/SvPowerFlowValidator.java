...
//		Assert.isNull( svPowerFlow.getSvPowerFlowId(), "CreateSvPowerFlowCommand identifier should be null" );
	...
	public void validate( AssignSvPowerFlowToSvPowerFlowCommand command ) throws Exception {
		...
		Assert.notNull( command.getSvPowerFlowId(), "AssignSvPowerFlowToSvPowerFlowCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSvPowerFlowToSvPowerFlowCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSvPowerFlowFromSvPowerFlowCommand command ) throws Exception {
		...
		Assert.notNull( command.getSvPowerFlowId(), "UnAssignSvPowerFlowFromSvPowerFlowCommand identifier should not be null" );
	}
