...
//		Assert.isNull( svShuntCompensatorSections.getSvShuntCompensatorSectionsId(), "CreateSvShuntCompensatorSectionsCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignSvShuntCompensatorSectionsToSvShuntCompensatorSectionsCommand command ) throws Exception {
		Assert.notNull( command, "AssignSvShuntCompensatorSectionsToSvShuntCompensatorSectionsCommand should not be null" );
		Assert.notNull( command.getSvShuntCompensatorSectionsId(), "AssignSvShuntCompensatorSectionsToSvShuntCompensatorSectionsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSvShuntCompensatorSectionsToSvShuntCompensatorSectionsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignSvShuntCompensatorSectionsFromSvShuntCompensatorSectionsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignSvShuntCompensatorSectionsFromSvShuntCompensatorSectionsCommand should not be null" );
		Assert.notNull( command.getSvShuntCompensatorSectionsId(), "UnAssignSvShuntCompensatorSectionsFromSvShuntCompensatorSectionsCommand identifier should not be null" );
	}
