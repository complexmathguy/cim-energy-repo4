...
//		Assert.isNull( svTapStep.getSvTapStepId(), "CreateSvTapStepCommand identifier should be null" );
	...
	public void validate( AssignSvTapStepToSvTapStepCommand command ) throws Exception {
		...
		Assert.notNull( command.getSvTapStepId(), "AssignSvTapStepToSvTapStepCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSvTapStepToSvTapStepCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSvTapStepFromSvTapStepCommand command ) throws Exception {
		...
		Assert.notNull( command.getSvTapStepId(), "UnAssignSvTapStepFromSvTapStepCommand identifier should not be null" );
	}
