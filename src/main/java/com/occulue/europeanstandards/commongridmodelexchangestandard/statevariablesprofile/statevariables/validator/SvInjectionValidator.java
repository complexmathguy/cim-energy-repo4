...
//		Assert.isNull( svInjection.getSvInjectionId(), "CreateSvInjectionCommand identifier should be null" );
	...
	public void validate( AssignSvInjectionToSvInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getSvInjectionId(), "AssignSvInjectionToSvInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSvInjectionToSvInjectionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSvInjectionFromSvInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getSvInjectionId(), "UnAssignSvInjectionFromSvInjectionCommand identifier should not be null" );
	}
