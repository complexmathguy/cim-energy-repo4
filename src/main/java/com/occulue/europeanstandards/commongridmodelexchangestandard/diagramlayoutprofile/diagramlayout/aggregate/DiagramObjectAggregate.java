...
public class DiagramObjectAggregate {  
    ...
    public void handle(UpdateDiagramObjectCommand command) throws Exception {
    	...
    	UpdateDiagramObjectEvent event = new UpdateDiagramObjectEvent(command.getDiagramObjectId(), command.getDrawingOrder(), command.getPolygonFlag(), command.getOffsetX(), command.getOffsetY(), command.getRotation(), command.getStyledObjects(), command.getDiagramElements(), command.getDiagramObjects());        
    ...
    public void handle(AssignStyledObjectsToDiagramObjectCommand command) throws Exception {
    	...
    	if ( styledObjects.contains( command.getAddTo() ) )
    		throw new ProcessingException( "StyledObjects already contains an entity with id " + command.getAddTo().getDiagramObjectId() );

    	apply(new AssignStyledObjectsToDiagramObjectEvent(command.getDiagramObjectId(), command.getAddTo()));
    }
    ...
    public void handle(RemoveStyledObjectsFromDiagramObjectCommand command) throws Exception {
    	...
    	if ( !styledObjects.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "StyledObjects does not contain an entity with id " + command.getRemoveFrom().getDiagramObjectId() );

        apply(new RemoveStyledObjectsFromDiagramObjectEvent(command.getDiagramObjectId(), command.getRemoveFrom()));
    }
    @CommandHandler
    public void handle(AssignDiagramElementsToDiagramObjectCommand command) throws Exception {
    	...
    	if ( diagramElements.contains( command.getAddTo() ) )
    		throw new ProcessingException( "DiagramElements already contains an entity with id " + command.getAddTo().getDiagramObjectId() );

    	apply(new AssignDiagramElementsToDiagramObjectEvent(command.getDiagramObjectId(), command.getAddTo()));
    }
    ...
    public void handle(RemoveDiagramElementsFromDiagramObjectCommand command) throws Exception {
    	...
    	if ( !diagramElements.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "DiagramElements does not contain an entity with id " + command.getRemoveFrom().getDiagramObjectId() );

        apply(new RemoveDiagramElementsFromDiagramObjectEvent(command.getDiagramObjectId(), command.getRemoveFrom()));
    }
    @CommandHandler
    public void handle(AssignDiagramObjectsToDiagramObjectCommand command) throws Exception {
    	...
    	if ( diagramObjects.contains( command.getAddTo() ) )
    		throw new ProcessingException( "DiagramObjects already contains an entity with id " + command.getAddTo().getDiagramObjectId() );

    	apply(new AssignDiagramObjectsToDiagramObjectEvent(command.getDiagramObjectId(), command.getAddTo()));
    }
    ...
    public void handle(RemoveDiagramObjectsFromDiagramObjectCommand command) throws Exception {
    	...
    	if ( !diagramObjects.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "DiagramObjects does not contain an entity with id " + command.getRemoveFrom().getDiagramObjectId() );

        apply(new RemoveDiagramObjectsFromDiagramObjectEvent(command.getDiagramObjectId(), command.getRemoveFrom()));
    }
