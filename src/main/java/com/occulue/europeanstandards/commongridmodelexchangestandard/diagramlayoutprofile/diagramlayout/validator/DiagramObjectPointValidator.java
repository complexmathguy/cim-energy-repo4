...
//		Assert.isNull( diagramObjectPoint.getDiagramObjectPointId(), "CreateDiagramObjectPointCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignDiagramObjectPointsToDiagramObjectPointCommand command ) throws Exception {
		Assert.notNull( command, "AssignDiagramObjectPointsToDiagramObjectPointCommand should not be null" );
		Assert.notNull( command.getDiagramObjectPointId(), "AssignDiagramObjectPointsToDiagramObjectPointCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDiagramObjectPointsToDiagramObjectPointCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveDiagramObjectPointsFromDiagramObjectPointCommand command ) throws Exception {
		Assert.notNull( command, "RemoveDiagramObjectPointsFromDiagramObjectPointCommand should not be null" );
		Assert.notNull( command.getDiagramObjectPointId(), "RemoveDiagramObjectPointsFromDiagramObjectPointCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDiagramObjectPointsFromDiagramObjectPointCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDiagramObjectPointId(), "RemoveDiagramObjectPointsFromDiagramObjectPointCommand removeFrom attribubte identifier should not be null" );
	}
