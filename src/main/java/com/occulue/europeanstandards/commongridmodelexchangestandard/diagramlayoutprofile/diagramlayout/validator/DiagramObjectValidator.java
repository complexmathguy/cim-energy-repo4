...
//		Assert.isNull( diagramObject.getDiagramObjectId(), "CreateDiagramObjectCommand identifier should be null" );
	...
	public void validate( AssignStyledObjectsToDiagramObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramObjectId(), "AssignStyledObjectsToDiagramObjectCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignStyledObjectsToDiagramObjectCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveStyledObjectsFromDiagramObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramObjectId(), "RemoveStyledObjectsFromDiagramObjectCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveStyledObjectsFromDiagramObjectCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDiagramObjectId(), "RemoveStyledObjectsFromDiagramObjectCommand removeFrom attribubte identifier should not be null" );
	}
	...
	public void validate( AssignDiagramElementsToDiagramObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramObjectId(), "AssignDiagramElementsToDiagramObjectCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDiagramElementsToDiagramObjectCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveDiagramElementsFromDiagramObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramObjectId(), "RemoveDiagramElementsFromDiagramObjectCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDiagramElementsFromDiagramObjectCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDiagramObjectId(), "RemoveDiagramElementsFromDiagramObjectCommand removeFrom attribubte identifier should not be null" );
	}
	...
	public void validate( AssignDiagramObjectsToDiagramObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramObjectId(), "AssignDiagramObjectsToDiagramObjectCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDiagramObjectsToDiagramObjectCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveDiagramObjectsFromDiagramObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramObjectId(), "RemoveDiagramObjectsFromDiagramObjectCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDiagramObjectsFromDiagramObjectCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDiagramObjectId(), "RemoveDiagramObjectsFromDiagramObjectCommand removeFrom attribubte identifier should not be null" );
	}
