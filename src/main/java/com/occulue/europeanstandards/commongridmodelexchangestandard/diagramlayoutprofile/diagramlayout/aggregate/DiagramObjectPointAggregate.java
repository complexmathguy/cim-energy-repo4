...
public class DiagramObjectPointAggregate {  
    ...
    public void handle(UpdateDiagramObjectPointCommand command) throws Exception {
    	...
    	UpdateDiagramObjectPointEvent event = new UpdateDiagramObjectPointEvent(command.getDiagramObjectPointId(), command.getSequenceNumber(), command.getXPosition(), command.getYPosition(), command.getZPosition(), command.getDiagramObjectPoints());        
    ...
    @CommandHandler
    public void handle(AssignDiagramObjectPointsToDiagramObjectPointCommand command) throws Exception {
    	...
    	if ( diagramObjectPoints.contains( command.getAddTo() ) )
    		throw new ProcessingException( "DiagramObjectPoints already contains an entity with id " + command.getAddTo().getDiagramObjectPointId() );

    	apply(new AssignDiagramObjectPointsToDiagramObjectPointEvent(command.getDiagramObjectPointId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveDiagramObjectPointsFromDiagramObjectPointCommand command) throws Exception {
    	...
    	if ( !diagramObjectPoints.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "DiagramObjectPoints does not contain an entity with id " + command.getRemoveFrom().getDiagramObjectPointId() );

        apply(new RemoveDiagramObjectPointsFromDiagramObjectPointEvent(command.getDiagramObjectPointId(), command.getRemoveFrom()));
    }
