...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToDiagramObjectPoints( AssignDiagramObjectPointsToDiagramObjectPointCommand command ) throws ProcessingException {
		...
		DiagramObjectPointBusinessDelegate childDelegate 	= DiagramObjectPointBusinessDelegate.getDiagramObjectPointInstance();
		DiagramObjectPointBusinessDelegate parentDelegate = DiagramObjectPointBusinessDelegate.getDiagramObjectPointInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a DiagramObjectPoint as DiagramObjectPoints to DiagramObjectPoint" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromDiagramObjectPoints( RemoveDiagramObjectPointsFromDiagramObjectPointCommand command ) throws ProcessingException {		
