...
public void handle( RemoveStyledObjectsFromDiagramObjectEvent event) {
    ...
    DiagramObject entity = removeFromStyledObjects(event.getDiagramObjectId(), event.getRemoveFrom() );
...
public void handle( RemoveDiagramElementsFromDiagramObjectEvent event) {
    ...
    DiagramObject entity = removeFromDiagramElements(event.getDiagramObjectId(), event.getRemoveFrom() );
...
public void handle( RemoveDiagramObjectsFromDiagramObjectEvent event) {
    ...
    DiagramObject entity = removeFromDiagramObjects(event.getDiagramObjectId(), event.getRemoveFrom() );
