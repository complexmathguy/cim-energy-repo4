...
public class DiagramAggregate {  
    ...
    public DiagramAggregate(CreateDiagramCommand command) throws Exception {
    	...
    	CreateDiagramEvent event = new CreateDiagramEvent(command.getDiagramId(), command.getOrientation());
    ...
    public void handle(UpdateDiagramCommand command) throws Exception {
    	...
    	UpdateDiagramEvent event = new UpdateDiagramEvent(command.getDiagramId(), command.getOrientation(), command.getX1InitialView(), command.getX2InitialView(), command.getY1InitialView(), command.getY2InitialView(), command.getDiagram());        
    ...
    public void handle(AssignDiagramToDiagramCommand command) throws Exception {
    	...
    	if ( diagram.contains( command.getAddTo() ) )
    		throw new ProcessingException( "Diagram already contains an entity with id " + command.getAddTo().getDiagramId() );
    ...
    public void handle(RemoveDiagramFromDiagramCommand command) throws Exception {
    	...
    	if ( !diagram.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "Diagram does not contain an entity with id " + command.getRemoveFrom().getDiagramId() );
