...
//		Assert.isNull( visibilityLayer.getVisibilityLayerId(), "CreateVisibilityLayerCommand identifier should be null" );
	...
	public void validate( AssignVisibilityLayersToVisibilityLayerCommand command ) throws Exception {
		...
		Assert.notNull( command.getVisibilityLayerId(), "AssignVisibilityLayersToVisibilityLayerCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignVisibilityLayersToVisibilityLayerCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveVisibilityLayersFromVisibilityLayerCommand command ) throws Exception {
		...
		Assert.notNull( command.getVisibilityLayerId(), "RemoveVisibilityLayersFromVisibilityLayerCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveVisibilityLayersFromVisibilityLayerCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getVisibilityLayerId(), "RemoveVisibilityLayersFromVisibilityLayerCommand removeFrom attribubte identifier should not be null" );
	}
