...
//		Assert.isNull( diagram.getDiagramId(), "CreateDiagramCommand identifier should be null" );
	...
	public void validate( AssignDiagramToDiagramCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramId(), "AssignDiagramToDiagramCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDiagramToDiagramCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveDiagramFromDiagramCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramId(), "RemoveDiagramFromDiagramCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDiagramFromDiagramCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDiagramId(), "RemoveDiagramFromDiagramCommand removeFrom attribubte identifier should not be null" );
	}
