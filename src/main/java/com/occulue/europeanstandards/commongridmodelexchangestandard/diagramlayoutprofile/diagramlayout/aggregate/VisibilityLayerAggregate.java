...
public class VisibilityLayerAggregate {  
    ...
    public void handle(UpdateVisibilityLayerCommand command) throws Exception {
    	...
    	UpdateVisibilityLayerEvent event = new UpdateVisibilityLayerEvent(command.getVisibilityLayerId(), command.getDrawingOrder(), command.getVisibilityLayers());        
    ...
    public void handle(AssignVisibilityLayersToVisibilityLayerCommand command) throws Exception {
    	...
    	if ( visibilityLayers.contains( command.getAddTo() ) )
    		throw new ProcessingException( "VisibilityLayers already contains an entity with id " + command.getAddTo().getVisibilityLayerId() );

    	apply(new AssignVisibilityLayersToVisibilityLayerEvent(command.getVisibilityLayerId(), command.getAddTo()));
    }
    ...
    public void handle(RemoveVisibilityLayersFromVisibilityLayerCommand command) throws Exception {
    	...
    	if ( !visibilityLayers.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "VisibilityLayers does not contain an entity with id " + command.getRemoveFrom().getVisibilityLayerId() );

        apply(new RemoveVisibilityLayersFromVisibilityLayerEvent(command.getVisibilityLayerId(), command.getRemoveFrom()));
    }
