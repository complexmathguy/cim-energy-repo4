...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToRegions( AssignRegionsToSubGeographicalRegionCommand command ) throws ProcessingException {
		...
		SubGeographicalRegionBusinessDelegate childDelegate 	= SubGeographicalRegionBusinessDelegate.getSubGeographicalRegionInstance();
		SubGeographicalRegionBusinessDelegate parentDelegate = SubGeographicalRegionBusinessDelegate.getSubGeographicalRegionInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a SubGeographicalRegion as Regions to SubGeographicalRegion" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromRegions( RemoveRegionsFromSubGeographicalRegionCommand command ) throws ProcessingException {		
