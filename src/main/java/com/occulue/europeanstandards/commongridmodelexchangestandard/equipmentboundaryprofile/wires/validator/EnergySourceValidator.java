...
//		Assert.isNull( energySource.getEnergySourceId(), "CreateEnergySourceCommand identifier should be null" );
	...
	public void validate( AssignEnergySourceToEnergySourceCommand command ) throws Exception {
		...
		Assert.notNull( command.getEnergySourceId(), "AssignEnergySourceToEnergySourceCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignEnergySourceToEnergySourceCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveEnergySourceFromEnergySourceCommand command ) throws Exception {
		...
		Assert.notNull( command.getEnergySourceId(), "RemoveEnergySourceFromEnergySourceCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveEnergySourceFromEnergySourceCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getEnergySourceId(), "RemoveEnergySourceFromEnergySourceCommand removeFrom attribubte identifier should not be null" );
	}
