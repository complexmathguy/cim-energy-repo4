...
public class ConnectivityNodeAggregate {  
    ...
    public void handle(UpdateConnectivityNodeCommand command) throws Exception {
    	...
    	UpdateConnectivityNodeEvent event = new UpdateConnectivityNodeEvent(command.getConnectivityNodeId(), command.getBoundaryPoint(), command.getFromEndIsoCode(), command.getFromEndName(), command.getFromEndNameTso(), command.getToEndIsoCode(), command.getToEndName(), command.getToEndNameTso(), command.getConnectivityNodes());        
    ...
    public void handle(AssignConnectivityNodesToConnectivityNodeCommand command) throws Exception {
    	...
    	if ( connectivityNodes.contains( command.getAddTo() ) )
    		throw new ProcessingException( "ConnectivityNodes already contains an entity with id " + command.getAddTo().getConnectivityNodeId() );

    	apply(new AssignConnectivityNodesToConnectivityNodeEvent(command.getConnectivityNodeId(), command.getAddTo()));
    }
    ...
    public void handle(RemoveConnectivityNodesFromConnectivityNodeCommand command) throws Exception {
    	...
    	if ( !connectivityNodes.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "ConnectivityNodes does not contain an entity with id " + command.getRemoveFrom().getConnectivityNodeId() );

        apply(new RemoveConnectivityNodesFromConnectivityNodeEvent(command.getConnectivityNodeId(), command.getRemoveFrom()));
    }
