...
//		Assert.isNull( connectivityNode.getConnectivityNodeId(), "CreateConnectivityNodeCommand identifier should be null" );
	...
	public void validate( AssignConnectivityNodesToConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "AssignConnectivityNodesToConnectivityNodeCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignConnectivityNodesToConnectivityNodeCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveConnectivityNodesFromConnectivityNodeCommand command ) throws Exception {
		Assert.notNull( command, "RemoveConnectivityNodesFromConnectivityNodeCommand should not be null" );
		Assert.notNull( command.getConnectivityNodeId(), "RemoveConnectivityNodesFromConnectivityNodeCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveConnectivityNodesFromConnectivityNodeCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getConnectivityNodeId(), "RemoveConnectivityNodesFromConnectivityNodeCommand removeFrom attribubte identifier should not be null" );
	}
