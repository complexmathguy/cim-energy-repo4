...
//		Assert.isNull( equipment.getEquipmentId(), "CreateEquipmentCommand identifier should be null" );
	...
	public void validate( AssignEquipmentsToEquipmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentId(), "AssignEquipmentsToEquipmentCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignEquipmentsToEquipmentCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveEquipmentsFromEquipmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentId(), "RemoveEquipmentsFromEquipmentCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveEquipmentsFromEquipmentCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getEquipmentId(), "RemoveEquipmentsFromEquipmentCommand removeFrom attribubte identifier should not be null" );
	}
