...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToEnergySource( AssignEnergySourceToEnergySourceCommand command ) throws ProcessingException {
		...
		EnergySourceBusinessDelegate childDelegate 	= EnergySourceBusinessDelegate.getEnergySourceInstance();
		EnergySourceBusinessDelegate parentDelegate = EnergySourceBusinessDelegate.getEnergySourceInstance();		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromEnergySource( RemoveEnergySourceFromEnergySourceCommand command ) throws ProcessingException {		
