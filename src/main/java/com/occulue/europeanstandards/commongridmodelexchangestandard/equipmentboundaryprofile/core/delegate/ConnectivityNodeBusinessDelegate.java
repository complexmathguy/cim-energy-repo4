...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToConnectivityNodes( AssignConnectivityNodesToConnectivityNodeCommand command ) throws ProcessingException {
		...
		ConnectivityNodeBusinessDelegate childDelegate 	= ConnectivityNodeBusinessDelegate.getConnectivityNodeInstance();
		ConnectivityNodeBusinessDelegate parentDelegate = ConnectivityNodeBusinessDelegate.getConnectivityNodeInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a ConnectivityNode as ConnectivityNodes to ConnectivityNode" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromConnectivityNodes( RemoveConnectivityNodesFromConnectivityNodeCommand command ) throws ProcessingException {		
