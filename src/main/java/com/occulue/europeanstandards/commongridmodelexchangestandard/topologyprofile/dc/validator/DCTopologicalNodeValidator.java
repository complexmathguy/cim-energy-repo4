...
//		Assert.isNull( dCTopologicalNode.getDCTopologicalNodeId(), "CreateDCTopologicalNodeCommand identifier should be null" );
	...
	public void validate( AssignDCTopologicalNodeToDCTopologicalNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCTopologicalNodeId(), "AssignDCTopologicalNodeToDCTopologicalNodeCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDCTopologicalNodeToDCTopologicalNodeCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveDCTopologicalNodeFromDCTopologicalNodeCommand command ) throws Exception {
		Assert.notNull( command, "RemoveDCTopologicalNodeFromDCTopologicalNodeCommand should not be null" );
		Assert.notNull( command.getDCTopologicalNodeId(), "RemoveDCTopologicalNodeFromDCTopologicalNodeCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDCTopologicalNodeFromDCTopologicalNodeCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDCTopologicalNodeId(), "RemoveDCTopologicalNodeFromDCTopologicalNodeCommand removeFrom attribubte identifier should not be null" );
	}
