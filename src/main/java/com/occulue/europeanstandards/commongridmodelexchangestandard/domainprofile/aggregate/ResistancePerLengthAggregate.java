...
public class ResistancePerLengthAggregate {  
    ...
    public ResistancePerLengthAggregate(CreateResistancePerLengthCommand command) throws Exception {
    	...
    	CreateResistancePerLengthEvent event = new CreateResistancePerLengthEvent(command.getResistancePerLengthId(), command.getDenominatorMultiplier(), command.getDenominatorUnit(), command.getMultiplier(), command.getUnit());
