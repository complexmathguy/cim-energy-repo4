...
public class InductancePerLengthAggregate {  
    ...
    public InductancePerLengthAggregate(CreateInductancePerLengthCommand command) throws Exception {
    	...
    	CreateInductancePerLengthEvent event = new CreateInductancePerLengthEvent(command.getInductancePerLengthId(), command.getDenominatorMultiplier(), command.getDenominatorUnit(), command.getMultiplier(), command.getUnit());
