...
public class ActivePowerPerFrequencyAggregate {  
    ...
    public ActivePowerPerFrequencyAggregate(CreateActivePowerPerFrequencyCommand command) throws Exception {
    	...
    	CreateActivePowerPerFrequencyEvent event = new CreateActivePowerPerFrequencyEvent(command.getActivePowerPerFrequencyId(), command.getDenominatorMultiplier(), command.getDenominatorUnit(), command.getMultiplier(), command.getUnit());
