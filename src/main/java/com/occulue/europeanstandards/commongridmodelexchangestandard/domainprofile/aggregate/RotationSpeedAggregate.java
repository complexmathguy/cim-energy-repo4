...
public class RotationSpeedAggregate {  
    ...
    public RotationSpeedAggregate(CreateRotationSpeedCommand command) throws Exception {
    	...
    	CreateRotationSpeedEvent event = new CreateRotationSpeedEvent(command.getRotationSpeedId(), command.getDenominatorMultiplier(), command.getDenominatorUnit(), command.getMultiplier(), command.getUnit());
