...
public class CapacitancePerLengthAggregate {  
    ...
    public CapacitancePerLengthAggregate(CreateCapacitancePerLengthCommand command) throws Exception {
    	...
    	CreateCapacitancePerLengthEvent event = new CreateCapacitancePerLengthEvent(command.getCapacitancePerLengthId(), command.getDenominatorMultiplier(), command.getDenominatorUnit(), command.getMultiplier(), command.getUnit());
