...
public class VoltagePerReactivePowerAggregate {  
    ...
    public VoltagePerReactivePowerAggregate(CreateVoltagePerReactivePowerCommand command) throws Exception {
    	...
    	CreateVoltagePerReactivePowerEvent event = new CreateVoltagePerReactivePowerEvent(command.getVoltagePerReactivePowerId(), command.getDenominatorMultiplier(), command.getDenominatorUnit(), command.getMultiplier(), command.getUnit());
