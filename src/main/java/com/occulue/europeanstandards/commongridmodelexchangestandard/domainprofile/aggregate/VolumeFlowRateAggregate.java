...
public class VolumeFlowRateAggregate {  
    ...
    public VolumeFlowRateAggregate(CreateVolumeFlowRateCommand command) throws Exception {
    	...
    	CreateVolumeFlowRateEvent event = new CreateVolumeFlowRateEvent(command.getVolumeFlowRateId(), command.getDenominatorMultiplier(), command.getDenominatorUnit(), command.getMultiplier(), command.getUnit());
