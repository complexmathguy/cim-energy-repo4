...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToRegulationSchedule( AssignRegulationScheduleToRegulationScheduleCommand command ) throws ProcessingException {
		...
		RegulationScheduleBusinessDelegate childDelegate 	= RegulationScheduleBusinessDelegate.getRegulationScheduleInstance();
		RegulationScheduleBusinessDelegate parentDelegate = RegulationScheduleBusinessDelegate.getRegulationScheduleInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a RegulationSchedule as RegulationSchedule to RegulationSchedule" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromRegulationSchedule( RemoveRegulationScheduleFromRegulationScheduleCommand command ) throws ProcessingException {		
