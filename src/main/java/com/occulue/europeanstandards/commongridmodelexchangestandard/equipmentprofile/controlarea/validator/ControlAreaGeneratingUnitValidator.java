...
//		Assert.isNull( controlAreaGeneratingUnit.getControlAreaGeneratingUnitId(), "CreateControlAreaGeneratingUnitCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignControlAreaGeneratingUnitToControlAreaGeneratingUnitCommand command ) throws Exception {
		Assert.notNull( command, "AssignControlAreaGeneratingUnitToControlAreaGeneratingUnitCommand should not be null" );
		Assert.notNull( command.getControlAreaGeneratingUnitId(), "AssignControlAreaGeneratingUnitToControlAreaGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignControlAreaGeneratingUnitToControlAreaGeneratingUnitCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitCommand command ) throws Exception {
		Assert.notNull( command, "RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitCommand should not be null" );
		Assert.notNull( command.getControlAreaGeneratingUnitId(), "RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getControlAreaGeneratingUnitId(), "RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitCommand removeFrom attribubte identifier should not be null" );
	}
