...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToPhaseTapChangerTabular( AssignPhaseTapChangerTabularToPhaseTapChangerTabularCommand command ) throws ProcessingException {
		...
		PhaseTapChangerTabularBusinessDelegate childDelegate 	= PhaseTapChangerTabularBusinessDelegate.getPhaseTapChangerTabularInstance();
		PhaseTapChangerTabularBusinessDelegate parentDelegate = PhaseTapChangerTabularBusinessDelegate.getPhaseTapChangerTabularInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a PhaseTapChangerTabular as PhaseTapChangerTabular to PhaseTapChangerTabular" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromPhaseTapChangerTabular( RemovePhaseTapChangerTabularFromPhaseTapChangerTabularCommand command ) throws ProcessingException {		
