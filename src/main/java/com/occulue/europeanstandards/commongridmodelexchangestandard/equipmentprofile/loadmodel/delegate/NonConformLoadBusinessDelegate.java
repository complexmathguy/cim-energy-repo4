...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToEnergyConsumers( AssignEnergyConsumersToNonConformLoadCommand command ) throws ProcessingException {
		...
		NonConformLoadBusinessDelegate childDelegate 	= NonConformLoadBusinessDelegate.getNonConformLoadInstance();
		NonConformLoadBusinessDelegate parentDelegate = NonConformLoadBusinessDelegate.getNonConformLoadInstance();		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromEnergyConsumers( RemoveEnergyConsumersFromNonConformLoadCommand command ) throws ProcessingException {		
