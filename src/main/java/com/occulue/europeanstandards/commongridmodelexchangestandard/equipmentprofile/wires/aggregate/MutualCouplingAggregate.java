...
public class MutualCouplingAggregate {  
    ...
    public void handle(UpdateMutualCouplingCommand command) throws Exception {
    	...
    	UpdateMutualCouplingEvent event = new UpdateMutualCouplingEvent(command.getMutualCouplingId(), command.getB0ch(), command.getDistance11(), command.getDistance12(), command.getDistance21(), command.getDistance22(), command.getG0ch(), command.getR0(), command.getX0(), command.getHasSecondMutualCoupling(), command.getHasFirstMutualCoupling());        
    ...
    @CommandHandler
    public void handle(AssignHasSecondMutualCouplingToMutualCouplingCommand command) throws Exception {
    	...
    	if ( hasSecondMutualCoupling.contains( command.getAddTo() ) )
    		throw new ProcessingException( "HasSecondMutualCoupling already contains an entity with id " + command.getAddTo().getMutualCouplingId() );

    	apply(new AssignHasSecondMutualCouplingToMutualCouplingEvent(command.getMutualCouplingId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveHasSecondMutualCouplingFromMutualCouplingCommand command) throws Exception {
    	...
    	if ( !hasSecondMutualCoupling.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "HasSecondMutualCoupling does not contain an entity with id " + command.getRemoveFrom().getMutualCouplingId() );

        apply(new RemoveHasSecondMutualCouplingFromMutualCouplingEvent(command.getMutualCouplingId(), command.getRemoveFrom()));
    }
    @CommandHandler
    public void handle(AssignHasFirstMutualCouplingToMutualCouplingCommand command) throws Exception {
    	...
    	if ( hasFirstMutualCoupling.contains( command.getAddTo() ) )
    		throw new ProcessingException( "HasFirstMutualCoupling already contains an entity with id " + command.getAddTo().getMutualCouplingId() );

    	apply(new AssignHasFirstMutualCouplingToMutualCouplingEvent(command.getMutualCouplingId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveHasFirstMutualCouplingFromMutualCouplingCommand command) throws Exception {
    	...
    	if ( !hasFirstMutualCoupling.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "HasFirstMutualCoupling does not contain an entity with id " + command.getRemoveFrom().getMutualCouplingId() );

        apply(new RemoveHasFirstMutualCouplingFromMutualCouplingEvent(command.getMutualCouplingId(), command.getRemoveFrom()));
    }
