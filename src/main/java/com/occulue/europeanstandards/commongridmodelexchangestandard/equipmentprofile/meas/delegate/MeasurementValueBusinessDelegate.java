...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToMeasurementValues( AssignMeasurementValuesToMeasurementValueCommand command ) throws ProcessingException {
		...
		MeasurementValueBusinessDelegate childDelegate 	= MeasurementValueBusinessDelegate.getMeasurementValueInstance();
		MeasurementValueBusinessDelegate parentDelegate = MeasurementValueBusinessDelegate.getMeasurementValueInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a MeasurementValue as MeasurementValues to MeasurementValue" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromMeasurementValues( RemoveMeasurementValuesFromMeasurementValueCommand command ) throws ProcessingException {		
