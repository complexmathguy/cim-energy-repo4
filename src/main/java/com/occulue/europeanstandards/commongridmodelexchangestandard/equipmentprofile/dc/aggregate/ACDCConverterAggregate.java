...
public class ACDCConverterAggregate {  
    ...
    public void handle(UpdateACDCConverterCommand command) throws Exception {
    	...
    	UpdateACDCConverterEvent event = new UpdateACDCConverterEvent(command.getACDCConverterId(), command.getBaseS(), command.getIdleLoss(), command.getMaxUdc(), command.getMinUdc(), command.getNumberOfValves(), command.getRatedUdc(), command.getResistiveLoss(), command.getSwitchingLoss(), command.getValveU0(), command.getConverterDCSides());        
    ...
    public void handle(AssignConverterDCSidesToACDCConverterCommand command) throws Exception {
    	...
    	if ( converterDCSides.contains( command.getAddTo() ) )
    		throw new ProcessingException( "ConverterDCSides already contains an entity with id " + command.getAddTo().getACDCConverterId() );

    	apply(new AssignConverterDCSidesToACDCConverterEvent(command.getACDCConverterId(), command.getAddTo()));
    }
    ...
    public void handle(RemoveConverterDCSidesFromACDCConverterCommand command) throws Exception {
    	...
    	if ( !converterDCSides.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "ConverterDCSides does not contain an entity with id " + command.getRemoveFrom().getACDCConverterId() );

        apply(new RemoveConverterDCSidesFromACDCConverterEvent(command.getACDCConverterId(), command.getRemoveFrom()));
    }
