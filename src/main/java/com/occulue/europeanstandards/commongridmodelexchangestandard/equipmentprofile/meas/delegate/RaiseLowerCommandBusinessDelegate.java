...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToRaiseLowerCommands( AssignRaiseLowerCommandsToRaiseLowerCommandCommand command ) throws ProcessingException {
		...
		RaiseLowerCommandBusinessDelegate childDelegate 	= RaiseLowerCommandBusinessDelegate.getRaiseLowerCommandInstance();
		RaiseLowerCommandBusinessDelegate parentDelegate = RaiseLowerCommandBusinessDelegate.getRaiseLowerCommandInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a RaiseLowerCommand as RaiseLowerCommands to RaiseLowerCommand" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromRaiseLowerCommands( RemoveRaiseLowerCommandsFromRaiseLowerCommandCommand command ) throws ProcessingException {		
