...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToHydroGeneratingUnits( AssignHydroGeneratingUnitsToHydroGeneratingUnitCommand command ) throws ProcessingException {
		...
		HydroGeneratingUnitBusinessDelegate childDelegate 	= HydroGeneratingUnitBusinessDelegate.getHydroGeneratingUnitInstance();
		HydroGeneratingUnitBusinessDelegate parentDelegate = HydroGeneratingUnitBusinessDelegate.getHydroGeneratingUnitInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a HydroGeneratingUnit as HydroGeneratingUnits to HydroGeneratingUnit" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromHydroGeneratingUnits( RemoveHydroGeneratingUnitsFromHydroGeneratingUnitCommand command ) throws ProcessingException {		
