...
public class PhaseTapChangerAggregate {  
    ...
    public void handle(UpdatePhaseTapChangerCommand command) throws Exception {
    	...
    	UpdatePhaseTapChangerEvent event = new UpdatePhaseTapChangerEvent(command.getPhaseTapChangerId(), command.getPhaseTapChanger());        
    ...
    public void handle(AssignPhaseTapChangerToPhaseTapChangerCommand command) throws Exception {
    	...
    	if (  phaseTapChanger != null && phaseTapChanger.getPhaseTapChangerId() == command.getAssignment().getPhaseTapChangerId() )
    		throw new ProcessingException( "PhaseTapChanger already assigned with id " + command.getAssignment().getPhaseTapChangerId() );  
    		
        apply(new AssignPhaseTapChangerToPhaseTapChangerEvent(command.getPhaseTapChangerId(), command.getAssignment()));
    }
