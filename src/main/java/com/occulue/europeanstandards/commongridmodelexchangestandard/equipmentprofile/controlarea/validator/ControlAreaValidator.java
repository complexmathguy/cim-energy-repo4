...
//		Assert.isNull( controlArea.getControlAreaId(), "CreateControlAreaCommand identifier should be null" );
	...
	public void validate( AssignControlAreaToControlAreaCommand command ) throws Exception {
		...
		Assert.notNull( command.getControlAreaId(), "AssignControlAreaToControlAreaCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignControlAreaToControlAreaCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignControlAreaFromControlAreaCommand command ) throws Exception {
		...
		Assert.notNull( command.getControlAreaId(), "UnAssignControlAreaFromControlAreaCommand identifier should not be null" );
	}
