...
public class OperationalLimitProjector extends OperationalLimitEntityProjector {
    ...
    public void handle( AssignOperationalLimitToOperationalLimitEvent event) {
    	...
    	// delegate to addTo 
    	// ------------------------------------------ 
	    OperationalLimit entity = addToOperationalLimit(event.getOperationalLimitId(), event.getAddTo() );
...
public void handle( RemoveOperationalLimitFromOperationalLimitEvent event) {
    ...
    OperationalLimit entity = removeFromOperationalLimit(event.getOperationalLimitId(), event.getRemoveFrom() );
    ...
    public void handle( AssignOperationalLimitValueToOperationalLimitEvent event) {
    	...
    	// delegate to addTo 
    	// ------------------------------------------ 
	    OperationalLimit entity = addToOperationalLimitValue(event.getOperationalLimitId(), event.getAddTo() );
...
public void handle( RemoveOperationalLimitValueFromOperationalLimitEvent event) {
    ...
    OperationalLimit entity = removeFromOperationalLimitValue(event.getOperationalLimitId(), event.getRemoveFrom() );
