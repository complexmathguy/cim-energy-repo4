...
//		Assert.isNull( conformLoad.getConformLoadId(), "CreateConformLoadCommand identifier should be null" );
	...
	public void validate( AssignEnergyConsumersToConformLoadCommand command ) throws Exception {
		...
		Assert.notNull( command.getConformLoadId(), "AssignEnergyConsumersToConformLoadCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignEnergyConsumersToConformLoadCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveEnergyConsumersFromConformLoadCommand command ) throws Exception {
		...
		Assert.notNull( command.getConformLoadId(), "RemoveEnergyConsumersFromConformLoadCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveEnergyConsumersFromConformLoadCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getConformLoadId(), "RemoveEnergyConsumersFromConformLoadCommand removeFrom attribubte identifier should not be null" );
	}
