...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToPowerTransformerEnd( AssignPowerTransformerEndToPowerTransformerEndCommand command ) throws ProcessingException {
		...
		PowerTransformerEndBusinessDelegate childDelegate 	= PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance();
		PowerTransformerEndBusinessDelegate parentDelegate = PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a PowerTransformerEnd as PowerTransformerEnd to PowerTransformerEnd" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromPowerTransformerEnd( RemovePowerTransformerEndFromPowerTransformerEndCommand command ) throws ProcessingException {		
