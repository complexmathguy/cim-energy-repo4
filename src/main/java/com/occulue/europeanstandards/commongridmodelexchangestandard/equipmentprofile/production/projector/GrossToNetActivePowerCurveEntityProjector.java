...
public class GrossToNetActivePowerCurveEntityProjector {
     ...
     */
    public GrossToNetActivePowerCurve addToGrossToNetActivePowerCurves( UUID parentId, GrossToNetActivePowerCurve addTo ) {
	    ...
	    GrossToNetActivePowerCurve child = GrossToNetActivePowerCurveProjector.find(addTo.getGrossToNetActivePowerCurveId());
     ...
     * @return	GrossToNetActivePowerCurve
     */
	public GrossToNetActivePowerCurve removeFromGrossToNetActivePowerCurves( UUID parentId, GrossToNetActivePowerCurve removeFrom ) {
	    LOGGER.info("handling RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveEvent " );
	
	    GrossToNetActivePowerCurve parentEntity = repository.findById(parentId).get();
	    GrossToNetActivePowerCurve child = GrossToNetActivePowerCurveProjector.find(removeFrom.getGrossToNetActivePowerCurveId());
