...
//		Assert.isNull( raiseLowerCommand.getRaiseLowerCommandId(), "CreateRaiseLowerCommandCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignRaiseLowerCommandsToRaiseLowerCommandCommand command ) throws Exception {
		Assert.notNull( command, "AssignRaiseLowerCommandsToRaiseLowerCommandCommand should not be null" );
		Assert.notNull( command.getRaiseLowerCommandId(), "AssignRaiseLowerCommandsToRaiseLowerCommandCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignRaiseLowerCommandsToRaiseLowerCommandCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveRaiseLowerCommandsFromRaiseLowerCommandCommand command ) throws Exception {
		Assert.notNull( command, "RemoveRaiseLowerCommandsFromRaiseLowerCommandCommand should not be null" );
		Assert.notNull( command.getRaiseLowerCommandId(), "RemoveRaiseLowerCommandsFromRaiseLowerCommandCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveRaiseLowerCommandsFromRaiseLowerCommandCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getRaiseLowerCommandId(), "RemoveRaiseLowerCommandsFromRaiseLowerCommandCommand removeFrom attribubte identifier should not be null" );
	}
