...
public class GrossToNetActivePowerCurveAggregate {  
    ...
    public void handle(UpdateGrossToNetActivePowerCurveCommand command) throws Exception {
    	...
    	UpdateGrossToNetActivePowerCurveEvent event = new UpdateGrossToNetActivePowerCurveEvent(command.getGrossToNetActivePowerCurveId(), command.getGrossToNetActivePowerCurves());        
    ...
    @CommandHandler
    public void handle(AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveCommand" );
    	
    	if ( grossToNetActivePowerCurves.contains( command.getAddTo() ) )
    		throw new ProcessingException( "GrossToNetActivePowerCurves already contains an entity with id " + command.getAddTo().getGrossToNetActivePowerCurveId() );

    	apply(new AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveEvent(command.getGrossToNetActivePowerCurveId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveCommand command) throws Exception {
    	LOGGER.info( "Handling command RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveCommand" );
    	
    	if ( !grossToNetActivePowerCurves.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "GrossToNetActivePowerCurves does not contain an entity with id " + command.getRemoveFrom().getGrossToNetActivePowerCurveId() );

        apply(new RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveEvent(command.getGrossToNetActivePowerCurveId(), command.getRemoveFrom()));
    }
    ...
    void on(AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveEvent event ) {
    	LOGGER.info( "Event sourcing AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveEvent" );
	...
	void on(RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveEvent event ) {	
		LOGGER.info( "Event sourcing RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveEvent" );
