...
//		Assert.isNull( phaseTapChangerTablePoint.getPhaseTapChangerTablePointId(), "CreatePhaseTapChangerTablePointCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignPhaseTapChangerTablePointToPhaseTapChangerTablePointCommand command ) throws Exception {
		Assert.notNull( command, "AssignPhaseTapChangerTablePointToPhaseTapChangerTablePointCommand should not be null" );
		Assert.notNull( command.getPhaseTapChangerTablePointId(), "AssignPhaseTapChangerTablePointToPhaseTapChangerTablePointCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignPhaseTapChangerTablePointToPhaseTapChangerTablePointCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointCommand command ) throws Exception {
		Assert.notNull( command, "RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointCommand should not be null" );
		Assert.notNull( command.getPhaseTapChangerTablePointId(), "RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getPhaseTapChangerTablePointId(), "RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointCommand removeFrom attribubte identifier should not be null" );
	}
