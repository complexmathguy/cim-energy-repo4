...
public class RaiseLowerCommandAggregate {  
    ...
    public void handle(UpdateRaiseLowerCommandCommand command) throws Exception {
    	...
    	UpdateRaiseLowerCommandEvent event = new UpdateRaiseLowerCommandEvent(command.getRaiseLowerCommandId(), command.getRaiseLowerCommands());        
    ...
    public void handle(AssignRaiseLowerCommandsToRaiseLowerCommandCommand command) throws Exception {
    	...
    	if ( raiseLowerCommands.contains( command.getAddTo() ) )
    		throw new ProcessingException( "RaiseLowerCommands already contains an entity with id " + command.getAddTo().getRaiseLowerCommandId() );

    	apply(new AssignRaiseLowerCommandsToRaiseLowerCommandEvent(command.getRaiseLowerCommandId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveRaiseLowerCommandsFromRaiseLowerCommandCommand command) throws Exception {
    	...
    	if ( !raiseLowerCommands.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "RaiseLowerCommands does not contain an entity with id " + command.getRemoveFrom().getRaiseLowerCommandId() );

        apply(new RemoveRaiseLowerCommandsFromRaiseLowerCommandEvent(command.getRaiseLowerCommandId(), command.getRemoveFrom()));
    }
