...
public class SynchronousMachineAggregate {  
    ...
    public SynchronousMachineAggregate(CreateSynchronousMachineCommand command) throws Exception {
    	...
    	CreateSynchronousMachineEvent event = new CreateSynchronousMachineEvent(command.getSynchronousMachineId(), command.getShortCircuitRotorType(), command.getType());
    ...
    @CommandHandler
    public void handle(AssignInitiallyUsedBySynchronousMachinesToSynchronousMachineCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignInitiallyUsedBySynchronousMachinesToSynchronousMachineCommand" );
    	
    	if ( initiallyUsedBySynchronousMachines.contains( command.getAddTo() ) )
    		throw new ProcessingException( "InitiallyUsedBySynchronousMachines already contains an entity with id " + command.getAddTo().getSynchronousMachineId() );

    	apply(new AssignInitiallyUsedBySynchronousMachinesToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineCommand command) throws Exception {
    	LOGGER.info( "Handling command RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineCommand" );
    	
    	if ( !initiallyUsedBySynchronousMachines.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "InitiallyUsedBySynchronousMachines does not contain an entity with id " + command.getRemoveFrom().getSynchronousMachineId() );

        apply(new RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineEvent(command.getSynchronousMachineId(), command.getRemoveFrom()));
    }
	...
	void on(RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineEvent event ) {	
		LOGGER.info( "Event sourcing RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineEvent" );
