...
public class PowerTransformerEndAggregate {  
    ...
    public PowerTransformerEndAggregate(CreatePowerTransformerEndCommand command) throws Exception {
    	...
    	CreatePowerTransformerEndEvent event = new CreatePowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getConnectionKind());
    ...
    public void handle(UpdatePowerTransformerEndCommand command) throws Exception {
    	...
    	UpdatePowerTransformerEndEvent event = new UpdatePowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getB(), command.getB0(), command.getConnectionKind(), command.getG(), command.getG0(), command.getPhaseAngleClock(), command.getR(), command.getR0(), command.getRatedS(), command.getRatedU(), command.getX(), command.getX0(), command.getPowerTransformerEnd());        
    ...
    @CommandHandler
    public void handle(AssignPowerTransformerEndToPowerTransformerEndCommand command) throws Exception {
    	...
    	if ( powerTransformerEnd.contains( command.getAddTo() ) )
    		throw new ProcessingException( "PowerTransformerEnd already contains an entity with id " + command.getAddTo().getPowerTransformerEndId() );

    	apply(new AssignPowerTransformerEndToPowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemovePowerTransformerEndFromPowerTransformerEndCommand command) throws Exception {
    	...
    	if ( !powerTransformerEnd.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "PowerTransformerEnd does not contain an entity with id " + command.getRemoveFrom().getPowerTransformerEndId() );

        apply(new RemovePowerTransformerEndFromPowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getRemoveFrom()));
    }
