...
//		Assert.isNull( nonConformLoad.getNonConformLoadId(), "CreateNonConformLoadCommand identifier should be null" );
	...
	public void validate( AssignEnergyConsumersToNonConformLoadCommand command ) throws Exception {
		...
		Assert.notNull( command.getNonConformLoadId(), "AssignEnergyConsumersToNonConformLoadCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignEnergyConsumersToNonConformLoadCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveEnergyConsumersFromNonConformLoadCommand command ) throws Exception {
		...
		Assert.notNull( command.getNonConformLoadId(), "RemoveEnergyConsumersFromNonConformLoadCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveEnergyConsumersFromNonConformLoadCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getNonConformLoadId(), "RemoveEnergyConsumersFromNonConformLoadCommand removeFrom attribubte identifier should not be null" );
	}
