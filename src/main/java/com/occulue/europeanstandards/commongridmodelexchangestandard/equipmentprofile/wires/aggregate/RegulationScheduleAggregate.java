...
public class RegulationScheduleAggregate {  
    ...
    public void handle(UpdateRegulationScheduleCommand command) throws Exception {
    	...
    	UpdateRegulationScheduleEvent event = new UpdateRegulationScheduleEvent(command.getRegulationScheduleId(), command.getRegulationSchedule());        
    ...
    public void handle(AssignRegulationScheduleToRegulationScheduleCommand command) throws Exception {
    	...
    	if ( regulationSchedule.contains( command.getAddTo() ) )
    		throw new ProcessingException( "RegulationSchedule already contains an entity with id " + command.getAddTo().getRegulationScheduleId() );

    	apply(new AssignRegulationScheduleToRegulationScheduleEvent(command.getRegulationScheduleId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveRegulationScheduleFromRegulationScheduleCommand command) throws Exception {
    	...
    	if ( !regulationSchedule.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "RegulationSchedule does not contain an entity with id " + command.getRemoveFrom().getRegulationScheduleId() );

        apply(new RemoveRegulationScheduleFromRegulationScheduleEvent(command.getRegulationScheduleId(), command.getRemoveFrom()));
    }
