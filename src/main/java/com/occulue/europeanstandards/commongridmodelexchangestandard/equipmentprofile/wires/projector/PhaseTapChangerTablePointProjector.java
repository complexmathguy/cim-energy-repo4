...
public class PhaseTapChangerTablePointProjector extends PhaseTapChangerTablePointEntityProjector {
    ...
    public void handle( AssignPhaseTapChangerTablePointToPhaseTapChangerTablePointEvent event) {
	    LOGGER.info("handling AssignPhaseTapChangerTablePointToPhaseTapChangerTablePointEvent - " + event );
	    
	    // ------------------------------------------
    	// delegate to addTo 
    	// ------------------------------------------ 
	    PhaseTapChangerTablePoint entity = addToPhaseTapChangerTablePoint(event.getPhaseTapChangerTablePointId(), event.getAddTo() );
 ...
 */
@EventHandler( payloadType=RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointEvent.class)
public void handle( RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointEvent event) {
    LOGGER.info("handling RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointEvent - " + event );

    PhaseTapChangerTablePoint entity = removeFromPhaseTapChangerTablePoint(event.getPhaseTapChangerTablePointId(), event.getRemoveFrom() );
