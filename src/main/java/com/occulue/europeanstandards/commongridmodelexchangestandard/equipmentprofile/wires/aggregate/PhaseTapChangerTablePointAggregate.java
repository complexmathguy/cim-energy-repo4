...
public class PhaseTapChangerTablePointAggregate {  
    ...
    public void handle(UpdatePhaseTapChangerTablePointCommand command) throws Exception {
    	...
    	UpdatePhaseTapChangerTablePointEvent event = new UpdatePhaseTapChangerTablePointEvent(command.getPhaseTapChangerTablePointId(), command.getAngle(), command.getPhaseTapChangerTablePoint());        
    ...
    @CommandHandler
    public void handle(AssignPhaseTapChangerTablePointToPhaseTapChangerTablePointCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignPhaseTapChangerTablePointToPhaseTapChangerTablePointCommand" );
    	
    	if ( phaseTapChangerTablePoint.contains( command.getAddTo() ) )
    		throw new ProcessingException( "PhaseTapChangerTablePoint already contains an entity with id " + command.getAddTo().getPhaseTapChangerTablePointId() );

    	apply(new AssignPhaseTapChangerTablePointToPhaseTapChangerTablePointEvent(command.getPhaseTapChangerTablePointId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointCommand command) throws Exception {
    	LOGGER.info( "Handling command RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointCommand" );
    	
    	if ( !phaseTapChangerTablePoint.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "PhaseTapChangerTablePoint does not contain an entity with id " + command.getRemoveFrom().getPhaseTapChangerTablePointId() );

        apply(new RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointEvent(command.getPhaseTapChangerTablePointId(), command.getRemoveFrom()));
    }
