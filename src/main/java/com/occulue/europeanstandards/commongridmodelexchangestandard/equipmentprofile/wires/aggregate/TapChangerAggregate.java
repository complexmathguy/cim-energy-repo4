...
public class TapChangerAggregate {  
    ...
    public void handle(UpdateTapChangerCommand command) throws Exception {
    	...
    	UpdateTapChangerEvent event = new UpdateTapChangerEvent(command.getTapChangerId(), command.getHighStep(), command.getLowStep(), command.getLtcFlag(), command.getNeutralStep(), command.getNeutralU(), command.getNormalStep(), command.getTapChanger());        
    ...
    public void handle(AssignTapChangerToTapChangerCommand command) throws Exception {
    	...
    	if ( tapChanger.contains( command.getAddTo() ) )
    		throw new ProcessingException( "TapChanger already contains an entity with id " + command.getAddTo().getTapChangerId() );
    ...
    public void handle(RemoveTapChangerFromTapChangerCommand command) throws Exception {
    	...
    	if ( !tapChanger.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "TapChanger does not contain an entity with id " + command.getRemoveFrom().getTapChangerId() );

        apply(new RemoveTapChangerFromTapChangerEvent(command.getTapChangerId(), command.getRemoveFrom()));
    }
