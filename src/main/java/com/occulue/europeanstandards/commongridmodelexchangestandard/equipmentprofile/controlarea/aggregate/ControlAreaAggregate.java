...
public class ControlAreaAggregate {  
    ...
    public void handle(UpdateControlAreaCommand command) throws Exception {
    	...
    	UpdateControlAreaEvent event = new UpdateControlAreaEvent(command.getControlAreaId(), command.getType(), command.getControlArea());        
    ...
    public void handle(AssignControlAreaToControlAreaCommand command) throws Exception {
        ...
        apply(new AssignControlAreaToControlAreaEvent(command.getControlAreaId(), command.getAssignment()));
    }
