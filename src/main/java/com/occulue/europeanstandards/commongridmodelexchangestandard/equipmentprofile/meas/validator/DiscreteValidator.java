...
//		Assert.isNull( discrete.getDiscreteId(), "CreateDiscreteCommand identifier should be null" );
	...
	public void validate( AssignDiscretesToDiscreteCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscreteId(), "AssignDiscretesToDiscreteCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDiscretesToDiscreteCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveDiscretesFromDiscreteCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscreteId(), "RemoveDiscretesFromDiscreteCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDiscretesFromDiscreteCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDiscreteId(), "RemoveDiscretesFromDiscreteCommand removeFrom attribubte identifier should not be null" );
	}
