...
//		Assert.isNull( command.getCommandId(), "CreateCommandCommand identifier should be null" );
	...
	public void validate( AssignCommandToCommandCommand command ) throws Exception {
		...
		Assert.notNull( command.getCommandId(), "AssignCommandToCommandCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignCommandToCommandCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignCommandFromCommandCommand command ) throws Exception {
		...
		Assert.notNull( command.getCommandId(), "UnAssignCommandFromCommandCommand identifier should not be null" );
	}
	...
	public void validate( AssignCommandsToCommandCommand command ) throws Exception {
		...
		Assert.notNull( command.getCommandId(), "AssignCommandsToCommandCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignCommandsToCommandCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveCommandsFromCommandCommand command ) throws Exception {
		...
		Assert.notNull( command.getCommandId(), "RemoveCommandsFromCommandCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveCommandsFromCommandCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getCommandId(), "RemoveCommandsFromCommandCommand removeFrom attribubte identifier should not be null" );
	}
