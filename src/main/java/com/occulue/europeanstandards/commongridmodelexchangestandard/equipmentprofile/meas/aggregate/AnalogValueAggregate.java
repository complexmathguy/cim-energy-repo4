...
public class AnalogValueAggregate {  
    ...
    public void handle(UpdateAnalogValueCommand command) throws Exception {
    	...
    	UpdateAnalogValueEvent event = new UpdateAnalogValueEvent(command.getAnalogValueId(), command.getValue(), command.getAnalogValues());        
    ...
    public void handle(AssignAnalogValuesToAnalogValueCommand command) throws Exception {
    	...
    	if ( analogValues.contains( command.getAddTo() ) )
    		throw new ProcessingException( "AnalogValues already contains an entity with id " + command.getAddTo().getAnalogValueId() );
    ...
    public void handle(RemoveAnalogValuesFromAnalogValueCommand command) throws Exception {
    	...
    	if ( !analogValues.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "AnalogValues does not contain an entity with id " + command.getRemoveFrom().getAnalogValueId() );

        apply(new RemoveAnalogValuesFromAnalogValueEvent(command.getAnalogValueId(), command.getRemoveFrom()));
    }
