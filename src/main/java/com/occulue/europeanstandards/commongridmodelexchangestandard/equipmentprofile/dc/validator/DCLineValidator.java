...
//		Assert.isNull( dCLine.getDCLineId(), "CreateDCLineCommand identifier should be null" );
	...
	public void validate( AssignDCLinesToDCLineCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCLineId(), "AssignDCLinesToDCLineCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDCLinesToDCLineCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveDCLinesFromDCLineCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCLineId(), "RemoveDCLinesFromDCLineCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDCLinesFromDCLineCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDCLineId(), "RemoveDCLinesFromDCLineCommand removeFrom attribubte identifier should not be null" );
	}
