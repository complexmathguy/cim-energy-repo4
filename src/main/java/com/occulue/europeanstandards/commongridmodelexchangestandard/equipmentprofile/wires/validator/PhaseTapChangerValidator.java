...
//		Assert.isNull( phaseTapChanger.getPhaseTapChangerId(), "CreatePhaseTapChangerCommand identifier should be null" );
	...
	public void validate( AssignPhaseTapChangerToPhaseTapChangerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPhaseTapChangerId(), "AssignPhaseTapChangerToPhaseTapChangerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPhaseTapChangerToPhaseTapChangerCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPhaseTapChangerFromPhaseTapChangerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPhaseTapChangerId(), "UnAssignPhaseTapChangerFromPhaseTapChangerCommand identifier should not be null" );
	}
