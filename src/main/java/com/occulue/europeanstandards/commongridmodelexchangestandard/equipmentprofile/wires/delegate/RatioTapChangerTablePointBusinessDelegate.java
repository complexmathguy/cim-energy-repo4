...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToRatioTapChangerTablePoint( AssignRatioTapChangerTablePointToRatioTapChangerTablePointCommand command ) throws ProcessingException {
		...
		RatioTapChangerTablePointBusinessDelegate childDelegate 	= RatioTapChangerTablePointBusinessDelegate.getRatioTapChangerTablePointInstance();
		RatioTapChangerTablePointBusinessDelegate parentDelegate = RatioTapChangerTablePointBusinessDelegate.getRatioTapChangerTablePointInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a RatioTapChangerTablePoint as RatioTapChangerTablePoint to RatioTapChangerTablePoint" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromRatioTapChangerTablePoint( RemoveRatioTapChangerTablePointFromRatioTapChangerTablePointCommand command ) throws ProcessingException {		
