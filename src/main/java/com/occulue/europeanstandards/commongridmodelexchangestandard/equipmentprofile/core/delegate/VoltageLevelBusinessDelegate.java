...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToVoltageLevel( AssignVoltageLevelToVoltageLevelCommand command ) throws ProcessingException {
		...
		VoltageLevelBusinessDelegate childDelegate 	= VoltageLevelBusinessDelegate.getVoltageLevelInstance();
		VoltageLevelBusinessDelegate parentDelegate = VoltageLevelBusinessDelegate.getVoltageLevelInstance();		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromVoltageLevel( RemoveVoltageLevelFromVoltageLevelCommand command ) throws ProcessingException {		
     ...
     * @exception	ProcessingException
     */     
	public void addToVoltageLevels( AssignVoltageLevelsToVoltageLevelCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromVoltageLevels( RemoveVoltageLevelsFromVoltageLevelCommand command ) throws ProcessingException {		
