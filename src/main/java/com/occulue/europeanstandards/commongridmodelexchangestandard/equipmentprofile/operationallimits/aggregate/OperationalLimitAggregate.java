...
public class OperationalLimitAggregate {  
    ...
    public void handle(UpdateOperationalLimitCommand command) throws Exception {
    	...
    	UpdateOperationalLimitEvent event = new UpdateOperationalLimitEvent(command.getOperationalLimitId(), command.getOperationalLimit(), command.getOperationalLimitValue());        
    ...
    public void handle(AssignOperationalLimitToOperationalLimitCommand command) throws Exception {
    	...
    	if ( operationalLimit.contains( command.getAddTo() ) )
    		throw new ProcessingException( "OperationalLimit already contains an entity with id " + command.getAddTo().getOperationalLimitId() );

    	apply(new AssignOperationalLimitToOperationalLimitEvent(command.getOperationalLimitId(), command.getAddTo()));
    }
    ...
    public void handle(RemoveOperationalLimitFromOperationalLimitCommand command) throws Exception {
    	...
    	if ( !operationalLimit.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "OperationalLimit does not contain an entity with id " + command.getRemoveFrom().getOperationalLimitId() );

        apply(new RemoveOperationalLimitFromOperationalLimitEvent(command.getOperationalLimitId(), command.getRemoveFrom()));
    }
    @CommandHandler
    public void handle(AssignOperationalLimitValueToOperationalLimitCommand command) throws Exception {
    	...
    	if ( operationalLimitValue.contains( command.getAddTo() ) )
    		throw new ProcessingException( "OperationalLimitValue already contains an entity with id " + command.getAddTo().getOperationalLimitId() );

    	apply(new AssignOperationalLimitValueToOperationalLimitEvent(command.getOperationalLimitId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveOperationalLimitValueFromOperationalLimitCommand command) throws Exception {
    	...
    	if ( !operationalLimitValue.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "OperationalLimitValue does not contain an entity with id " + command.getRemoveFrom().getOperationalLimitId() );

        apply(new RemoveOperationalLimitValueFromOperationalLimitEvent(command.getOperationalLimitId(), command.getRemoveFrom()));
    }
