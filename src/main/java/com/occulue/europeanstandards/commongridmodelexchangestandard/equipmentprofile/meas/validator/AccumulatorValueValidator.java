...
//		Assert.isNull( accumulatorValue.getAccumulatorValueId(), "CreateAccumulatorValueCommand identifier should be null" );
	...
	public void validate( AssignAccumulatorValuesToAccumulatorValueCommand command ) throws Exception {
		...
		Assert.notNull( command.getAccumulatorValueId(), "AssignAccumulatorValuesToAccumulatorValueCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignAccumulatorValuesToAccumulatorValueCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveAccumulatorValuesFromAccumulatorValueCommand command ) throws Exception {
		Assert.notNull( command, "RemoveAccumulatorValuesFromAccumulatorValueCommand should not be null" );
		Assert.notNull( command.getAccumulatorValueId(), "RemoveAccumulatorValuesFromAccumulatorValueCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveAccumulatorValuesFromAccumulatorValueCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getAccumulatorValueId(), "RemoveAccumulatorValuesFromAccumulatorValueCommand removeFrom attribubte identifier should not be null" );
	}
