...
//		Assert.isNull( nonConformLoadSchedule.getNonConformLoadScheduleId(), "CreateNonConformLoadScheduleCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignNonConformLoadSchedulesToNonConformLoadScheduleCommand command ) throws Exception {
		Assert.notNull( command, "AssignNonConformLoadSchedulesToNonConformLoadScheduleCommand should not be null" );
		Assert.notNull( command.getNonConformLoadScheduleId(), "AssignNonConformLoadSchedulesToNonConformLoadScheduleCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignNonConformLoadSchedulesToNonConformLoadScheduleCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveNonConformLoadSchedulesFromNonConformLoadScheduleCommand command ) throws Exception {
		Assert.notNull( command, "RemoveNonConformLoadSchedulesFromNonConformLoadScheduleCommand should not be null" );
		Assert.notNull( command.getNonConformLoadScheduleId(), "RemoveNonConformLoadSchedulesFromNonConformLoadScheduleCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveNonConformLoadSchedulesFromNonConformLoadScheduleCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getNonConformLoadScheduleId(), "RemoveNonConformLoadSchedulesFromNonConformLoadScheduleCommand removeFrom attribubte identifier should not be null" );
	}
