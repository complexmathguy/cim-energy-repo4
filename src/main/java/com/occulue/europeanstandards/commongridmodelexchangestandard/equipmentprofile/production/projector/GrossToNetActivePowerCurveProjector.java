...
public class GrossToNetActivePowerCurveProjector extends GrossToNetActivePowerCurveEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveEvent.class)
    public void handle( AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveEvent event) {
	    LOGGER.info("handling AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveEvent - " + event );
	    
	    // ------------------------------------------
    	// delegate to addTo 
    	// ------------------------------------------ 
	    GrossToNetActivePowerCurve entity = addToGrossToNetActivePowerCurves(event.getGrossToNetActivePowerCurveId(), event.getAddTo() );
 ...
 */
@EventHandler( payloadType=RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveEvent.class)
public void handle( RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveEvent event) {
    LOGGER.info("handling RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveEvent - " + event );

    GrossToNetActivePowerCurve entity = removeFromGrossToNetActivePowerCurves(event.getGrossToNetActivePowerCurveId(), event.getRemoveFrom() );
