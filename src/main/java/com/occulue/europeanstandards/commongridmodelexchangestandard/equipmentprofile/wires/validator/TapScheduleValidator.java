...
//		Assert.isNull( tapSchedule.getTapScheduleId(), "CreateTapScheduleCommand identifier should be null" );
	...
	public void validate( AssignTapSchedulesToTapScheduleCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapScheduleId(), "AssignTapSchedulesToTapScheduleCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignTapSchedulesToTapScheduleCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveTapSchedulesFromTapScheduleCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapScheduleId(), "RemoveTapSchedulesFromTapScheduleCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveTapSchedulesFromTapScheduleCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getTapScheduleId(), "RemoveTapSchedulesFromTapScheduleCommand removeFrom attribubte identifier should not be null" );
	}
