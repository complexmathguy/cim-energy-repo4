...
//		Assert.isNull( measurement.getMeasurementId(), "CreateMeasurementCommand identifier should be null" );
	...
	public void validate( AssignMeasurementsToMeasurementCommand command ) throws Exception {
		...
		Assert.notNull( command.getMeasurementId(), "AssignMeasurementsToMeasurementCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignMeasurementsToMeasurementCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveMeasurementsFromMeasurementCommand command ) throws Exception {
		...
		Assert.notNull( command.getMeasurementId(), "RemoveMeasurementsFromMeasurementCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveMeasurementsFromMeasurementCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getMeasurementId(), "RemoveMeasurementsFromMeasurementCommand removeFrom attribubte identifier should not be null" );
	}
