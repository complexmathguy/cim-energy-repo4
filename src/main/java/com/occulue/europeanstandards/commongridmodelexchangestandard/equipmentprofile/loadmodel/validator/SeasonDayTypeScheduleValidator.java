...
//		Assert.isNull( seasonDayTypeSchedule.getSeasonDayTypeScheduleId(), "CreateSeasonDayTypeScheduleCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignSeasonDayTypeSchedulesToSeasonDayTypeScheduleCommand command ) throws Exception {
		Assert.notNull( command, "AssignSeasonDayTypeSchedulesToSeasonDayTypeScheduleCommand should not be null" );
		Assert.notNull( command.getSeasonDayTypeScheduleId(), "AssignSeasonDayTypeSchedulesToSeasonDayTypeScheduleCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignSeasonDayTypeSchedulesToSeasonDayTypeScheduleCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveSeasonDayTypeSchedulesFromSeasonDayTypeScheduleCommand command ) throws Exception {
		Assert.notNull( command, "RemoveSeasonDayTypeSchedulesFromSeasonDayTypeScheduleCommand should not be null" );
		Assert.notNull( command.getSeasonDayTypeScheduleId(), "RemoveSeasonDayTypeSchedulesFromSeasonDayTypeScheduleCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveSeasonDayTypeSchedulesFromSeasonDayTypeScheduleCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getSeasonDayTypeScheduleId(), "RemoveSeasonDayTypeSchedulesFromSeasonDayTypeScheduleCommand removeFrom attribubte identifier should not be null" );
	}
