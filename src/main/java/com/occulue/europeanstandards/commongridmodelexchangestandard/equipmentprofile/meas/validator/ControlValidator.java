...
//		Assert.isNull( control.getControlId(), "CreateControlCommand identifier should be null" );
	...
	public void validate( AssignControlsToControlCommand command ) throws Exception {
		...
		Assert.notNull( command.getControlId(), "AssignControlsToControlCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignControlsToControlCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveControlsFromControlCommand command ) throws Exception {
		...
		Assert.notNull( command.getControlId(), "RemoveControlsFromControlCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveControlsFromControlCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getControlId(), "RemoveControlsFromControlCommand removeFrom attribubte identifier should not be null" );
	}
