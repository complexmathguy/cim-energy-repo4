...
//		Assert.isNull( hydroGeneratingUnit.getHydroGeneratingUnitId(), "CreateHydroGeneratingUnitCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignHydroGeneratingUnitsToHydroGeneratingUnitCommand command ) throws Exception {
		Assert.notNull( command, "AssignHydroGeneratingUnitsToHydroGeneratingUnitCommand should not be null" );
		Assert.notNull( command.getHydroGeneratingUnitId(), "AssignHydroGeneratingUnitsToHydroGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignHydroGeneratingUnitsToHydroGeneratingUnitCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveHydroGeneratingUnitsFromHydroGeneratingUnitCommand command ) throws Exception {
		Assert.notNull( command, "RemoveHydroGeneratingUnitsFromHydroGeneratingUnitCommand should not be null" );
		Assert.notNull( command.getHydroGeneratingUnitId(), "RemoveHydroGeneratingUnitsFromHydroGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveHydroGeneratingUnitsFromHydroGeneratingUnitCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getHydroGeneratingUnitId(), "RemoveHydroGeneratingUnitsFromHydroGeneratingUnitCommand removeFrom attribubte identifier should not be null" );
	}
