...
//		Assert.isNull( bay.getBayId(), "CreateBayCommand identifier should be null" );
	...
	public void validate( RemoveBaysFromBayCommand command ) throws Exception {
		...
		Assert.notNull( command.getRemoveFrom(), "RemoveBaysFromBayCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getBayId(), "RemoveBaysFromBayCommand removeFrom attribubte identifier should not be null" );
	}
