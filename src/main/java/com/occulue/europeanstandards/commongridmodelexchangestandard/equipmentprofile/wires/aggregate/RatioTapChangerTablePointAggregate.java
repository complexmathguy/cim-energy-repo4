...
public class RatioTapChangerTablePointAggregate {  
    ...
    public void handle(UpdateRatioTapChangerTablePointCommand command) throws Exception {
    	...
    	UpdateRatioTapChangerTablePointEvent event = new UpdateRatioTapChangerTablePointEvent(command.getRatioTapChangerTablePointId(), command.getRatioTapChangerTablePoint());        
    ...
    @CommandHandler
    public void handle(AssignRatioTapChangerTablePointToRatioTapChangerTablePointCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignRatioTapChangerTablePointToRatioTapChangerTablePointCommand" );
    	
    	if ( ratioTapChangerTablePoint.contains( command.getAddTo() ) )
    		throw new ProcessingException( "RatioTapChangerTablePoint already contains an entity with id " + command.getAddTo().getRatioTapChangerTablePointId() );

    	apply(new AssignRatioTapChangerTablePointToRatioTapChangerTablePointEvent(command.getRatioTapChangerTablePointId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveRatioTapChangerTablePointFromRatioTapChangerTablePointCommand command) throws Exception {
    	LOGGER.info( "Handling command RemoveRatioTapChangerTablePointFromRatioTapChangerTablePointCommand" );
    	
    	if ( !ratioTapChangerTablePoint.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "RatioTapChangerTablePoint does not contain an entity with id " + command.getRemoveFrom().getRatioTapChangerTablePointId() );

        apply(new RemoveRatioTapChangerTablePointFromRatioTapChangerTablePointEvent(command.getRatioTapChangerTablePointId(), command.getRemoveFrom()));
    }
