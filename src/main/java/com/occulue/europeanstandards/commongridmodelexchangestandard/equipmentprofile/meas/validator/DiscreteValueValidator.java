...
//		Assert.isNull( discreteValue.getDiscreteValueId(), "CreateDiscreteValueCommand identifier should be null" );
	...
	public void validate( AssignDiscreteValuesToDiscreteValueCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscreteValueId(), "AssignDiscreteValuesToDiscreteValueCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDiscreteValuesToDiscreteValueCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveDiscreteValuesFromDiscreteValueCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscreteValueId(), "RemoveDiscreteValuesFromDiscreteValueCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDiscreteValuesFromDiscreteValueCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDiscreteValueId(), "RemoveDiscreteValuesFromDiscreteValueCommand removeFrom attribubte identifier should not be null" );
	}
