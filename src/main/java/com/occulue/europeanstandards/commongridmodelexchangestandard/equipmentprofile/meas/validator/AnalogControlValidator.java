...
//		Assert.isNull( analogControl.getAnalogControlId(), "CreateAnalogControlCommand identifier should be null" );
	...
	public void validate( AssignAnalogControlToAnalogControlCommand command ) throws Exception {
		...
		Assert.notNull( command.getAnalogControlId(), "AssignAnalogControlToAnalogControlCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAnalogControlToAnalogControlCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAnalogControlFromAnalogControlCommand command ) throws Exception {
		...
		Assert.notNull( command.getAnalogControlId(), "UnAssignAnalogControlFromAnalogControlCommand identifier should not be null" );
	}
