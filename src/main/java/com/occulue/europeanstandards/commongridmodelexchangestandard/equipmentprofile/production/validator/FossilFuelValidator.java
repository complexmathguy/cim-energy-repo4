...
//		Assert.isNull( fossilFuel.getFossilFuelId(), "CreateFossilFuelCommand identifier should be null" );
	...
	public void validate( AssignFossilFuelsToFossilFuelCommand command ) throws Exception {
		...
		Assert.notNull( command.getFossilFuelId(), "AssignFossilFuelsToFossilFuelCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignFossilFuelsToFossilFuelCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveFossilFuelsFromFossilFuelCommand command ) throws Exception {
		...
		Assert.notNull( command.getFossilFuelId(), "RemoveFossilFuelsFromFossilFuelCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveFossilFuelsFromFossilFuelCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getFossilFuelId(), "RemoveFossilFuelsFromFossilFuelCommand removeFrom attribubte identifier should not be null" );
	}
