...
//		Assert.isNull( dCConverterUnit.getDCConverterUnitId(), "CreateDCConverterUnitCommand identifier should be null" );
	...
	public void validate( AssignDCConverterUnitToDCConverterUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCConverterUnitId(), "AssignDCConverterUnitToDCConverterUnitCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDCConverterUnitToDCConverterUnitCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveDCConverterUnitFromDCConverterUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCConverterUnitId(), "RemoveDCConverterUnitFromDCConverterUnitCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDCConverterUnitFromDCConverterUnitCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDCConverterUnitId(), "RemoveDCConverterUnitFromDCConverterUnitCommand removeFrom attribubte identifier should not be null" );
	}
