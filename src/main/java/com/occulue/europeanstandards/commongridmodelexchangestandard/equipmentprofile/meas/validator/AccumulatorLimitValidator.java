...
//		Assert.isNull( accumulatorLimit.getAccumulatorLimitId(), "CreateAccumulatorLimitCommand identifier should be null" );
	...
	public void validate( AssignLimitsToAccumulatorLimitCommand command ) throws Exception {
		...
		Assert.notNull( command.getAccumulatorLimitId(), "AssignLimitsToAccumulatorLimitCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignLimitsToAccumulatorLimitCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveLimitsFromAccumulatorLimitCommand command ) throws Exception {
		...
		Assert.notNull( command.getAccumulatorLimitId(), "RemoveLimitsFromAccumulatorLimitCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveLimitsFromAccumulatorLimitCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getAccumulatorLimitId(), "RemoveLimitsFromAccumulatorLimitCommand removeFrom attribubte identifier should not be null" );
	}
