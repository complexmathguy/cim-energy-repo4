...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToNonConformLoadSchedules( AssignNonConformLoadSchedulesToNonConformLoadScheduleCommand command ) throws ProcessingException {
		...
		NonConformLoadScheduleBusinessDelegate childDelegate 	= NonConformLoadScheduleBusinessDelegate.getNonConformLoadScheduleInstance();
		NonConformLoadScheduleBusinessDelegate parentDelegate = NonConformLoadScheduleBusinessDelegate.getNonConformLoadScheduleInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a NonConformLoadSchedule as NonConformLoadSchedules to NonConformLoadSchedule" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromNonConformLoadSchedules( RemoveNonConformLoadSchedulesFromNonConformLoadScheduleCommand command ) throws ProcessingException {		
