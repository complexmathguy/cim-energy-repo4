...
//		Assert.isNull( equivalentEquipment.getEquivalentEquipmentId(), "CreateEquivalentEquipmentCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignEquivalentEquipmentsToEquivalentEquipmentCommand command ) throws Exception {
		Assert.notNull( command, "AssignEquivalentEquipmentsToEquivalentEquipmentCommand should not be null" );
		Assert.notNull( command.getEquivalentEquipmentId(), "AssignEquivalentEquipmentsToEquivalentEquipmentCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignEquivalentEquipmentsToEquivalentEquipmentCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveEquivalentEquipmentsFromEquivalentEquipmentCommand command ) throws Exception {
		Assert.notNull( command, "RemoveEquivalentEquipmentsFromEquivalentEquipmentCommand should not be null" );
		Assert.notNull( command.getEquivalentEquipmentId(), "RemoveEquivalentEquipmentsFromEquivalentEquipmentCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveEquivalentEquipmentsFromEquivalentEquipmentCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getEquivalentEquipmentId(), "RemoveEquivalentEquipmentsFromEquivalentEquipmentCommand removeFrom attribubte identifier should not be null" );
	}
