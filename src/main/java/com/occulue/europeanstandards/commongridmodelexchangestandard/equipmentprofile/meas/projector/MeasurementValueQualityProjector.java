...
public class MeasurementValueQualityProjector extends MeasurementValueQualityEntityProjector {
    ...
    public void handle( AssignMeasurementValueQualityToMeasurementValueQualityEvent event) {
	    ...
	    // ------------------------------------------
	    MeasurementValueQuality entity = assignMeasurementValueQuality( event.getMeasurementValueQualityId(), event.getAssignment() );
	...
	public void handle( UnAssignMeasurementValueQualityFromMeasurementValueQualityEvent event) {
	    LOGGER.info("handling UnAssignMeasurementValueQualityFromMeasurementValueQualityEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    MeasurementValueQuality entity = unAssignMeasurementValueQuality( event.getMeasurementValueQualityId() );
