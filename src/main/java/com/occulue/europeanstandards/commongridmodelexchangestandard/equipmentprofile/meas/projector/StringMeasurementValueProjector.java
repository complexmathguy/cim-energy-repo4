...
public class StringMeasurementValueProjector extends StringMeasurementValueEntityProjector {
    ...
    public void handle( AssignStringMeasurementValuesToStringMeasurementValueEvent event) {
    	...
    	// delegate to addTo 
    	// ------------------------------------------ 
	    StringMeasurementValue entity = addToStringMeasurementValues(event.getStringMeasurementValueId(), event.getAddTo() );
...
public void handle( RemoveStringMeasurementValuesFromStringMeasurementValueEvent event) {
    ...
    StringMeasurementValue entity = removeFromStringMeasurementValues(event.getStringMeasurementValueId(), event.getRemoveFrom() );
