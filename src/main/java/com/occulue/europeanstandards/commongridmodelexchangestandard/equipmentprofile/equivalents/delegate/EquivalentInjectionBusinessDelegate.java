...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToEquivalentInjection( AssignEquivalentInjectionToEquivalentInjectionCommand command ) throws ProcessingException {
		...
		EquivalentInjectionBusinessDelegate childDelegate 	= EquivalentInjectionBusinessDelegate.getEquivalentInjectionInstance();
		EquivalentInjectionBusinessDelegate parentDelegate = EquivalentInjectionBusinessDelegate.getEquivalentInjectionInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a EquivalentInjection as EquivalentInjection to EquivalentInjection" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromEquivalentInjection( RemoveEquivalentInjectionFromEquivalentInjectionCommand command ) throws ProcessingException {		
