...
public class DCLineSegmentAggregate {  
    ...
    public void handle(UpdateDCLineSegmentCommand command) throws Exception {
    	...
    	UpdateDCLineSegmentEvent event = new UpdateDCLineSegmentEvent(command.getDCLineSegmentId(), command.getCapacitance(), command.getInductance(), command.getLength(), command.getResistance(), command.getDCLineSegments());        
    ...
    public void handle(AssignDCLineSegmentsToDCLineSegmentCommand command) throws Exception {
    	...
    	if ( dCLineSegments.contains( command.getAddTo() ) )
    		throw new ProcessingException( "DCLineSegments already contains an entity with id " + command.getAddTo().getDCLineSegmentId() );

    	apply(new AssignDCLineSegmentsToDCLineSegmentEvent(command.getDCLineSegmentId(), command.getAddTo()));
    }
    ...
    public void handle(RemoveDCLineSegmentsFromDCLineSegmentCommand command) throws Exception {
    	...
    	if ( !dCLineSegments.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "DCLineSegments does not contain an entity with id " + command.getRemoveFrom().getDCLineSegmentId() );

        apply(new RemoveDCLineSegmentsFromDCLineSegmentEvent(command.getDCLineSegmentId(), command.getRemoveFrom()));
    }
