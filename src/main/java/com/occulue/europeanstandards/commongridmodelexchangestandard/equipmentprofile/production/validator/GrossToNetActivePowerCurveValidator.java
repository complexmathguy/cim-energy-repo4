...
//		Assert.isNull( grossToNetActivePowerCurve.getGrossToNetActivePowerCurveId(), "CreateGrossToNetActivePowerCurveCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveCommand command ) throws Exception {
		Assert.notNull( command, "AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveCommand should not be null" );
		Assert.notNull( command.getGrossToNetActivePowerCurveId(), "AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveCommand command ) throws Exception {
		Assert.notNull( command, "RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveCommand should not be null" );
		Assert.notNull( command.getGrossToNetActivePowerCurveId(), "RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getGrossToNetActivePowerCurveId(), "RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveCommand removeFrom attribubte identifier should not be null" );
	}
