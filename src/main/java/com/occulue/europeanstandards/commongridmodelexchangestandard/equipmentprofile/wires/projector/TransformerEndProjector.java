...
public void handle( RemoveTransformerEndsFromTransformerEndEvent event) {
    ...
    TransformerEnd entity = removeFromTransformerEnds(event.getTransformerEndId(), event.getRemoveFrom() );
...
public void handle( RemoveTransformerEndFromTransformerEndEvent event) {
    ...
    TransformerEnd entity = removeFromTransformerEnd(event.getTransformerEndId(), event.getRemoveFrom() );
