...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToOperationalLimitSet( AssignOperationalLimitSetToOperationalLimitSetCommand command ) throws ProcessingException {
		...
		OperationalLimitSetBusinessDelegate parentDelegate = OperationalLimitSetBusinessDelegate.getOperationalLimitSetInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a OperationalLimitSet as OperationalLimitSet to OperationalLimitSet" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromOperationalLimitSet( RemoveOperationalLimitSetFromOperationalLimitSetCommand command ) throws ProcessingException {		
