...
//		Assert.isNull( aCDCConverterDCTerminal.getACDCConverterDCTerminalId(), "CreateACDCConverterDCTerminalCommand identifier should be null" );
	...
	public void validate( AssignDCTerminalsToACDCConverterDCTerminalCommand command ) throws Exception {
		...
		Assert.notNull( command.getACDCConverterDCTerminalId(), "AssignDCTerminalsToACDCConverterDCTerminalCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDCTerminalsToACDCConverterDCTerminalCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveDCTerminalsFromACDCConverterDCTerminalCommand command ) throws Exception {
		Assert.notNull( command, "RemoveDCTerminalsFromACDCConverterDCTerminalCommand should not be null" );
		Assert.notNull( command.getACDCConverterDCTerminalId(), "RemoveDCTerminalsFromACDCConverterDCTerminalCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDCTerminalsFromACDCConverterDCTerminalCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getACDCConverterDCTerminalId(), "RemoveDCTerminalsFromACDCConverterDCTerminalCommand removeFrom attribubte identifier should not be null" );
	}
