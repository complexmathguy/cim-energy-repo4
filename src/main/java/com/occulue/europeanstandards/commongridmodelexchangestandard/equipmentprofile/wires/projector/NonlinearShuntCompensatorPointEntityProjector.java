...
public class NonlinearShuntCompensatorPointEntityProjector {
     ...
     * @return	NonlinearShuntCompensatorPoint
     */
    public NonlinearShuntCompensatorPoint addToNonlinearShuntCompensatorPoints( UUID parentId, NonlinearShuntCompensatorPoint addTo ) {
	    LOGGER.info("handling AssignNonlinearShuntCompensatorPointsToNonlinearShuntCompensatorPointEvent - " );
	    
	    NonlinearShuntCompensatorPoint parentEntity = repository.findById(parentId).get();
	    NonlinearShuntCompensatorPoint child = NonlinearShuntCompensatorPointProjector.find(addTo.getNonlinearShuntCompensatorPointId());
     ...
     * @return	NonlinearShuntCompensatorPoint
     */
	public NonlinearShuntCompensatorPoint removeFromNonlinearShuntCompensatorPoints( UUID parentId, NonlinearShuntCompensatorPoint removeFrom ) {
	    LOGGER.info("handling RemoveNonlinearShuntCompensatorPointsFromNonlinearShuntCompensatorPointEvent " );
	
	    NonlinearShuntCompensatorPoint parentEntity = repository.findById(parentId).get();
	    NonlinearShuntCompensatorPoint child = NonlinearShuntCompensatorPointProjector.find(removeFrom.getNonlinearShuntCompensatorPointId());
