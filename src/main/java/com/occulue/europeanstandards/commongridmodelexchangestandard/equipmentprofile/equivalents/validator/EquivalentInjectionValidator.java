...
//		Assert.isNull( equivalentInjection.getEquivalentInjectionId(), "CreateEquivalentInjectionCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignEquivalentInjectionToEquivalentInjectionCommand command ) throws Exception {
		Assert.notNull( command, "AssignEquivalentInjectionToEquivalentInjectionCommand should not be null" );
		Assert.notNull( command.getEquivalentInjectionId(), "AssignEquivalentInjectionToEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignEquivalentInjectionToEquivalentInjectionCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveEquivalentInjectionFromEquivalentInjectionCommand command ) throws Exception {
		Assert.notNull( command, "RemoveEquivalentInjectionFromEquivalentInjectionCommand should not be null" );
		Assert.notNull( command.getEquivalentInjectionId(), "RemoveEquivalentInjectionFromEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveEquivalentInjectionFromEquivalentInjectionCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getEquivalentInjectionId(), "RemoveEquivalentInjectionFromEquivalentInjectionCommand removeFrom attribubte identifier should not be null" );
	}
