...
//		Assert.isNull( valueToAlias.getValueToAliasId(), "CreateValueToAliasCommand identifier should be null" );
	...
	public void validate( AssignValuesToValueToAliasCommand command ) throws Exception {
		...
		Assert.notNull( command.getValueToAliasId(), "AssignValuesToValueToAliasCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignValuesToValueToAliasCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveValuesFromValueToAliasCommand command ) throws Exception {
		...
		Assert.notNull( command.getValueToAliasId(), "RemoveValuesFromValueToAliasCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveValuesFromValueToAliasCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getValueToAliasId(), "RemoveValuesFromValueToAliasCommand removeFrom attribubte identifier should not be null" );
	}
