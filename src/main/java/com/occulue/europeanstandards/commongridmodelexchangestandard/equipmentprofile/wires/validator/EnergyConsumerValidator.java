...
//		Assert.isNull( energyConsumer.getEnergyConsumerId(), "CreateEnergyConsumerCommand identifier should be null" );
	...
	public void validate( AssignEnergyConsumerToEnergyConsumerCommand command ) throws Exception {
		...
		Assert.notNull( command.getEnergyConsumerId(), "AssignEnergyConsumerToEnergyConsumerCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignEnergyConsumerToEnergyConsumerCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveEnergyConsumerFromEnergyConsumerCommand command ) throws Exception {
		...
		Assert.notNull( command.getEnergyConsumerId(), "RemoveEnergyConsumerFromEnergyConsumerCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveEnergyConsumerFromEnergyConsumerCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getEnergyConsumerId(), "RemoveEnergyConsumerFromEnergyConsumerCommand removeFrom attribubte identifier should not be null" );
	}
