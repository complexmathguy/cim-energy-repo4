...
//		Assert.isNull( curveData.getCurveDataId(), "CreateCurveDataCommand identifier should be null" );
	...
	public void validate( AssignCurveDatasToCurveDataCommand command ) throws Exception {
		...
		Assert.notNull( command.getCurveDataId(), "AssignCurveDatasToCurveDataCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignCurveDatasToCurveDataCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveCurveDatasFromCurveDataCommand command ) throws Exception {
		...
		Assert.notNull( command.getCurveDataId(), "RemoveCurveDatasFromCurveDataCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveCurveDatasFromCurveDataCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getCurveDataId(), "RemoveCurveDatasFromCurveDataCommand removeFrom attribubte identifier should not be null" );
	}
