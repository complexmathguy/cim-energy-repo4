...
public class HydroGeneratingUnitEntityProjector {
     ...
     * @return	HydroGeneratingUnit
     */
	public HydroGeneratingUnit removeFromHydroGeneratingUnits( UUID parentId, HydroGeneratingUnit removeFrom ) {
	    LOGGER.info("handling RemoveHydroGeneratingUnitsFromHydroGeneratingUnitEvent " );
	
	    HydroGeneratingUnit parentEntity = repository.findById(parentId).get();
	    HydroGeneratingUnit child = HydroGeneratingUnitProjector.find(removeFrom.getHydroGeneratingUnitId());
