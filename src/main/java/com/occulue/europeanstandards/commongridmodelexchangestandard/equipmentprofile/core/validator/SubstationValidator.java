...
//		Assert.isNull( substation.getSubstationId(), "CreateSubstationCommand identifier should be null" );
	...
	public void validate( AssignSubstationsToSubstationCommand command ) throws Exception {
		...
		Assert.notNull( command.getSubstationId(), "AssignSubstationsToSubstationCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignSubstationsToSubstationCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveSubstationsFromSubstationCommand command ) throws Exception {
		...
		Assert.notNull( command.getSubstationId(), "RemoveSubstationsFromSubstationCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveSubstationsFromSubstationCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getSubstationId(), "RemoveSubstationsFromSubstationCommand removeFrom attribubte identifier should not be null" );
	}
