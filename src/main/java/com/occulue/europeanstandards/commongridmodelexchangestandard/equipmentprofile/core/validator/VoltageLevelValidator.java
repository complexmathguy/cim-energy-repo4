...
//		Assert.isNull( voltageLevel.getVoltageLevelId(), "CreateVoltageLevelCommand identifier should be null" );
	...
	public void validate( AssignVoltageLevelToVoltageLevelCommand command ) throws Exception {
		...
		Assert.notNull( command.getVoltageLevelId(), "AssignVoltageLevelToVoltageLevelCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignVoltageLevelToVoltageLevelCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveVoltageLevelFromVoltageLevelCommand command ) throws Exception {
		...
		Assert.notNull( command.getVoltageLevelId(), "RemoveVoltageLevelFromVoltageLevelCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveVoltageLevelFromVoltageLevelCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getVoltageLevelId(), "RemoveVoltageLevelFromVoltageLevelCommand removeFrom attribubte identifier should not be null" );
	}
	...
	public void validate( AssignVoltageLevelsToVoltageLevelCommand command ) throws Exception {
		...
		Assert.notNull( command.getVoltageLevelId(), "AssignVoltageLevelsToVoltageLevelCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignVoltageLevelsToVoltageLevelCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveVoltageLevelsFromVoltageLevelCommand command ) throws Exception {
		...
		Assert.notNull( command.getVoltageLevelId(), "RemoveVoltageLevelsFromVoltageLevelCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveVoltageLevelsFromVoltageLevelCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getVoltageLevelId(), "RemoveVoltageLevelsFromVoltageLevelCommand removeFrom attribubte identifier should not be null" );
	}
