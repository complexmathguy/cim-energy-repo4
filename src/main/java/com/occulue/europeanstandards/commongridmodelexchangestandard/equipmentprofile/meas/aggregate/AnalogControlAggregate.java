...
public class AnalogControlAggregate {  
    ...
    public void handle(UpdateAnalogControlCommand command) throws Exception {
    	...
    	UpdateAnalogControlEvent event = new UpdateAnalogControlEvent(command.getAnalogControlId(), command.getMaxValue(), command.getMinValue(), command.getAnalogControl());        
    ...
    public void handle(AssignAnalogControlToAnalogControlCommand command) throws Exception {
    	...
    	if (  analogControl != null && analogControl.getAnalogControlId() == command.getAssignment().getAnalogControlId() )
    		throw new ProcessingException( "AnalogControl already assigned with id " + command.getAssignment().getAnalogControlId() );  
    		
        apply(new AssignAnalogControlToAnalogControlEvent(command.getAnalogControlId(), command.getAssignment()));
    }
