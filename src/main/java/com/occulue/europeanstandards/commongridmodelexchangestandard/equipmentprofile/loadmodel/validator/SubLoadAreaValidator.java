...
//		Assert.isNull( subLoadArea.getSubLoadAreaId(), "CreateSubLoadAreaCommand identifier should be null" );
	...
	public void validate( AssignSubLoadAreasToSubLoadAreaCommand command ) throws Exception {
		...
		Assert.notNull( command.getSubLoadAreaId(), "AssignSubLoadAreasToSubLoadAreaCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignSubLoadAreasToSubLoadAreaCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveSubLoadAreasFromSubLoadAreaCommand command ) throws Exception {
		...
		Assert.notNull( command.getSubLoadAreaId(), "RemoveSubLoadAreasFromSubLoadAreaCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveSubLoadAreasFromSubLoadAreaCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getSubLoadAreaId(), "RemoveSubLoadAreasFromSubLoadAreaCommand removeFrom attribubte identifier should not be null" );
	}
