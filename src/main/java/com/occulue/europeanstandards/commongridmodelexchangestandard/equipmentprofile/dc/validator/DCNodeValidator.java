...
//		Assert.isNull( dCNode.getDCNodeId(), "CreateDCNodeCommand identifier should be null" );
	...
	public void validate( AssignDCNodesToDCNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCNodeId(), "AssignDCNodesToDCNodeCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDCNodesToDCNodeCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveDCNodesFromDCNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCNodeId(), "RemoveDCNodesFromDCNodeCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDCNodesFromDCNodeCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDCNodeId(), "RemoveDCNodesFromDCNodeCommand removeFrom attribubte identifier should not be null" );
	}
