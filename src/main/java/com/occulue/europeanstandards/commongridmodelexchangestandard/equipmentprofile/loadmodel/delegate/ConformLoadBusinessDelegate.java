...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToEnergyConsumers( AssignEnergyConsumersToConformLoadCommand command ) throws ProcessingException {
		...
		ConformLoadBusinessDelegate childDelegate 	= ConformLoadBusinessDelegate.getConformLoadInstance();
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromEnergyConsumers( RemoveEnergyConsumersFromConformLoadCommand command ) throws ProcessingException {		
