...
//		Assert.isNull( aCDCConverter.getACDCConverterId(), "CreateACDCConverterCommand identifier should be null" );
	...
	public void validate( AssignConverterDCSidesToACDCConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getACDCConverterId(), "AssignConverterDCSidesToACDCConverterCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignConverterDCSidesToACDCConverterCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveConverterDCSidesFromACDCConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getACDCConverterId(), "RemoveConverterDCSidesFromACDCConverterCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveConverterDCSidesFromACDCConverterCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getACDCConverterId(), "RemoveConverterDCSidesFromACDCConverterCommand removeFrom attribubte identifier should not be null" );
	}
