...
public class TransformerEndAggregate {  
    ...
    public void handle(UpdateTransformerEndCommand command) throws Exception {
    	...
    	UpdateTransformerEndEvent event = new UpdateTransformerEndEvent(command.getTransformerEndId(), command.getEndNumber(), command.getGrounded(), command.getRground(), command.getXground(), command.getTransformerEnds(), command.getTransformerEnd());        
    ...
    public void handle(AssignTransformerEndsToTransformerEndCommand command) throws Exception {
    	...
    	if ( transformerEnds.contains( command.getAddTo() ) )
    		throw new ProcessingException( "TransformerEnds already contains an entity with id " + command.getAddTo().getTransformerEndId() );

    	apply(new AssignTransformerEndsToTransformerEndEvent(command.getTransformerEndId(), command.getAddTo()));
    }
    ...
    public void handle(RemoveTransformerEndsFromTransformerEndCommand command) throws Exception {
    	...
    	if ( !transformerEnds.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "TransformerEnds does not contain an entity with id " + command.getRemoveFrom().getTransformerEndId() );

        apply(new RemoveTransformerEndsFromTransformerEndEvent(command.getTransformerEndId(), command.getRemoveFrom()));
    }
    @CommandHandler
    public void handle(AssignTransformerEndToTransformerEndCommand command) throws Exception {
    	...
    	if ( transformerEnd.contains( command.getAddTo() ) )
    		throw new ProcessingException( "TransformerEnd already contains an entity with id " + command.getAddTo().getTransformerEndId() );

    	apply(new AssignTransformerEndToTransformerEndEvent(command.getTransformerEndId(), command.getAddTo()));
    }
    ...
    public void handle(RemoveTransformerEndFromTransformerEndCommand command) throws Exception {
    	...
    	if ( !transformerEnd.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "TransformerEnd does not contain an entity with id " + command.getRemoveFrom().getTransformerEndId() );

        apply(new RemoveTransformerEndFromTransformerEndEvent(command.getTransformerEndId(), command.getRemoveFrom()));
    }
