...
//		Assert.isNull( regulatingCondEq.getRegulatingCondEqId(), "CreateRegulatingCondEqCommand identifier should be null" );
	...
	public void validate( AssignRegulatingCondEqToRegulatingCondEqCommand command ) throws Exception {
		...
		Assert.notNull( command.getRegulatingCondEqId(), "AssignRegulatingCondEqToRegulatingCondEqCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignRegulatingCondEqToRegulatingCondEqCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveRegulatingCondEqFromRegulatingCondEqCommand command ) throws Exception {
		...
		Assert.notNull( command.getRegulatingCondEqId(), "RemoveRegulatingCondEqFromRegulatingCondEqCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveRegulatingCondEqFromRegulatingCondEqCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getRegulatingCondEqId(), "RemoveRegulatingCondEqFromRegulatingCondEqCommand removeFrom attribubte identifier should not be null" );
	}
