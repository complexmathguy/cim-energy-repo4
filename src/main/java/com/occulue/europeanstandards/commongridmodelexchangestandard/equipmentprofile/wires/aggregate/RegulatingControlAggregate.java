...
public class RegulatingControlAggregate {  
    ...
    public void handle(UpdateRegulatingControlCommand command) throws Exception {
    	...
    	UpdateRegulatingControlEvent event = new UpdateRegulatingControlEvent(command.getRegulatingControlId(), command.getMode(), command.getRegulatingControl());        
    ...
    public void handle(AssignRegulatingControlToRegulatingControlCommand command) throws Exception {
        ...
        apply(new AssignRegulatingControlToRegulatingControlEvent(command.getRegulatingControlId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignRegulatingControlFromRegulatingControlCommand command) throws Exception {
    	...
    	apply(new UnAssignRegulatingControlFromRegulatingControlEvent(command.getRegulatingControlId()));
    }
