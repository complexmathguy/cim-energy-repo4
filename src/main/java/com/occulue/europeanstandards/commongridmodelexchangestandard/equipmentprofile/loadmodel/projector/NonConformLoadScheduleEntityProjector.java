...
public class NonConformLoadScheduleEntityProjector {
     ...
     */
    public NonConformLoadSchedule addToNonConformLoadSchedules( UUID parentId, NonConformLoadSchedule addTo ) {
	    ...
	    NonConformLoadSchedule child = NonConformLoadScheduleProjector.find(addTo.getNonConformLoadScheduleId());
     ...
     * @return	NonConformLoadSchedule
     */
	public NonConformLoadSchedule removeFromNonConformLoadSchedules( UUID parentId, NonConformLoadSchedule removeFrom ) {
	    LOGGER.info("handling RemoveNonConformLoadSchedulesFromNonConformLoadScheduleEvent " );
	
	    NonConformLoadSchedule parentEntity = repository.findById(parentId).get();
	    NonConformLoadSchedule child = NonConformLoadScheduleProjector.find(removeFrom.getNonConformLoadScheduleId());
