...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToAccumulatorValues( AssignAccumulatorValuesToAccumulatorValueCommand command ) throws ProcessingException {
		...
		AccumulatorValueBusinessDelegate childDelegate 	= AccumulatorValueBusinessDelegate.getAccumulatorValueInstance();
		AccumulatorValueBusinessDelegate parentDelegate = AccumulatorValueBusinessDelegate.getAccumulatorValueInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a AccumulatorValue as AccumulatorValues to AccumulatorValue" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromAccumulatorValues( RemoveAccumulatorValuesFromAccumulatorValueCommand command ) throws ProcessingException {		
