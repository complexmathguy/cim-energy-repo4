...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToConformLoadSchedules( AssignConformLoadSchedulesToConformLoadScheduleCommand command ) throws ProcessingException {
		...
		ConformLoadScheduleBusinessDelegate childDelegate 	= ConformLoadScheduleBusinessDelegate.getConformLoadScheduleInstance();
		ConformLoadScheduleBusinessDelegate parentDelegate = ConformLoadScheduleBusinessDelegate.getConformLoadScheduleInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a ConformLoadSchedule as ConformLoadSchedules to ConformLoadSchedule" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromConformLoadSchedules( RemoveConformLoadSchedulesFromConformLoadScheduleCommand command ) throws ProcessingException {		
