...
//		Assert.isNull( regulatingControl.getRegulatingControlId(), "CreateRegulatingControlCommand identifier should be null" );
	...
	public void validate( AssignRegulatingControlToRegulatingControlCommand command ) throws Exception {
		...
		Assert.notNull( command.getRegulatingControlId(), "AssignRegulatingControlToRegulatingControlCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRegulatingControlToRegulatingControlCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignRegulatingControlFromRegulatingControlCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignRegulatingControlFromRegulatingControlCommand should not be null" );
		Assert.notNull( command.getRegulatingControlId(), "UnAssignRegulatingControlFromRegulatingControlCommand identifier should not be null" );
	}
