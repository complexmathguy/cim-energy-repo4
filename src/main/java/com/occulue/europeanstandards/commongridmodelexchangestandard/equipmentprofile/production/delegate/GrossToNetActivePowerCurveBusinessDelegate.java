...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToGrossToNetActivePowerCurves( AssignGrossToNetActivePowerCurvesToGrossToNetActivePowerCurveCommand command ) throws ProcessingException {
		...
		GrossToNetActivePowerCurveBusinessDelegate childDelegate 	= GrossToNetActivePowerCurveBusinessDelegate.getGrossToNetActivePowerCurveInstance();
		GrossToNetActivePowerCurveBusinessDelegate parentDelegate = GrossToNetActivePowerCurveBusinessDelegate.getGrossToNetActivePowerCurveInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a GrossToNetActivePowerCurve as GrossToNetActivePowerCurves to GrossToNetActivePowerCurve" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromGrossToNetActivePowerCurves( RemoveGrossToNetActivePowerCurvesFromGrossToNetActivePowerCurveCommand command ) throws ProcessingException {		
