...
//		Assert.isNull( tieFlow.getTieFlowId(), "CreateTieFlowCommand identifier should be null" );
	...
	public void validate( AssignTieFlowToTieFlowCommand command ) throws Exception {
		...
		Assert.notNull( command.getTieFlowId(), "AssignTieFlowToTieFlowCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignTieFlowToTieFlowCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveTieFlowFromTieFlowCommand command ) throws Exception {
		...
		Assert.notNull( command.getTieFlowId(), "RemoveTieFlowFromTieFlowCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveTieFlowFromTieFlowCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getTieFlowId(), "RemoveTieFlowFromTieFlowCommand removeFrom attribubte identifier should not be null" );
	}
