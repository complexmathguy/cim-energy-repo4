...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToHasSecondMutualCoupling( AssignHasSecondMutualCouplingToMutualCouplingCommand command ) throws ProcessingException {
		...
		MutualCouplingBusinessDelegate childDelegate 	= MutualCouplingBusinessDelegate.getMutualCouplingInstance();
		MutualCouplingBusinessDelegate parentDelegate = MutualCouplingBusinessDelegate.getMutualCouplingInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a MutualCoupling as HasSecondMutualCoupling to MutualCoupling" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromHasSecondMutualCoupling( RemoveHasSecondMutualCouplingFromMutualCouplingCommand command ) throws ProcessingException {		
     ...
     * @exception	ProcessingException
     */     
	public void addToHasFirstMutualCoupling( AssignHasFirstMutualCouplingToMutualCouplingCommand command ) throws ProcessingException {
		...
		try {		
			...
			final String msg = "Failed to add a MutualCoupling as HasFirstMutualCoupling to MutualCoupling" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromHasFirstMutualCoupling( RemoveHasFirstMutualCouplingFromMutualCouplingCommand command ) throws ProcessingException {		
