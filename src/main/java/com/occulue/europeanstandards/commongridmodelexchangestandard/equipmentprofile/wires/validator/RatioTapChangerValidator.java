...
//		Assert.isNull( ratioTapChanger.getRatioTapChangerId(), "CreateRatioTapChangerCommand identifier should be null" );
	...
	public void validate( AssignRatioTapChangerToRatioTapChangerCommand command ) throws Exception {
		...
		Assert.notNull( command.getRatioTapChangerId(), "AssignRatioTapChangerToRatioTapChangerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRatioTapChangerToRatioTapChangerCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRatioTapChangerFromRatioTapChangerCommand command ) throws Exception {
		...
		Assert.notNull( command.getRatioTapChangerId(), "UnAssignRatioTapChangerFromRatioTapChangerCommand identifier should not be null" );
	}
