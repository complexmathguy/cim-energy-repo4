...
//		Assert.isNull( vsConverter.getVsConverterId(), "CreateVsConverterCommand identifier should be null" );
	...
	public void validate( AssignVsConverterDCSidesToVsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getVsConverterId(), "AssignVsConverterDCSidesToVsConverterCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignVsConverterDCSidesToVsConverterCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveVsConverterDCSidesFromVsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getVsConverterId(), "RemoveVsConverterDCSidesFromVsConverterCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveVsConverterDCSidesFromVsConverterCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getVsConverterId(), "RemoveVsConverterDCSidesFromVsConverterCommand removeFrom attribubte identifier should not be null" );
	}
