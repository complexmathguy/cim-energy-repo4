...
public class ControlAreaGeneratingUnitAggregate {  
    ...
    public void handle(UpdateControlAreaGeneratingUnitCommand command) throws Exception {
    	...
    	UpdateControlAreaGeneratingUnitEvent event = new UpdateControlAreaGeneratingUnitEvent(command.getControlAreaGeneratingUnitId(), command.getControlAreaGeneratingUnit());        
    ...
    @CommandHandler
    public void handle(AssignControlAreaGeneratingUnitToControlAreaGeneratingUnitCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignControlAreaGeneratingUnitToControlAreaGeneratingUnitCommand" );
    	
    	if ( controlAreaGeneratingUnit.contains( command.getAddTo() ) )
    		throw new ProcessingException( "ControlAreaGeneratingUnit already contains an entity with id " + command.getAddTo().getControlAreaGeneratingUnitId() );

    	apply(new AssignControlAreaGeneratingUnitToControlAreaGeneratingUnitEvent(command.getControlAreaGeneratingUnitId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitCommand command) throws Exception {
    	LOGGER.info( "Handling command RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitCommand" );
    	
    	if ( !controlAreaGeneratingUnit.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "ControlAreaGeneratingUnit does not contain an entity with id " + command.getRemoveFrom().getControlAreaGeneratingUnitId() );

        apply(new RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitEvent(command.getControlAreaGeneratingUnitId(), command.getRemoveFrom()));
    }
