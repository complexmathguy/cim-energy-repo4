...
public class BasicIntervalScheduleAggregate {  
    ...
    public BasicIntervalScheduleAggregate(CreateBasicIntervalScheduleCommand command) throws Exception {
    	...
    	CreateBasicIntervalScheduleEvent event = new CreateBasicIntervalScheduleEvent(command.getBasicIntervalScheduleId(), command.getValue1Unit(), command.getValue2Unit());
