...
public class PhaseTapChangerTablePointEntityProjector {
     ...
     * @return	PhaseTapChangerTablePoint
     */
    public PhaseTapChangerTablePoint addToPhaseTapChangerTablePoint( UUID parentId, PhaseTapChangerTablePoint addTo ) {
	    LOGGER.info("handling AssignPhaseTapChangerTablePointToPhaseTapChangerTablePointEvent - " );
	    
	    PhaseTapChangerTablePoint parentEntity = repository.findById(parentId).get();
	    PhaseTapChangerTablePoint child = PhaseTapChangerTablePointProjector.find(addTo.getPhaseTapChangerTablePointId());
     ...
     * @return	PhaseTapChangerTablePoint
     */
	public PhaseTapChangerTablePoint removeFromPhaseTapChangerTablePoint( UUID parentId, PhaseTapChangerTablePoint removeFrom ) {
	    LOGGER.info("handling RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointEvent " );
	
	    PhaseTapChangerTablePoint parentEntity = repository.findById(parentId).get();
	    PhaseTapChangerTablePoint child = PhaseTapChangerTablePointProjector.find(removeFrom.getPhaseTapChangerTablePointId());
