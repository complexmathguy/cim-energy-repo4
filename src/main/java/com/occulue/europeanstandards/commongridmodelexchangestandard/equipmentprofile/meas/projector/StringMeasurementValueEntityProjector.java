...
public class StringMeasurementValueEntityProjector {
     ...
     * @return	StringMeasurementValue
     */
    public StringMeasurementValue addToStringMeasurementValues( UUID parentId, StringMeasurementValue addTo ) {
	    LOGGER.info("handling AssignStringMeasurementValuesToStringMeasurementValueEvent - " );
	    
	    StringMeasurementValue parentEntity = repository.findById(parentId).get();
	    StringMeasurementValue child = StringMeasurementValueProjector.find(addTo.getStringMeasurementValueId());
     ...
     * @return	StringMeasurementValue
     */
	public StringMeasurementValue removeFromStringMeasurementValues( UUID parentId, StringMeasurementValue removeFrom ) {
	    LOGGER.info("handling RemoveStringMeasurementValuesFromStringMeasurementValueEvent " );
	
	    StringMeasurementValue parentEntity = repository.findById(parentId).get();
	    StringMeasurementValue child = StringMeasurementValueProjector.find(removeFrom.getStringMeasurementValueId());
