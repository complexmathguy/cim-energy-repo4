...
public class MutualCouplingProjector extends MutualCouplingEntityProjector {
    ...
    public void handle( AssignHasSecondMutualCouplingToMutualCouplingEvent event) {
    	...
    	// delegate to addTo 
    	// ------------------------------------------ 
	    MutualCoupling entity = addToHasSecondMutualCoupling(event.getMutualCouplingId(), event.getAddTo() );
...
public void handle( RemoveHasSecondMutualCouplingFromMutualCouplingEvent event) {
    ...
    MutualCoupling entity = removeFromHasSecondMutualCoupling(event.getMutualCouplingId(), event.getRemoveFrom() );
    ...
    public void handle( AssignHasFirstMutualCouplingToMutualCouplingEvent event) {
    	...
    	// delegate to addTo 
    	// ------------------------------------------ 
	    MutualCoupling entity = addToHasFirstMutualCoupling(event.getMutualCouplingId(), event.getAddTo() );
...
public void handle( RemoveHasFirstMutualCouplingFromMutualCouplingEvent event) {
    ...
    MutualCoupling entity = removeFromHasFirstMutualCoupling(event.getMutualCouplingId(), event.getRemoveFrom() );
