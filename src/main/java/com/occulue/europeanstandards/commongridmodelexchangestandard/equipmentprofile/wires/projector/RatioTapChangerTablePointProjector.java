...
public class RatioTapChangerTablePointProjector extends RatioTapChangerTablePointEntityProjector {
    ...
    public void handle( AssignRatioTapChangerTablePointToRatioTapChangerTablePointEvent event) {
	    LOGGER.info("handling AssignRatioTapChangerTablePointToRatioTapChangerTablePointEvent - " + event );
	    
	    // ------------------------------------------
    	// delegate to addTo 
    	// ------------------------------------------ 
	    RatioTapChangerTablePoint entity = addToRatioTapChangerTablePoint(event.getRatioTapChangerTablePointId(), event.getAddTo() );
 ...
 */
@EventHandler( payloadType=RemoveRatioTapChangerTablePointFromRatioTapChangerTablePointEvent.class)
public void handle( RemoveRatioTapChangerTablePointFromRatioTapChangerTablePointEvent event) {
    LOGGER.info("handling RemoveRatioTapChangerTablePointFromRatioTapChangerTablePointEvent - " + event );

    RatioTapChangerTablePoint entity = removeFromRatioTapChangerTablePoint(event.getRatioTapChangerTablePointId(), event.getRemoveFrom() );
