...
//************************************************************************
    ...
    */
	...
	public void addToValues( AssignValuesToValueToAliasCommand command ) throws ProcessingException {
		...
		ValueToAliasBusinessDelegate childDelegate 	= ValueToAliasBusinessDelegate.getValueToAliasInstance();
		ValueToAliasBusinessDelegate parentDelegate = ValueToAliasBusinessDelegate.getValueToAliasInstance();		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromValues( RemoveValuesFromValueToAliasCommand command ) throws ProcessingException {		
