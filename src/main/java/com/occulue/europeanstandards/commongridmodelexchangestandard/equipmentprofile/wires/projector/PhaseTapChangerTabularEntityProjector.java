...
public class PhaseTapChangerTabularEntityProjector {
     ...
     */
    public PhaseTapChangerTabular addToPhaseTapChangerTabular( UUID parentId, PhaseTapChangerTabular addTo ) {
	    ...
	    PhaseTapChangerTabular child = PhaseTapChangerTabularProjector.find(addTo.getPhaseTapChangerTabularId());
     ...
     * @return	PhaseTapChangerTabular
     */
	public PhaseTapChangerTabular removeFromPhaseTapChangerTabular( UUID parentId, PhaseTapChangerTabular removeFrom ) {
	    LOGGER.info("handling RemovePhaseTapChangerTabularFromPhaseTapChangerTabularEvent " );
	
	    PhaseTapChangerTabular parentEntity = repository.findById(parentId).get();
	    PhaseTapChangerTabular child = PhaseTapChangerTabularProjector.find(removeFrom.getPhaseTapChangerTabularId());
