...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToEquivalentEquipments( AssignEquivalentEquipmentsToEquivalentEquipmentCommand command ) throws ProcessingException {
		...
		EquivalentEquipmentBusinessDelegate childDelegate 	= EquivalentEquipmentBusinessDelegate.getEquivalentEquipmentInstance();
		EquivalentEquipmentBusinessDelegate parentDelegate = EquivalentEquipmentBusinessDelegate.getEquivalentEquipmentInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a EquivalentEquipment as EquivalentEquipments to EquivalentEquipment" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromEquivalentEquipments( RemoveEquivalentEquipmentsFromEquivalentEquipmentCommand command ) throws ProcessingException {		
