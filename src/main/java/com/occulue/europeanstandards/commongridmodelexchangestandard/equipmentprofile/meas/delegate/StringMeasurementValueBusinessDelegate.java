...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToStringMeasurementValues( AssignStringMeasurementValuesToStringMeasurementValueCommand command ) throws ProcessingException {
		...
		StringMeasurementValueBusinessDelegate childDelegate 	= StringMeasurementValueBusinessDelegate.getStringMeasurementValueInstance();
		StringMeasurementValueBusinessDelegate parentDelegate = StringMeasurementValueBusinessDelegate.getStringMeasurementValueInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a StringMeasurementValue as StringMeasurementValues to StringMeasurementValue" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromStringMeasurementValues( RemoveStringMeasurementValuesFromStringMeasurementValueCommand command ) throws ProcessingException {		
