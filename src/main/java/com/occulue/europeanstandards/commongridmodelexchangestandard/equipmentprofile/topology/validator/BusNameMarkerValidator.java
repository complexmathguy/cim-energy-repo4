...
//		Assert.isNull( busNameMarker.getBusNameMarkerId(), "CreateBusNameMarkerCommand identifier should be null" );
	...
	public void validate( AssignBusNameMarkerToBusNameMarkerCommand command ) throws Exception {
		...
		Assert.notNull( command.getBusNameMarkerId(), "AssignBusNameMarkerToBusNameMarkerCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignBusNameMarkerToBusNameMarkerCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveBusNameMarkerFromBusNameMarkerCommand command ) throws Exception {
		...
		Assert.notNull( command.getBusNameMarkerId(), "RemoveBusNameMarkerFromBusNameMarkerCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveBusNameMarkerFromBusNameMarkerCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getBusNameMarkerId(), "RemoveBusNameMarkerFromBusNameMarkerCommand removeFrom attribubte identifier should not be null" );
	}
