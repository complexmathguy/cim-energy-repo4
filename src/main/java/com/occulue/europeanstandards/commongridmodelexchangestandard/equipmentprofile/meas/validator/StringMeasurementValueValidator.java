...
//		Assert.isNull( stringMeasurementValue.getStringMeasurementValueId(), "CreateStringMeasurementValueCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignStringMeasurementValuesToStringMeasurementValueCommand command ) throws Exception {
		Assert.notNull( command, "AssignStringMeasurementValuesToStringMeasurementValueCommand should not be null" );
		Assert.notNull( command.getStringMeasurementValueId(), "AssignStringMeasurementValuesToStringMeasurementValueCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignStringMeasurementValuesToStringMeasurementValueCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveStringMeasurementValuesFromStringMeasurementValueCommand command ) throws Exception {
		Assert.notNull( command, "RemoveStringMeasurementValuesFromStringMeasurementValueCommand should not be null" );
		Assert.notNull( command.getStringMeasurementValueId(), "RemoveStringMeasurementValuesFromStringMeasurementValueCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveStringMeasurementValuesFromStringMeasurementValueCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getStringMeasurementValueId(), "RemoveStringMeasurementValuesFromStringMeasurementValueCommand removeFrom attribubte identifier should not be null" );
	}
