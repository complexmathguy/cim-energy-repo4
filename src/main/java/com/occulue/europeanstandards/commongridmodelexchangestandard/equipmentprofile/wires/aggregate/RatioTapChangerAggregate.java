...
public class RatioTapChangerAggregate {  
    ...
    public void handle(UpdateRatioTapChangerCommand command) throws Exception {
    	...
    	UpdateRatioTapChangerEvent event = new UpdateRatioTapChangerEvent(command.getRatioTapChangerId(), command.getStepVoltageIncrement(), command.getTculControlMode(), command.getRatioTapChanger());        
    ...
    public void handle(AssignRatioTapChangerToRatioTapChangerCommand command) throws Exception {
    	...
    	if (  ratioTapChanger != null && ratioTapChanger.getRatioTapChangerId() == command.getAssignment().getRatioTapChangerId() )
    		throw new ProcessingException( "RatioTapChanger already assigned with id " + command.getAssignment().getRatioTapChangerId() );  
    		
        apply(new AssignRatioTapChangerToRatioTapChangerEvent(command.getRatioTapChangerId(), command.getAssignment()));
    }
