...
public class OperationalLimitSetAggregate {  
    ...
    public void handle(UpdateOperationalLimitSetCommand command) throws Exception {
    	...
    	UpdateOperationalLimitSetEvent event = new UpdateOperationalLimitSetEvent(command.getOperationalLimitSetId(), command.getOperationalLimitSet());        
    ...
    @CommandHandler
    public void handle(AssignOperationalLimitSetToOperationalLimitSetCommand command) throws Exception {
    	...
    	apply(new AssignOperationalLimitSetToOperationalLimitSetEvent(command.getOperationalLimitSetId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveOperationalLimitSetFromOperationalLimitSetCommand command) throws Exception {
        ...
        apply(new RemoveOperationalLimitSetFromOperationalLimitSetEvent(command.getOperationalLimitSetId(), command.getRemoveFrom()));
    }
