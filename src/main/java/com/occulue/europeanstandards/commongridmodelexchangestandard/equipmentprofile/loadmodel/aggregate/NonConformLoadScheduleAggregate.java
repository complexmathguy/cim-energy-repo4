...
public class NonConformLoadScheduleAggregate {  
    ...
    public void handle(UpdateNonConformLoadScheduleCommand command) throws Exception {
    	...
    	UpdateNonConformLoadScheduleEvent event = new UpdateNonConformLoadScheduleEvent(command.getNonConformLoadScheduleId(), command.getNonConformLoadSchedules());        
    ...
    @CommandHandler
    public void handle(AssignNonConformLoadSchedulesToNonConformLoadScheduleCommand command) throws Exception {
    	...
    	if ( nonConformLoadSchedules.contains( command.getAddTo() ) )
    		throw new ProcessingException( "NonConformLoadSchedules already contains an entity with id " + command.getAddTo().getNonConformLoadScheduleId() );

    	apply(new AssignNonConformLoadSchedulesToNonConformLoadScheduleEvent(command.getNonConformLoadScheduleId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveNonConformLoadSchedulesFromNonConformLoadScheduleCommand command) throws Exception {
    	...
    	if ( !nonConformLoadSchedules.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "NonConformLoadSchedules does not contain an entity with id " + command.getRemoveFrom().getNonConformLoadScheduleId() );

        apply(new RemoveNonConformLoadSchedulesFromNonConformLoadScheduleEvent(command.getNonConformLoadScheduleId(), command.getRemoveFrom()));
    }
