...
//		Assert.isNull( operationalLimit.getOperationalLimitId(), "CreateOperationalLimitCommand identifier should be null" );
	...
	public void validate( AssignOperationalLimitToOperationalLimitCommand command ) throws Exception {
		...
		Assert.notNull( command.getOperationalLimitId(), "AssignOperationalLimitToOperationalLimitCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignOperationalLimitToOperationalLimitCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveOperationalLimitFromOperationalLimitCommand command ) throws Exception {
		...
		Assert.notNull( command.getOperationalLimitId(), "RemoveOperationalLimitFromOperationalLimitCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveOperationalLimitFromOperationalLimitCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getOperationalLimitId(), "RemoveOperationalLimitFromOperationalLimitCommand removeFrom attribubte identifier should not be null" );
	}
	 ...
	 */	
	public void validate( AssignOperationalLimitValueToOperationalLimitCommand command ) throws Exception {
		Assert.notNull( command, "AssignOperationalLimitValueToOperationalLimitCommand should not be null" );
		Assert.notNull( command.getOperationalLimitId(), "AssignOperationalLimitValueToOperationalLimitCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignOperationalLimitValueToOperationalLimitCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveOperationalLimitValueFromOperationalLimitCommand command ) throws Exception {
		Assert.notNull( command, "RemoveOperationalLimitValueFromOperationalLimitCommand should not be null" );
		Assert.notNull( command.getOperationalLimitId(), "RemoveOperationalLimitValueFromOperationalLimitCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveOperationalLimitValueFromOperationalLimitCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getOperationalLimitId(), "RemoveOperationalLimitValueFromOperationalLimitCommand removeFrom attribubte identifier should not be null" );
	}
