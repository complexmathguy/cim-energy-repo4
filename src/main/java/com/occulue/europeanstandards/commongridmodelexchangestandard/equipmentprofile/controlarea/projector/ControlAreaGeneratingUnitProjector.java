...
public class ControlAreaGeneratingUnitProjector extends ControlAreaGeneratingUnitEntityProjector {
    ...
    public void handle( AssignControlAreaGeneratingUnitToControlAreaGeneratingUnitEvent event) {
	    LOGGER.info("handling AssignControlAreaGeneratingUnitToControlAreaGeneratingUnitEvent - " + event );
	    
	    // ------------------------------------------
    	// delegate to addTo 
    	// ------------------------------------------ 
	    ControlAreaGeneratingUnit entity = addToControlAreaGeneratingUnit(event.getControlAreaGeneratingUnitId(), event.getAddTo() );
 ...
 */
@EventHandler( payloadType=RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitEvent.class)
public void handle( RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitEvent event) {
    LOGGER.info("handling RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitEvent - " + event );

    ControlAreaGeneratingUnit entity = removeFromControlAreaGeneratingUnit(event.getControlAreaGeneratingUnitId(), event.getRemoveFrom() );
