...
//		Assert.isNull( accumulatorLimitSet.getAccumulatorLimitSetId(), "CreateAccumulatorLimitSetCommand identifier should be null" );
	...
	public void validate( AssignLimitSetsToAccumulatorLimitSetCommand command ) throws Exception {
		...
		Assert.notNull( command.getAccumulatorLimitSetId(), "AssignLimitSetsToAccumulatorLimitSetCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignLimitSetsToAccumulatorLimitSetCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveLimitSetsFromAccumulatorLimitSetCommand command ) throws Exception {
		...
		Assert.notNull( command.getAccumulatorLimitSetId(), "RemoveLimitSetsFromAccumulatorLimitSetCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveLimitSetsFromAccumulatorLimitSetCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getAccumulatorLimitSetId(), "RemoveLimitSetsFromAccumulatorLimitSetCommand removeFrom attribubte identifier should not be null" );
	}
