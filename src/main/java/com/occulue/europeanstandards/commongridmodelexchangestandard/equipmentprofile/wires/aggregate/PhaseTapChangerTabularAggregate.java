...
public class PhaseTapChangerTabularAggregate {  
    ...
    public void handle(UpdatePhaseTapChangerTabularCommand command) throws Exception {
    	...
    	UpdatePhaseTapChangerTabularEvent event = new UpdatePhaseTapChangerTabularEvent(command.getPhaseTapChangerTabularId(), command.getPhaseTapChangerTabular());        
    ...
    @CommandHandler
    public void handle(AssignPhaseTapChangerTabularToPhaseTapChangerTabularCommand command) throws Exception {
    	...
    	if ( phaseTapChangerTabular.contains( command.getAddTo() ) )
    		throw new ProcessingException( "PhaseTapChangerTabular already contains an entity with id " + command.getAddTo().getPhaseTapChangerTabularId() );

    	apply(new AssignPhaseTapChangerTabularToPhaseTapChangerTabularEvent(command.getPhaseTapChangerTabularId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemovePhaseTapChangerTabularFromPhaseTapChangerTabularCommand command) throws Exception {
    	...
    	if ( !phaseTapChangerTabular.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "PhaseTapChangerTabular does not contain an entity with id " + command.getRemoveFrom().getPhaseTapChangerTabularId() );

        apply(new RemovePhaseTapChangerTabularFromPhaseTapChangerTabularEvent(command.getPhaseTapChangerTabularId(), command.getRemoveFrom()));
    }
