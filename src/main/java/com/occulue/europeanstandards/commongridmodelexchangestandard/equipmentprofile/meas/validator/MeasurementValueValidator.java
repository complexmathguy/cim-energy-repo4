...
//		Assert.isNull( measurementValue.getMeasurementValueId(), "CreateMeasurementValueCommand identifier should be null" );
	...
	public void validate( AssignMeasurementValuesToMeasurementValueCommand command ) throws Exception {
		...
		Assert.notNull( command.getMeasurementValueId(), "AssignMeasurementValuesToMeasurementValueCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignMeasurementValuesToMeasurementValueCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveMeasurementValuesFromMeasurementValueCommand command ) throws Exception {
		Assert.notNull( command, "RemoveMeasurementValuesFromMeasurementValueCommand should not be null" );
		Assert.notNull( command.getMeasurementValueId(), "RemoveMeasurementValuesFromMeasurementValueCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveMeasurementValuesFromMeasurementValueCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getMeasurementValueId(), "RemoveMeasurementValuesFromMeasurementValueCommand removeFrom attribubte identifier should not be null" );
	}
