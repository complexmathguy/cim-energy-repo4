...
public class SeasonDayTypeScheduleAggregate {  
    ...
    public void handle(UpdateSeasonDayTypeScheduleCommand command) throws Exception {
    	...
    	UpdateSeasonDayTypeScheduleEvent event = new UpdateSeasonDayTypeScheduleEvent(command.getSeasonDayTypeScheduleId(), command.getSeasonDayTypeSchedules());        
    ...
    @CommandHandler
    public void handle(AssignSeasonDayTypeSchedulesToSeasonDayTypeScheduleCommand command) throws Exception {
    	...
    	if ( seasonDayTypeSchedules.contains( command.getAddTo() ) )
    		throw new ProcessingException( "SeasonDayTypeSchedules already contains an entity with id " + command.getAddTo().getSeasonDayTypeScheduleId() );

    	apply(new AssignSeasonDayTypeSchedulesToSeasonDayTypeScheduleEvent(command.getSeasonDayTypeScheduleId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveSeasonDayTypeSchedulesFromSeasonDayTypeScheduleCommand command) throws Exception {
    	...
    	if ( !seasonDayTypeSchedules.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "SeasonDayTypeSchedules does not contain an entity with id " + command.getRemoveFrom().getSeasonDayTypeScheduleId() );

        apply(new RemoveSeasonDayTypeSchedulesFromSeasonDayTypeScheduleEvent(command.getSeasonDayTypeScheduleId(), command.getRemoveFrom()));
    }
