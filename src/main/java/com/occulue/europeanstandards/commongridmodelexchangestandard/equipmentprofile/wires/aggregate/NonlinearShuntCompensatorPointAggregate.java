...
public class NonlinearShuntCompensatorPointAggregate {  
    ...
    public void handle(UpdateNonlinearShuntCompensatorPointCommand command) throws Exception {
    	...
    	UpdateNonlinearShuntCompensatorPointEvent event = new UpdateNonlinearShuntCompensatorPointEvent(command.getNonlinearShuntCompensatorPointId(), command.getB(), command.getB0(), command.getG(), command.getG0(), command.getSectionNumber(), command.getNonlinearShuntCompensatorPoints());        
    ...
    @CommandHandler
    public void handle(AssignNonlinearShuntCompensatorPointsToNonlinearShuntCompensatorPointCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignNonlinearShuntCompensatorPointsToNonlinearShuntCompensatorPointCommand" );
    	
    	if ( nonlinearShuntCompensatorPoints.contains( command.getAddTo() ) )
    		throw new ProcessingException( "NonlinearShuntCompensatorPoints already contains an entity with id " + command.getAddTo().getNonlinearShuntCompensatorPointId() );

    	apply(new AssignNonlinearShuntCompensatorPointsToNonlinearShuntCompensatorPointEvent(command.getNonlinearShuntCompensatorPointId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveNonlinearShuntCompensatorPointsFromNonlinearShuntCompensatorPointCommand command) throws Exception {
    	LOGGER.info( "Handling command RemoveNonlinearShuntCompensatorPointsFromNonlinearShuntCompensatorPointCommand" );
    	
    	if ( !nonlinearShuntCompensatorPoints.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "NonlinearShuntCompensatorPoints does not contain an entity with id " + command.getRemoveFrom().getNonlinearShuntCompensatorPointId() );

        apply(new RemoveNonlinearShuntCompensatorPointsFromNonlinearShuntCompensatorPointEvent(command.getNonlinearShuntCompensatorPointId(), command.getRemoveFrom()));
    }
    ...
    void on(AssignNonlinearShuntCompensatorPointsToNonlinearShuntCompensatorPointEvent event ) {
    	LOGGER.info( "Event sourcing AssignNonlinearShuntCompensatorPointsToNonlinearShuntCompensatorPointEvent" );
	...
	void on(RemoveNonlinearShuntCompensatorPointsFromNonlinearShuntCompensatorPointEvent event ) {	
		LOGGER.info( "Event sourcing RemoveNonlinearShuntCompensatorPointsFromNonlinearShuntCompensatorPointEvent" );
