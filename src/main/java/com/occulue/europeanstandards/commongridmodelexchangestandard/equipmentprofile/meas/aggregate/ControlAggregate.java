...
public class ControlAggregate {  
    ...
    public ControlAggregate(CreateControlCommand command) throws Exception {
    	...
    	CreateControlEvent event = new CreateControlEvent(command.getControlId(), command.getUnitMultiplier(), command.getUnitSymbol());
    ...
    public void handle(UpdateControlCommand command) throws Exception {
    	...
    	UpdateControlEvent event = new UpdateControlEvent(command.getControlId(), command.getControlType(), command.getOperationInProgress(), command.getTimeStamp(), command.getUnitMultiplier(), command.getUnitSymbol(), command.getControls());        
