...
//		Assert.isNull( synchronousMachine.getSynchronousMachineId(), "CreateSynchronousMachineCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignInitiallyUsedBySynchronousMachinesToSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "AssignInitiallyUsedBySynchronousMachinesToSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "AssignInitiallyUsedBySynchronousMachinesToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignInitiallyUsedBySynchronousMachinesToSynchronousMachineCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getSynchronousMachineId(), "RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineCommand removeFrom attribubte identifier should not be null" );
	}
