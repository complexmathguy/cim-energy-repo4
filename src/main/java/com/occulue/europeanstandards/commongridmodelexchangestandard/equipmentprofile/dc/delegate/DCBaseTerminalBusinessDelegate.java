...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToDCTerminals( AssignDCTerminalsToDCBaseTerminalCommand command ) throws ProcessingException {
		...
		DCBaseTerminalBusinessDelegate childDelegate 	= DCBaseTerminalBusinessDelegate.getDCBaseTerminalInstance();
		DCBaseTerminalBusinessDelegate parentDelegate = DCBaseTerminalBusinessDelegate.getDCBaseTerminalInstance();		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromDCTerminals( RemoveDCTerminalsFromDCBaseTerminalCommand command ) throws ProcessingException {		
