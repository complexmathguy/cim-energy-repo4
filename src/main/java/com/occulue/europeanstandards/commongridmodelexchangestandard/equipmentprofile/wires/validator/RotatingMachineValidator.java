...
//		Assert.isNull( rotatingMachine.getRotatingMachineId(), "CreateRotatingMachineCommand identifier should be null" );
	...
	public void validate( AssignRotatingMachineToRotatingMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getRotatingMachineId(), "AssignRotatingMachineToRotatingMachineCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignRotatingMachineToRotatingMachineCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveRotatingMachineFromRotatingMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getRotatingMachineId(), "RemoveRotatingMachineFromRotatingMachineCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveRotatingMachineFromRotatingMachineCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getRotatingMachineId(), "RemoveRotatingMachineFromRotatingMachineCommand removeFrom attribubte identifier should not be null" );
	}
