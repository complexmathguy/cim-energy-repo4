...
//		Assert.isNull( switchSchedule.getSwitchScheduleId(), "CreateSwitchScheduleCommand identifier should be null" );
	...
	public void validate( AssignSwitchSchedulesToSwitchScheduleCommand command ) throws Exception {
		...
		Assert.notNull( command.getSwitchScheduleId(), "AssignSwitchSchedulesToSwitchScheduleCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignSwitchSchedulesToSwitchScheduleCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveSwitchSchedulesFromSwitchScheduleCommand command ) throws Exception {
		...
		Assert.notNull( command.getSwitchScheduleId(), "RemoveSwitchSchedulesFromSwitchScheduleCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveSwitchSchedulesFromSwitchScheduleCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getSwitchScheduleId(), "RemoveSwitchSchedulesFromSwitchScheduleCommand removeFrom attribubte identifier should not be null" );
	}
