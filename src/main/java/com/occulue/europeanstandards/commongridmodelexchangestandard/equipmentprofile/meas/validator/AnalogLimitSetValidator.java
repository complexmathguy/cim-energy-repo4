...
//		Assert.isNull( analogLimitSet.getAnalogLimitSetId(), "CreateAnalogLimitSetCommand identifier should be null" );
	...
	public void validate( AssignLimitSetsToAnalogLimitSetCommand command ) throws Exception {
		...
		Assert.notNull( command.getAnalogLimitSetId(), "AssignLimitSetsToAnalogLimitSetCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignLimitSetsToAnalogLimitSetCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveLimitSetsFromAnalogLimitSetCommand command ) throws Exception {
		...
		Assert.notNull( command.getAnalogLimitSetId(), "RemoveLimitSetsFromAnalogLimitSetCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveLimitSetsFromAnalogLimitSetCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getAnalogLimitSetId(), "RemoveLimitSetsFromAnalogLimitSetCommand removeFrom attribubte identifier should not be null" );
	}
