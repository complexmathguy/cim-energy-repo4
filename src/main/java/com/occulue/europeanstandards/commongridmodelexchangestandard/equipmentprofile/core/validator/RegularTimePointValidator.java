...
//		Assert.isNull( regularTimePoint.getRegularTimePointId(), "CreateRegularTimePointCommand identifier should be null" );
	...
	public void validate( AssignTimePointsToRegularTimePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getRegularTimePointId(), "AssignTimePointsToRegularTimePointCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignTimePointsToRegularTimePointCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveTimePointsFromRegularTimePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getRegularTimePointId(), "RemoveTimePointsFromRegularTimePointCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveTimePointsFromRegularTimePointCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getRegularTimePointId(), "RemoveTimePointsFromRegularTimePointCommand removeFrom attribubte identifier should not be null" );
	}
