...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToSeasonDayTypeSchedules( AssignSeasonDayTypeSchedulesToSeasonDayTypeScheduleCommand command ) throws ProcessingException {
		...
		SeasonDayTypeScheduleBusinessDelegate childDelegate 	= SeasonDayTypeScheduleBusinessDelegate.getSeasonDayTypeScheduleInstance();
		SeasonDayTypeScheduleBusinessDelegate parentDelegate = SeasonDayTypeScheduleBusinessDelegate.getSeasonDayTypeScheduleInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a SeasonDayTypeSchedule as SeasonDayTypeSchedules to SeasonDayTypeSchedule" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromSeasonDayTypeSchedules( RemoveSeasonDayTypeSchedulesFromSeasonDayTypeScheduleCommand command ) throws ProcessingException {		
