...
//		Assert.isNull( tapChanger.getTapChangerId(), "CreateTapChangerCommand identifier should be null" );
	...
	public void validate( AssignTapChangerToTapChangerCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerId(), "AssignTapChangerToTapChangerCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignTapChangerToTapChangerCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveTapChangerFromTapChangerCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerId(), "RemoveTapChangerFromTapChangerCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveTapChangerFromTapChangerCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getTapChangerId(), "RemoveTapChangerFromTapChangerCommand removeFrom attribubte identifier should not be null" );
	}
