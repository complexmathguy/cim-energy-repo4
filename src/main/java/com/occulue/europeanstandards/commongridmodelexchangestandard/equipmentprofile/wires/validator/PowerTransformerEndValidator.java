...
//		Assert.isNull( powerTransformerEnd.getPowerTransformerEndId(), "CreatePowerTransformerEndCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignPowerTransformerEndToPowerTransformerEndCommand command ) throws Exception {
		Assert.notNull( command, "AssignPowerTransformerEndToPowerTransformerEndCommand should not be null" );
		Assert.notNull( command.getPowerTransformerEndId(), "AssignPowerTransformerEndToPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignPowerTransformerEndToPowerTransformerEndCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemovePowerTransformerEndFromPowerTransformerEndCommand command ) throws Exception {
		Assert.notNull( command, "RemovePowerTransformerEndFromPowerTransformerEndCommand should not be null" );
		Assert.notNull( command.getPowerTransformerEndId(), "RemovePowerTransformerEndFromPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemovePowerTransformerEndFromPowerTransformerEndCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getPowerTransformerEndId(), "RemovePowerTransformerEndFromPowerTransformerEndCommand removeFrom attribubte identifier should not be null" );
	}
