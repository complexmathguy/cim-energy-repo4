...
public class ConformLoadScheduleProjector extends ConformLoadScheduleEntityProjector {
    ...
    public void handle( AssignConformLoadSchedulesToConformLoadScheduleEvent event) {
    	...
    	// delegate to addTo 
    	// ------------------------------------------ 
	    ConformLoadSchedule entity = addToConformLoadSchedules(event.getConformLoadScheduleId(), event.getAddTo() );
...
public void handle( RemoveConformLoadSchedulesFromConformLoadScheduleEvent event) {
    ...
    ConformLoadSchedule entity = removeFromConformLoadSchedules(event.getConformLoadScheduleId(), event.getRemoveFrom() );
