...
public class ControlAreaGeneratingUnitEntityProjector {
     ...
     */
    public ControlAreaGeneratingUnit addToControlAreaGeneratingUnit( UUID parentId, ControlAreaGeneratingUnit addTo ) {
	    ...
	    ControlAreaGeneratingUnit child = ControlAreaGeneratingUnitProjector.find(addTo.getControlAreaGeneratingUnitId());
     ...
     * @return	ControlAreaGeneratingUnit
     */
	public ControlAreaGeneratingUnit removeFromControlAreaGeneratingUnit( UUID parentId, ControlAreaGeneratingUnit removeFrom ) {
	    LOGGER.info("handling RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitEvent " );
	
	    ControlAreaGeneratingUnit parentEntity = repository.findById(parentId).get();
	    ControlAreaGeneratingUnit child = ControlAreaGeneratingUnitProjector.find(removeFrom.getControlAreaGeneratingUnitId());
