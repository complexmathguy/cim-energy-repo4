...
public class SynchronousMachineEntityProjector {
     ...
     * @return	SynchronousMachine
     */
    public SynchronousMachine addToInitiallyUsedBySynchronousMachines( UUID parentId, SynchronousMachine addTo ) {
     ...
     * @return	SynchronousMachine
     */
	public SynchronousMachine removeFromInitiallyUsedBySynchronousMachines( UUID parentId, SynchronousMachine removeFrom ) {
	    LOGGER.info("handling RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineEvent " );
	
	    SynchronousMachine parentEntity = repository.findById(parentId).get();
	    SynchronousMachine child = SynchronousMachineProjector.find(removeFrom.getSynchronousMachineId());
