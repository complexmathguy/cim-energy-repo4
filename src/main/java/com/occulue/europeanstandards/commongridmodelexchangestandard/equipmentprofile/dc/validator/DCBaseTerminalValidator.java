...
//		Assert.isNull( dCBaseTerminal.getDCBaseTerminalId(), "CreateDCBaseTerminalCommand identifier should be null" );
	...
	public void validate( AssignDCTerminalsToDCBaseTerminalCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCBaseTerminalId(), "AssignDCTerminalsToDCBaseTerminalCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDCTerminalsToDCBaseTerminalCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveDCTerminalsFromDCBaseTerminalCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCBaseTerminalId(), "RemoveDCTerminalsFromDCBaseTerminalCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDCTerminalsFromDCBaseTerminalCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDCBaseTerminalId(), "RemoveDCTerminalsFromDCBaseTerminalCommand removeFrom attribubte identifier should not be null" );
	}
