...
//		Assert.isNull( regulationSchedule.getRegulationScheduleId(), "CreateRegulationScheduleCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignRegulationScheduleToRegulationScheduleCommand command ) throws Exception {
		Assert.notNull( command, "AssignRegulationScheduleToRegulationScheduleCommand should not be null" );
		Assert.notNull( command.getRegulationScheduleId(), "AssignRegulationScheduleToRegulationScheduleCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignRegulationScheduleToRegulationScheduleCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveRegulationScheduleFromRegulationScheduleCommand command ) throws Exception {
		Assert.notNull( command, "RemoveRegulationScheduleFromRegulationScheduleCommand should not be null" );
		Assert.notNull( command.getRegulationScheduleId(), "RemoveRegulationScheduleFromRegulationScheduleCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveRegulationScheduleFromRegulationScheduleCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getRegulationScheduleId(), "RemoveRegulationScheduleFromRegulationScheduleCommand removeFrom attribubte identifier should not be null" );
	}
