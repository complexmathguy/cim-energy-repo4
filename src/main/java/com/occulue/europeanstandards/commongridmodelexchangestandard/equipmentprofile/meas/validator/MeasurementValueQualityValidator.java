...
//		Assert.isNull( measurementValueQuality.getMeasurementValueQualityId(), "CreateMeasurementValueQualityCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignMeasurementValueQualityToMeasurementValueQualityCommand command ) throws Exception {
		Assert.notNull( command, "AssignMeasurementValueQualityToMeasurementValueQualityCommand should not be null" );
		Assert.notNull( command.getMeasurementValueQualityId(), "AssignMeasurementValueQualityToMeasurementValueQualityCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMeasurementValueQualityToMeasurementValueQualityCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignMeasurementValueQualityFromMeasurementValueQualityCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignMeasurementValueQualityFromMeasurementValueQualityCommand should not be null" );
		Assert.notNull( command.getMeasurementValueQualityId(), "UnAssignMeasurementValueQualityFromMeasurementValueQualityCommand identifier should not be null" );
	}
