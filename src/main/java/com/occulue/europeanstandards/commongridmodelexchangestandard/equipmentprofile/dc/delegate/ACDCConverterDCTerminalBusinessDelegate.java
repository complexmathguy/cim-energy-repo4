...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToDCTerminals( AssignDCTerminalsToACDCConverterDCTerminalCommand command ) throws ProcessingException {
		...
		ACDCConverterDCTerminalBusinessDelegate childDelegate 	= ACDCConverterDCTerminalBusinessDelegate.getACDCConverterDCTerminalInstance();
		ACDCConverterDCTerminalBusinessDelegate parentDelegate = ACDCConverterDCTerminalBusinessDelegate.getACDCConverterDCTerminalInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a ACDCConverterDCTerminal as DCTerminals to ACDCConverterDCTerminal" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromDCTerminals( RemoveDCTerminalsFromACDCConverterDCTerminalCommand command ) throws ProcessingException {		
