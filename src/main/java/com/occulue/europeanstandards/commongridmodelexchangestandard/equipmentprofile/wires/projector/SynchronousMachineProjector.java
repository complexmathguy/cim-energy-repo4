...
public class SynchronousMachineProjector extends SynchronousMachineEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignInitiallyUsedBySynchronousMachinesToSynchronousMachineEvent.class)
    public void handle( AssignInitiallyUsedBySynchronousMachinesToSynchronousMachineEvent event) {
	    LOGGER.info("handling AssignInitiallyUsedBySynchronousMachinesToSynchronousMachineEvent - " + event );
	    
	    // ------------------------------------------
    	// delegate to addTo 
    	// ------------------------------------------ 
	    SynchronousMachine entity = addToInitiallyUsedBySynchronousMachines(event.getSynchronousMachineId(), event.getAddTo() );
 ...
 */
@EventHandler( payloadType=RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineEvent.class)
public void handle( RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineEvent event) {
    LOGGER.info("handling RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineEvent - " + event );

    SynchronousMachine entity = removeFromInitiallyUsedBySynchronousMachines(event.getSynchronousMachineId(), event.getRemoveFrom() );
