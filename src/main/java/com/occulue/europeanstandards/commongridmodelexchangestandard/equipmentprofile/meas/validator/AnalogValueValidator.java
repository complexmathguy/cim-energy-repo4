...
//		Assert.isNull( analogValue.getAnalogValueId(), "CreateAnalogValueCommand identifier should be null" );
	...
	public void validate( AssignAnalogValuesToAnalogValueCommand command ) throws Exception {
		...
		Assert.notNull( command.getAnalogValueId(), "AssignAnalogValuesToAnalogValueCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignAnalogValuesToAnalogValueCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveAnalogValuesFromAnalogValueCommand command ) throws Exception {
		...
		Assert.notNull( command.getAnalogValueId(), "RemoveAnalogValuesFromAnalogValueCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveAnalogValuesFromAnalogValueCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getAnalogValueId(), "RemoveAnalogValuesFromAnalogValueCommand removeFrom attribubte identifier should not be null" );
	}
