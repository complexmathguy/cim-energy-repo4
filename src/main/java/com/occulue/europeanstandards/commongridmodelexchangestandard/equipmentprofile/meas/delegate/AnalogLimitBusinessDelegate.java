...
//************************************************************************
    ...
    */
	...
	public void addToLimits( AssignLimitsToAnalogLimitCommand command ) throws ProcessingException {
		...
		AnalogLimitBusinessDelegate childDelegate 	= AnalogLimitBusinessDelegate.getAnalogLimitInstance();
		AnalogLimitBusinessDelegate parentDelegate = AnalogLimitBusinessDelegate.getAnalogLimitInstance();		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromLimits( RemoveLimitsFromAnalogLimitCommand command ) throws ProcessingException {		
