...
public class TieFlowAggregate {  
    ...
    public void handle(UpdateTieFlowCommand command) throws Exception {
    	...
    	UpdateTieFlowEvent event = new UpdateTieFlowEvent(command.getTieFlowId(), command.getPositiveFlowIn(), command.getTieFlow());        
    ...
    public void handle(AssignTieFlowToTieFlowCommand command) throws Exception {
    	...
    	if ( tieFlow.contains( command.getAddTo() ) )
    		throw new ProcessingException( "TieFlow already contains an entity with id " + command.getAddTo().getTieFlowId() );
    ...
    public void handle(RemoveTieFlowFromTieFlowCommand command) throws Exception {
    	...
    	if ( !tieFlow.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "TieFlow does not contain an entity with id " + command.getRemoveFrom().getTieFlowId() );
