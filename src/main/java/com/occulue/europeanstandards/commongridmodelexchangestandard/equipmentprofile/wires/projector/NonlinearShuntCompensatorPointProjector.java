...
public class NonlinearShuntCompensatorPointProjector extends NonlinearShuntCompensatorPointEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignNonlinearShuntCompensatorPointsToNonlinearShuntCompensatorPointEvent.class)
    public void handle( AssignNonlinearShuntCompensatorPointsToNonlinearShuntCompensatorPointEvent event) {
	    LOGGER.info("handling AssignNonlinearShuntCompensatorPointsToNonlinearShuntCompensatorPointEvent - " + event );
	    
	    // ------------------------------------------
    	// delegate to addTo 
    	// ------------------------------------------ 
	    NonlinearShuntCompensatorPoint entity = addToNonlinearShuntCompensatorPoints(event.getNonlinearShuntCompensatorPointId(), event.getAddTo() );
 ...
 */
@EventHandler( payloadType=RemoveNonlinearShuntCompensatorPointsFromNonlinearShuntCompensatorPointEvent.class)
public void handle( RemoveNonlinearShuntCompensatorPointsFromNonlinearShuntCompensatorPointEvent event) {
    LOGGER.info("handling RemoveNonlinearShuntCompensatorPointsFromNonlinearShuntCompensatorPointEvent - " + event );

    NonlinearShuntCompensatorPoint entity = removeFromNonlinearShuntCompensatorPoints(event.getNonlinearShuntCompensatorPointId(), event.getRemoveFrom() );
