...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToInitiallyUsedBySynchronousMachines( AssignInitiallyUsedBySynchronousMachinesToSynchronousMachineCommand command ) throws ProcessingException {
		...
		SynchronousMachineBusinessDelegate childDelegate 	= SynchronousMachineBusinessDelegate.getSynchronousMachineInstance();
		SynchronousMachineBusinessDelegate parentDelegate = SynchronousMachineBusinessDelegate.getSynchronousMachineInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a SynchronousMachine as InitiallyUsedBySynchronousMachines to SynchronousMachine" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromInitiallyUsedBySynchronousMachines( RemoveInitiallyUsedBySynchronousMachinesFromSynchronousMachineCommand command ) throws ProcessingException {		
