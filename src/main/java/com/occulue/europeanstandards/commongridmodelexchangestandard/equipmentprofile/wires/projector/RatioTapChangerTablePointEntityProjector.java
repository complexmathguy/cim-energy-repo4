...
public class RatioTapChangerTablePointEntityProjector {
     ...
     */
    public RatioTapChangerTablePoint addToRatioTapChangerTablePoint( UUID parentId, RatioTapChangerTablePoint addTo ) {
	    ...
	    RatioTapChangerTablePoint child = RatioTapChangerTablePointProjector.find(addTo.getRatioTapChangerTablePointId());
     ...
     * @return	RatioTapChangerTablePoint
     */
	public RatioTapChangerTablePoint removeFromRatioTapChangerTablePoint( UUID parentId, RatioTapChangerTablePoint removeFrom ) {
	    LOGGER.info("handling RemoveRatioTapChangerTablePointFromRatioTapChangerTablePointEvent " );
	
	    RatioTapChangerTablePoint parentEntity = repository.findById(parentId).get();
	    RatioTapChangerTablePoint child = RatioTapChangerTablePointProjector.find(removeFrom.getRatioTapChangerTablePointId());
