...
//		Assert.isNull( conformLoadSchedule.getConformLoadScheduleId(), "CreateConformLoadScheduleCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignConformLoadSchedulesToConformLoadScheduleCommand command ) throws Exception {
		Assert.notNull( command, "AssignConformLoadSchedulesToConformLoadScheduleCommand should not be null" );
		Assert.notNull( command.getConformLoadScheduleId(), "AssignConformLoadSchedulesToConformLoadScheduleCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignConformLoadSchedulesToConformLoadScheduleCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveConformLoadSchedulesFromConformLoadScheduleCommand command ) throws Exception {
		Assert.notNull( command, "RemoveConformLoadSchedulesFromConformLoadScheduleCommand should not be null" );
		Assert.notNull( command.getConformLoadScheduleId(), "RemoveConformLoadSchedulesFromConformLoadScheduleCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveConformLoadSchedulesFromConformLoadScheduleCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getConformLoadScheduleId(), "RemoveConformLoadSchedulesFromConformLoadScheduleCommand removeFrom attribubte identifier should not be null" );
	}
