...
//		Assert.isNull( phaseTapChangerTabular.getPhaseTapChangerTabularId(), "CreatePhaseTapChangerTabularCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignPhaseTapChangerTabularToPhaseTapChangerTabularCommand command ) throws Exception {
		Assert.notNull( command, "AssignPhaseTapChangerTabularToPhaseTapChangerTabularCommand should not be null" );
		Assert.notNull( command.getPhaseTapChangerTabularId(), "AssignPhaseTapChangerTabularToPhaseTapChangerTabularCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignPhaseTapChangerTabularToPhaseTapChangerTabularCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemovePhaseTapChangerTabularFromPhaseTapChangerTabularCommand command ) throws Exception {
		Assert.notNull( command, "RemovePhaseTapChangerTabularFromPhaseTapChangerTabularCommand should not be null" );
		Assert.notNull( command.getPhaseTapChangerTabularId(), "RemovePhaseTapChangerTabularFromPhaseTapChangerTabularCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemovePhaseTapChangerTabularFromPhaseTapChangerTabularCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getPhaseTapChangerTabularId(), "RemovePhaseTapChangerTabularFromPhaseTapChangerTabularCommand removeFrom attribubte identifier should not be null" );
	}
