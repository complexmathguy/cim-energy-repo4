...
//		Assert.isNull( mutualCoupling.getMutualCouplingId(), "CreateMutualCouplingCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignHasSecondMutualCouplingToMutualCouplingCommand command ) throws Exception {
		Assert.notNull( command, "AssignHasSecondMutualCouplingToMutualCouplingCommand should not be null" );
		Assert.notNull( command.getMutualCouplingId(), "AssignHasSecondMutualCouplingToMutualCouplingCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignHasSecondMutualCouplingToMutualCouplingCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveHasSecondMutualCouplingFromMutualCouplingCommand command ) throws Exception {
		Assert.notNull( command, "RemoveHasSecondMutualCouplingFromMutualCouplingCommand should not be null" );
		Assert.notNull( command.getMutualCouplingId(), "RemoveHasSecondMutualCouplingFromMutualCouplingCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveHasSecondMutualCouplingFromMutualCouplingCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getMutualCouplingId(), "RemoveHasSecondMutualCouplingFromMutualCouplingCommand removeFrom attribubte identifier should not be null" );
	}
	 ...
	 */	
	public void validate( AssignHasFirstMutualCouplingToMutualCouplingCommand command ) throws Exception {
		Assert.notNull( command, "AssignHasFirstMutualCouplingToMutualCouplingCommand should not be null" );
		Assert.notNull( command.getMutualCouplingId(), "AssignHasFirstMutualCouplingToMutualCouplingCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignHasFirstMutualCouplingToMutualCouplingCommand addTo attribute should not be null" );
	}
	 ...
	 */	
	public void validate( RemoveHasFirstMutualCouplingFromMutualCouplingCommand command ) throws Exception {
		Assert.notNull( command, "RemoveHasFirstMutualCouplingFromMutualCouplingCommand should not be null" );
		Assert.notNull( command.getMutualCouplingId(), "RemoveHasFirstMutualCouplingFromMutualCouplingCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveHasFirstMutualCouplingFromMutualCouplingCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getMutualCouplingId(), "RemoveHasFirstMutualCouplingFromMutualCouplingCommand removeFrom attribubte identifier should not be null" );
	}
