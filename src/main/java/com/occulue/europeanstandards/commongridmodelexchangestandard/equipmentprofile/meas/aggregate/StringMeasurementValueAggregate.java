...
public class StringMeasurementValueAggregate {  
    ...
    public void handle(UpdateStringMeasurementValueCommand command) throws Exception {
    	...
    	UpdateStringMeasurementValueEvent event = new UpdateStringMeasurementValueEvent(command.getStringMeasurementValueId(), command.getValue(), command.getStringMeasurementValues());        
    ...
    @CommandHandler
    public void handle(AssignStringMeasurementValuesToStringMeasurementValueCommand command) throws Exception {
    	...
    	if ( stringMeasurementValues.contains( command.getAddTo() ) )
    		throw new ProcessingException( "StringMeasurementValues already contains an entity with id " + command.getAddTo().getStringMeasurementValueId() );

    	apply(new AssignStringMeasurementValuesToStringMeasurementValueEvent(command.getStringMeasurementValueId(), command.getAddTo()));
    }

    @CommandHandler
    public void handle(RemoveStringMeasurementValuesFromStringMeasurementValueCommand command) throws Exception {
    	...
    	if ( !stringMeasurementValues.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "StringMeasurementValues does not contain an entity with id " + command.getRemoveFrom().getStringMeasurementValueId() );

        apply(new RemoveStringMeasurementValuesFromStringMeasurementValueEvent(command.getStringMeasurementValueId(), command.getRemoveFrom()));
    }
