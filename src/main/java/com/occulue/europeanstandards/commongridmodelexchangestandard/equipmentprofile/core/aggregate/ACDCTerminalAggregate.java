...
public class ACDCTerminalAggregate {  
    ...
    public void handle(UpdateACDCTerminalCommand command) throws Exception {
    	...
    	UpdateACDCTerminalEvent event = new UpdateACDCTerminalEvent(command.getACDCTerminalId(), command.getSequenceNumber(), command.getTerminal());        
    ...
    public void handle(AssignTerminalToACDCTerminalCommand command) throws Exception {
    	...
    	if ( terminal.contains( command.getAddTo() ) )
    		throw new ProcessingException( "Terminal already contains an entity with id " + command.getAddTo().getACDCTerminalId() );
    ...
    public void handle(RemoveTerminalFromACDCTerminalCommand command) throws Exception {
    	...
    	if ( !terminal.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "Terminal does not contain an entity with id " + command.getRemoveFrom().getACDCTerminalId() );

        apply(new RemoveTerminalFromACDCTerminalEvent(command.getACDCTerminalId(), command.getRemoveFrom()));
    }
