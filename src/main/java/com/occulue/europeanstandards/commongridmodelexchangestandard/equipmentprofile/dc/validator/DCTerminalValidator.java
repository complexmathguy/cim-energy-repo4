...
//		Assert.isNull( dCTerminal.getDCTerminalId(), "CreateDCTerminalCommand identifier should be null" );
	...
	public void validate( AssignDCTerminalsToDCTerminalCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCTerminalId(), "AssignDCTerminalsToDCTerminalCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDCTerminalsToDCTerminalCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveDCTerminalsFromDCTerminalCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCTerminalId(), "RemoveDCTerminalsFromDCTerminalCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDCTerminalsFromDCTerminalCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDCTerminalId(), "RemoveDCTerminalsFromDCTerminalCommand removeFrom attribubte identifier should not be null" );
	}
