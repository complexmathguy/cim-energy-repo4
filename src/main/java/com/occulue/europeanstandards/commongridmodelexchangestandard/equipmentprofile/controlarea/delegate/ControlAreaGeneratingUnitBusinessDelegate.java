...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToControlAreaGeneratingUnit( AssignControlAreaGeneratingUnitToControlAreaGeneratingUnitCommand command ) throws ProcessingException {
		...
		ControlAreaGeneratingUnitBusinessDelegate childDelegate 	= ControlAreaGeneratingUnitBusinessDelegate.getControlAreaGeneratingUnitInstance();
		ControlAreaGeneratingUnitBusinessDelegate parentDelegate = ControlAreaGeneratingUnitBusinessDelegate.getControlAreaGeneratingUnitInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a ControlAreaGeneratingUnit as ControlAreaGeneratingUnit to ControlAreaGeneratingUnit" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromControlAreaGeneratingUnit( RemoveControlAreaGeneratingUnitFromControlAreaGeneratingUnitCommand command ) throws ProcessingException {		
