...
//		Assert.isNull( transformerEnd.getTransformerEndId(), "CreateTransformerEndCommand identifier should be null" );
	...
	public void validate( AssignTransformerEndsToTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getTransformerEndId(), "AssignTransformerEndsToTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignTransformerEndsToTransformerEndCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveTransformerEndsFromTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getTransformerEndId(), "RemoveTransformerEndsFromTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveTransformerEndsFromTransformerEndCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getTransformerEndId(), "RemoveTransformerEndsFromTransformerEndCommand removeFrom attribubte identifier should not be null" );
	}
	...
	public void validate( AssignTransformerEndToTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getTransformerEndId(), "AssignTransformerEndToTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignTransformerEndToTransformerEndCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveTransformerEndFromTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getTransformerEndId(), "RemoveTransformerEndFromTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveTransformerEndFromTransformerEndCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getTransformerEndId(), "RemoveTransformerEndFromTransformerEndCommand removeFrom attribubte identifier should not be null" );
	}
