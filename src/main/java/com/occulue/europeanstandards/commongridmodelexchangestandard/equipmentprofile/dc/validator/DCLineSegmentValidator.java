...
//		Assert.isNull( dCLineSegment.getDCLineSegmentId(), "CreateDCLineSegmentCommand identifier should be null" );
	...
	public void validate( AssignDCLineSegmentsToDCLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCLineSegmentId(), "AssignDCLineSegmentsToDCLineSegmentCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignDCLineSegmentsToDCLineSegmentCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveDCLineSegmentsFromDCLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCLineSegmentId(), "RemoveDCLineSegmentsFromDCLineSegmentCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveDCLineSegmentsFromDCLineSegmentCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getDCLineSegmentId(), "RemoveDCLineSegmentsFromDCLineSegmentCommand removeFrom attribubte identifier should not be null" );
	}
