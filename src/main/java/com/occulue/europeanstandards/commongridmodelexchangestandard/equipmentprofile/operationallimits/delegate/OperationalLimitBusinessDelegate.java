...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToOperationalLimit( AssignOperationalLimitToOperationalLimitCommand command ) throws ProcessingException {
		...
		OperationalLimitBusinessDelegate childDelegate 	= OperationalLimitBusinessDelegate.getOperationalLimitInstance();
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromOperationalLimit( RemoveOperationalLimitFromOperationalLimitCommand command ) throws ProcessingException {		
     ...
     * @exception	ProcessingException
     */     
	public void addToOperationalLimitValue( AssignOperationalLimitValueToOperationalLimitCommand command ) throws ProcessingException {
		...
		try {		
			...
			final String msg = "Failed to add a OperationalLimit as OperationalLimitValue to OperationalLimit" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromOperationalLimitValue( RemoveOperationalLimitValueFromOperationalLimitCommand command ) throws ProcessingException {		
