...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToNonlinearShuntCompensatorPoints( AssignNonlinearShuntCompensatorPointsToNonlinearShuntCompensatorPointCommand command ) throws ProcessingException {
		...
		NonlinearShuntCompensatorPointBusinessDelegate childDelegate 	= NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance();
		NonlinearShuntCompensatorPointBusinessDelegate parentDelegate = NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a NonlinearShuntCompensatorPoint as NonlinearShuntCompensatorPoints to NonlinearShuntCompensatorPoint" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromNonlinearShuntCompensatorPoints( RemoveNonlinearShuntCompensatorPointsFromNonlinearShuntCompensatorPointCommand command ) throws ProcessingException {		
