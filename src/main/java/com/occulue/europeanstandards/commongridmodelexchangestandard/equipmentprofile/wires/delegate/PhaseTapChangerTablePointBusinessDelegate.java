...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToPhaseTapChangerTablePoint( AssignPhaseTapChangerTablePointToPhaseTapChangerTablePointCommand command ) throws ProcessingException {
		...
		PhaseTapChangerTablePointBusinessDelegate childDelegate 	= PhaseTapChangerTablePointBusinessDelegate.getPhaseTapChangerTablePointInstance();
		PhaseTapChangerTablePointBusinessDelegate parentDelegate = PhaseTapChangerTablePointBusinessDelegate.getPhaseTapChangerTablePointInstance();		
		...
		try {		
			...
			final String msg = "Failed to add a PhaseTapChangerTablePoint as PhaseTapChangerTablePoint to PhaseTapChangerTablePoint" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromPhaseTapChangerTablePoint( RemovePhaseTapChangerTablePointFromPhaseTapChangerTablePointCommand command ) throws ProcessingException {		
