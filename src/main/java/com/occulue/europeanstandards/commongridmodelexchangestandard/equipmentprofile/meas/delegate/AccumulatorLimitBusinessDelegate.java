...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToLimits( AssignLimitsToAccumulatorLimitCommand command ) throws ProcessingException {
		...
		AccumulatorLimitBusinessDelegate childDelegate 	= AccumulatorLimitBusinessDelegate.getAccumulatorLimitInstance();
		AccumulatorLimitBusinessDelegate parentDelegate = AccumulatorLimitBusinessDelegate.getAccumulatorLimitInstance();		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromLimits( RemoveLimitsFromAccumulatorLimitCommand command ) throws ProcessingException {		
