...
public class MeasurementAggregate {  
    ...
    public void handle(UpdateMeasurementCommand command) throws Exception {
    	...
    	UpdateMeasurementEvent event = new UpdateMeasurementEvent(command.getMeasurementId(), command.getMeasurementType(), command.getPhases(), command.getUnitMultiplier(), command.getUnitSymbol(), command.getMeasurements());        
    ...
    public void handle(AssignMeasurementsToMeasurementCommand command) throws Exception {
    	...
    	if ( measurements.contains( command.getAddTo() ) )
    		throw new ProcessingException( "Measurements already contains an entity with id " + command.getAddTo().getMeasurementId() );
    ...
    public void handle(RemoveMeasurementsFromMeasurementCommand command) throws Exception {
    	...
    	if ( !measurements.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "Measurements does not contain an entity with id " + command.getRemoveFrom().getMeasurementId() );

        apply(new RemoveMeasurementsFromMeasurementEvent(command.getMeasurementId(), command.getRemoveFrom()));
    }
