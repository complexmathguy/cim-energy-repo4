...
//		Assert.isNull( aCDCTerminal.getACDCTerminalId(), "CreateACDCTerminalCommand identifier should be null" );
	...
	public void validate( AssignTerminalToACDCTerminalCommand command ) throws Exception {
		...
		Assert.notNull( command.getACDCTerminalId(), "AssignTerminalToACDCTerminalCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignTerminalToACDCTerminalCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveTerminalFromACDCTerminalCommand command ) throws Exception {
		...
		Assert.notNull( command.getACDCTerminalId(), "RemoveTerminalFromACDCTerminalCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveTerminalFromACDCTerminalCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getACDCTerminalId(), "RemoveTerminalFromACDCTerminalCommand removeFrom attribubte identifier should not be null" );
	}
