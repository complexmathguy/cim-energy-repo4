...
//		Assert.isNull( topologicalNode.getTopologicalNodeId(), "CreateTopologicalNodeCommand identifier should be null" );
	...
	public void validate( AssignTopologicalNodeToTopologicalNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologicalNodeId(), "AssignTopologicalNodeToTopologicalNodeCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignTopologicalNodeToTopologicalNodeCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveTopologicalNodeFromTopologicalNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologicalNodeId(), "RemoveTopologicalNodeFromTopologicalNodeCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveTopologicalNodeFromTopologicalNodeCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getTopologicalNodeId(), "RemoveTopologicalNodeFromTopologicalNodeCommand removeFrom attribubte identifier should not be null" );
	}
