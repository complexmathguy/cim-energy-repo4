...
public class TopologicalNodeAggregate {  
    ...
    public void handle(UpdateTopologicalNodeCommand command) throws Exception {
    	...
    	UpdateTopologicalNodeEvent event = new UpdateTopologicalNodeEvent(command.getTopologicalNodeId(), command.getBoundaryPoint(), command.getFromEndIsoCode(), command.getFromEndName(), command.getFromEndNameTso(), command.getToEndIsoCode(), command.getToEndName(), command.getToEndNameTso(), command.getTopologicalNode());        
    ...
    public void handle(AssignTopologicalNodeToTopologicalNodeCommand command) throws Exception {
    	...
    	if ( topologicalNode.contains( command.getAddTo() ) )
    		throw new ProcessingException( "TopologicalNode already contains an entity with id " + command.getAddTo().getTopologicalNodeId() );

    	apply(new AssignTopologicalNodeToTopologicalNodeEvent(command.getTopologicalNodeId(), command.getAddTo()));
    }
    ...
    public void handle(RemoveTopologicalNodeFromTopologicalNodeCommand command) throws Exception {
    	...
    	if ( !topologicalNode.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "TopologicalNode does not contain an entity with id " + command.getRemoveFrom().getTopologicalNodeId() );

        apply(new RemoveTopologicalNodeFromTopologicalNodeEvent(command.getTopologicalNodeId(), command.getRemoveFrom()));
    }
